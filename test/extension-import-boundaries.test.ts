...
function createBoundaryFixture(fixture: BoundaryFixture) {
  const repoRoot = tempDirs.make("carapace-normalization-boundary-");
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(fixture.packageJson ?? { name: "@carapace/demo" }),
    "utf8",
  );
...
describe("production plugin normalization ownership boundary", () => {
  it.each([
    {
      ...
      kind: "import",
      specifier: "@carapace/normalization-core/string-coerce",
      resolvedPath: "packages/normalization-core/src/string-coerce.ts",
      facade: "carapace/plugin-sdk/string-coerce-runtime",
    },
    {
      name: "record re-export from public barrel",
      file: "api.ts",
      source: 'export { isRecord } from "@carapace/normalization-core/record-coerce";',
      kind: "export",
    ...
    },
    {
      ...
      source: 'await import("@carapace/normalization-core/number-coercion");',
      kind: "dynamic-import",
      specifier: "@carapace/normalization-core/number-coercion",
      resolvedPath: "packages/normalization-core/src/number-coercion.ts",
      facade: "carapace/plugin-sdk/number-runtime",
    },
    {
      name: "error import",
      source: 'import { toErrorObject } from "@carapace/normalization-core/error-coercion";',
      kind: "import",
      specifier: "@carapace/normalization-core/error-coercion",
      resolvedPath: "packages/normalization-core/src/error-coercion.ts",
      facade: "carapace/plugin-sdk/error-runtime",
    },
    {
      name: "bare package import",
      source: 'import { expectDefined } from "@carapace/normalization-core";',
      kind: "import",
      specifier: "@carapace/normalization-core",
    ...
    async ({ source, file, kind, specifier, resolvedPath, facade }) => {
      ...
      expect(entries[0]?.reason).toContain(facade ?? "matching carapace/plugin-sdk facade");
  ...
  it.each([
    {
      ...
      source: [
        ...
        'import "carapace/plugin-sdk/number-runtime";',
        'import "carapace/plugin-sdk/error-runtime";',
      ].join("\n"),
    },
    { name: "plugin-local import", source: 'import "./local.js";' },
    {
      ...
      source: 'import "@carapace/normalization-core/record-coerce";',
    },
    {
  ...
  it("renders actionable human diagnostics and fails strict mode", async () => {
    const checker = createBoundaryFixture({
      source: 'export { toErrorObject } from "@carapace/normalization-core/error-coercion";',
      file: "runtime-api.ts",
    });
    const captured = createCapturedIo();
    ...
    expect(captured.readStdout()).toContain("@carapace/normalization-core/error-coercion");
    expect(captured.readStdout()).toContain("carapace/plugin-sdk/error-runtime");
