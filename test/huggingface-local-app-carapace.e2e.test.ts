...
// Hugging Face local-app CLI contract tests cover Carapace's snippet-facing commands.
...
describe("Hugging Face Carapace local-app CLI contract", () => {
...
async function handleFakeOpenAiRequest(
  ...
  writeSse(res, {
    id: "chatcmpl-hf-carapace-contract",
