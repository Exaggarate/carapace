...
import type { PerformanceFixtureOptions } from "./carapace-performance-workflow.test-support.js";
...
const steps = {
  target: ["resolve_target", "Resolve Carapace target ref"],
...
function performanceRun(
  ...
  return runCiGitStep({
    workflow: { file: ".github/workflows/carapace-performance.yml", job, step },
    fetchResults: [],
    performance: { mode },
    ...options,
  });
