...
Linux desktop, VNC rescue, Slack Web, a real Carapace gateway, screenshots,
...
- **Mantis artifacts** - owned by the Carapace run. Live under
...
- remote logs: `slack-desktop-command.log`, `carapace-gateway.log`, `chrome.log`, `ffmpeg.log`
...
- `crabbox.remote_run` - sync, browser launch, Carapace install/build or
...
remote status but Mantis copied metadata proving either the Carapace gateway
