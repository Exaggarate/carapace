---
summary: "Use SOUL.md to give your Carapace agent an actual voice instead of generic assistant sludge"
read_when:
...
`SOUL.md` is where your agent's voice lives. Carapace injects it into normal
...
written once and forgotten. For Carapace, `SOUL.md` is that layer: write
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files Carapace injects into model context.
  </Card>
  <Card title="System prompt" href="/concepts/system-prompt" icon="message-lines">
    How `SOUL.md` is composed into Carapace and Codex runtime context.
  </Card>
