...
- [Doctor](/gateway/doctor) - `carapace doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where Carapace loads env vars and precedence
...
- [Carapace lore](/start/lore) - the story
