...
title: "Together AI"
read_when:
  - You want to use Together AI with Carapace
...
Carapace bundles it as the `together` provider.
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    carapace onboard --auth-choice together-api-key
    ```
  </Step>
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.carapace/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `carapace models list --provider together`
