---
summary: "Azure AI Speech text-to-speech for Carapace replies"
read_when:
...
Azure Speech is a bundled Azure AI Speech text-to-speech provider. Carapace
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Carapace synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Carapace derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Carapace
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled Carapace providers.
  </Card>
