...
```bash
carapace plugins install @carapace/fish-audio-speech
```
...
notes, and raw PCM at 8 kHz for telephony. For Discord voice, Carapace consumes
...
Fish voice library. Carapace lists your voices first, then a bounded page of
...
The first utterance downloads about 6.8 GB of model and codec data. Carapace
