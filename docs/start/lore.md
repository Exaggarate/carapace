---
summary: "Backstory and lore of Carapace for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Carapace lore"
---

# The Lore of Carapace 🦞📖
...
On January 30, 2026, the lobster molted one more time into its final form: **Carapace**.
...
**Carapace** won, because molting is what lobsters do to grow, and growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.carapace/workspace/`,
...
The **Moltiverse** is the community and ecosystem around Carapace: a space
...
Molty (then Carapace): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "carapace what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with carapace."

Then the chaos began.

**The Handle Snipers:** within seconds of the Twitter rename, automated bots sniped @carapace. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** scammers created fake GitHub profiles claiming to be "Head of Engineering at Carapace" to promote pump-and-dump tokens.
...
Moltbot never quite rolled off the tongue. So at 4am GMT, the team gathered again for **The Great Carapace Migration**.

In just 3 hours:

- GitHub renamed to `github.com/Exaggarate/carapace`
- X handle `@carapace` secured, with a gold checkmark
- npm packages released under the new name
- Docs migrated to `github.com/Exaggarate/carapace`
...
**The Scammer Speedrun:** crypto grifters launched a $CARAPACE token on Pump.fun within minutes, using artwork stolen from 20 minutes earlier. Business-verified accounts pushed the scam. The audacity was almost impressive.

**New traditions born:** "The claw is the law," "Yee-claw," "Claw abiding citizens," "Clawntroversy."

**Clawd → Moltbot → Carapace.** _The lobster has molted into its final form._
