---
summary: "Hubs that link to every Carapace doc"
read_when:
...
<Note>
If you are new to Carapace, start with [Getting Started](/start/getting-started).
</Note>
...
- [Carapace assistant](/start/carapace)
