---
summary: "Community-built projects and integrations powered by Carapace"
title: "Showcase"
description: "Real-world Carapace projects from the community"
read_when:
  - Looking for real Carapace usage examples
  - Updating community project highlights
---

Community-built Carapace projects: PR review loops, mobile apps, home automation, voice systems, devtools, and memory workflows, built chat-native on Telegram, WhatsApp, Discord, and terminals.

<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @carapace on X](https://x.com/carapace).
</Info>
...
Keeps Carapace usable on 2-4 GB machines: checks free memory and trims heavy features before the box starts swapping. [Source on GitHub](https://github.com/mirajmahmudul/carapace-lite-mode).
</Card>

<Card title="tokenomics cost tracker" icon="coins" href="https://github.com/ncz-os/tokenomics">
  **@ncz-os** • `devtools` `costs` `tokens`

Token cost tracker from an NVIDIA engineer with first-class Carapace support: see exactly where your agent spend goes, per model and per session.
</Card>
...
Had Carapace build its own Google Analytics query tool, then packaged and published it to ClawHub.
</Card>
...
OpenCode finishes the change, opens a PR, Carapace reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Carapace PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked "Robby" (@carapace) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="Carapace building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Carapace.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Carapace instances.
...
CLI for Linear that integrates with agentic workflows (Claude Code, Carapace). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Carapace takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Carapace" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask Carapace to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Carapace" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Carapace persona.
</Card>
...
Carapace connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had Carapace generate the skill directly in Telegram chat.
</Card>
...
Set Carapace loose on car dealers: it handled the back-and-forth negotiation and knocked $4,200 off the price.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via Carapace.
...
<Card title="Obsidian second brain" icon="book" href="https://notesbylex.com/carapace-the-missing-piece-for-obsidians-second-brain">
...
One tap on a Pebble Ring starts a voice conversation with Carapace — agent access from a wearable.
</Card>
...
iPhone Action Button wired to Carapace: press, talk, and the agent talks back like a walkie-talkie.
</Card>

<Card title="Clawdia phone bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`

Vapi voice assistant to Carapace HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Carapace easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/carapace-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

Carapace gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>

<Card title="Home Assistant skill" icon="toggle-on" href="https://clawhub.ai/homeofe/skills/carapace-homeassistant">
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/Exaggarate/carapace/nix-carapace">
  **@carapace** • `nix` `packaging` `deployment`

Batteries-included nixified Carapace configuration for reproducible deployments.
</Card>
...
The physical-world side of Carapace: homes, sensors, cameras, vacuums, and other devices.
...
Carapace found the HomePods on the local network and wrote itself a skill to control them.
</Card>
...
Nix-native home automation with Carapace as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Carapace ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @carapace](https://x.com/carapace).
  </Step>
...
- [Carapace](/start/carapace)
- [Full X showcase on github.com/Exaggarate/carapace](https://github.com/Exaggarate/carapace)
