...
- <a id="configure-carapace" />[Configure Carapace](/channels/slack/setup#configure-carapace)
...
- <a id="configure-carapace-1" />[Configure Carapace](/channels/slack/setup#configure-carapace-1)
