...
Carapace has two cooperating guardrails against repetitive tool-call patterns,
...
When a loop is detected, Carapace logs a loop event and either warns or blocks
...
- Warnings come first. On Carapace-executed tool calls, a short system note is
