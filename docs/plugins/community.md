---
summary: "Find and publish community-maintained Carapace plugins"
read_when:
  - You want to find third-party Carapace plugins
  - You want to publish or list your own plugin on ClawHub
title: "Community plugins"
doc-schema-version: 1
---

Community plugins are third-party packages that extend Carapace with
...
```bash
carapace plugins install npm:<package-name>
```

Use [Manage plugins](/plugins/manage-plugins) for common install, update,
inspect, and uninstall examples. Use [`carapace plugins`](/cli/plugins) for
the full command reference and source-selection rules.

## Publish plugins

Publish public community plugins on ClawHub so Carapace users can discover
...
| Requirement          | Why                                                 |
| -------------------- | --------------------------------------------------- |
| Published on ClawHub | Users need `carapace plugins install` hints to work |
