...
read_when:
  - You want an Carapace agent to join a Zoom meeting
...
Carapace Chrome profile. It does not create meetings, dial in, use the Zoom
...
same Carapace Chrome profile, then retry status or speech. It does not bypass
Zoom policy.
