---
summary: "Synology Chat channel plugin for Carapace channels and direct messages."
read_when:
...
Synology Chat channel plugin for Carapace channels and direct messages.

## Distribution

- Package: `@carapace/synology-chat`
