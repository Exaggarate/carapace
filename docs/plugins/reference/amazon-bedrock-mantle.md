---
summary: "Carapace Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
Carapace Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.

## Distribution

- Package: `@carapace/amazon-bedrock-mantle-provider`
