---
summary: "Adds MiniMax, MiniMax Portal model provider support to Carapace."
read_when:
...
Adds MiniMax, MiniMax Portal model provider support to Carapace.

## Distribution

- Package: `@carapace/minimax-provider`
