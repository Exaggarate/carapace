---
summary: "Carapace Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Carapace Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@carapace/anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. Carapace publishes its
