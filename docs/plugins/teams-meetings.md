...
read_when:
  - You want an Carapace agent to join a Microsoft Teams meeting
...
`teams.live.com/meet/...` as a guest in the Carapace Chrome profile. It does not
...
`manualAction`; complete the requested step in the same Carapace Chrome profile,
