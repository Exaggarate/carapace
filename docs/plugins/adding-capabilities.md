---
summary: "Contributor guide for adding a new shared capability to the Carapace plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Carapace core developers. If you are
...
Use this when Carapace needs a new shared domain such as embeddings, image
