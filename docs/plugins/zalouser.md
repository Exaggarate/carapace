...
read_when:
  - You want Zalo Personal (unofficial) support in Carapace
  - You are configuring or developing the zalouser plugin
title: "Zalo personal plugin"
---

Zalo Personal support for Carapace via a plugin that uses native `zca-js` to
...
carapace channels login --channel zalouser --account <name>
...
carapace directory groups list --channel zalouser --query "name"
