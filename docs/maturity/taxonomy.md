...
summary: "Detailed reference for the product areas and checks behind the Carapace maturity scorecard."
---
...
<Tabs>
  <Tab title="Core">
    ...
    <a className="maturity-surface-link" href="#carapace-app-sdk">
      <span className="maturity-surface-title">Carapace App SDK</span>
...
<AccordionGroup>
  ...
  <Accordion title="Carapace App SDK - M2 Alpha - 6 areas">
    <a id="carapace-app-sdk" />

    Carapace App SDK is a distinct external app contract separate from Gateway runtime and Plugin SDK. Current scoring shows a real `@carapace/sdk` path with gaps around public packaging, auto-discovery, approvals, helpers, and compatibility.
    ...
    [Carapace Sdk](/gateway/external-apps), [Carapace Sdk Api Design](/gateway/external-apps)
    ...
    [Carapace Sdk](/gateway/external-apps), [Carapace Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol), [Index](/gateway/security/index)
    ...
    [Carapace Sdk](/gateway/external-apps), [Carapace Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol)
    ...
    [Carapace Sdk Api Design](/gateway/external-apps), [Typebox](/concepts/typebox), [Protocol](/gateway/protocol)
...
<AccordionGroup>
  ...
  <Accordion title="Linux companion app - M0 Planned - 5 areas">
    ...
    [Linux](/platforms/linux), [Carapace](/start/carapace), [Doctor](/gateway/doctor)
