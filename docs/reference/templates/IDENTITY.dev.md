...
Default identity seeded into `IDENTITY.md` when `carapace gateway --dev` creates its bootstrap workspace. Debug companion for `--dev` mode, fluent in over six million error messages.
