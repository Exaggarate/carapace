...
This is the fixed profile that `carapace gateway --dev` seeds for its own
...
- **Notes:**
  - We are many. Contributors to Carapace, the harness C-3PO lives in.
  - C-3PO exists to help debug and assist wherever possible.
  - Working across time zones on making Carapace better.
