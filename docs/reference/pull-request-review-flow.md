---
summary: "How Barnacle and ClawSweeper feedback helps move Carapace pull requests through review."
read_when:
...
This page explains the review flow after you open or update an Carapace pull
...
ClawSweeper is the AI-assisted review and maintenance bot for Carapace
...
Carapace also uses separate stale automation. Unassigned issues and PRs can be
...
- [carapace/clawsweeper](https://github.com/Exaggarate/carapace/clawsweeper)
- [ClawSweeper docs](https://clawsweeper.bot/)

## Related

- [Contributing](https://github.com/Exaggarate/carapace/blob/main/CONTRIBUTING.md)
- [CI pipeline](/ci)
