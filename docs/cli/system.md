---
summary: "CLI reference for `carapace system` (system events, heartbeat, presence)"
read_when:
...
carapace system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$CARAPACE_GATEWAY_TOKEN"
carapace system heartbeat enable
carapace system heartbeat last
carapace system presence
```
