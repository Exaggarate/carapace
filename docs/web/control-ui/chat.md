...
<AccordionGroup>
  <Accordion title="Send and history semantics">
    ...
    - In the macOS app, the Carapace mark uses the otherwise-empty native titlebar strip next to the window controls instead of consuming a sidebar row.
  ...
  <Accordion title="Stop and abort">
    ...
    - Type `/stop` (or standalone abort phrases like `stop`, `stop action`, `stop run`, `stop carapace`, `please stop`) to abort out-of-band.
...
The **Ask Carapace** panel supports table scrolling, copying, expansion, and web
