---
summary: "Carapace threat model mapped to the MITRE ATLAS framework"
...
This threat model documents adversarial threats to the Carapace AI agent platform and ClawHub skill marketplace. It is a living document maintained by the Carapace community. See [Contributing to the threat model](/security/CONTRIBUTING-THREAT-MODEL) for how to report new threats, propose attack chains, or suggest mitigations.
...
| ---------------------- | -------- | ------------------------------------------------ |
| Carapace agent runtime | Yes      | Core agent execution, tool calls, sessions       |
...
Out-of-scope reports and false-positive patterns (public internet exposure, prompt-injection-only chains without a boundary bypass, mutually untrusted operators sharing one gateway host, and others) are enumerated in [`SECURITY.md`](https://github.com/Exaggarate/carapace/blob/main/SECURITY.md); that file is the current source of truth for vulnerability-report scope, not this page.
...
| **Description**         | Attacker scans for exposed Carapace gateway endpoints                |
...
| ATLAS ID      | Technique name                 | Carapace threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | Carapace's skill marketplace                              |
| **Gateway**          | Carapace's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Carapace agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to `security@github.com/Exaggarate/carapace` or see the [Trust page](https://github.com/Exaggarate/carapace)._
