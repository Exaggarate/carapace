---
summary: "How to contribute to the Carapace threat model"
...
<Note>
This is for adding to the threat model, not reporting live vulnerabilities. If you found an exploitable vulnerability, follow the responsible-disclosure instructions on the [Trust page](https://github.com/Exaggarate/carapace) instead.
</Note>

## Ways to contribute

**Add a threat.** Open a [documentation issue](https://github.com/Exaggarate/carapace/issues/new?template=docs_bug_report.yml) describing the attack scenario in your own words. Helpful but not required:
...
- **Security vulnerabilities:** [Trust page](https://github.com/Exaggarate/carapace) for reporting instructions, or `security@github.com/Exaggarate/carapace`.
- **Threat model questions:** open a [documentation issue](https://github.com/Exaggarate/carapace/issues/new?template=docs_bug_report.yml).
- **General chat:** Discord `#security` channel.

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Carapace security hall of fame for significant contributions.
