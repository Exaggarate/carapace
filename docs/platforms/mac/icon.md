---
summary: "Menu bar icon states and animations for Carapace on macOS"
read_when:
...
The other designs follow macOS light/dark appearance while Carapace is running.

The selection is saved separately for each Carapace profile and applies immediately.
