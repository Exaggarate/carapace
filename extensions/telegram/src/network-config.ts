...
import { isTruthyEnvValue, isWSL2Sync } from "carapace/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "carapace/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "CARAPACE_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "CARAPACE_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "CARAPACE_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable CARAPACE_TELEGRAM_DNS_RESULT_ORDER
