export { createChannelPartialDeliveryError } from "carapace/plugin-sdk/channel-inbound";
import {
  createEmptyPluginRegistry,
  withPluginRuntimeRegistryScope,
} from "carapace/plugin-sdk/channel-test-helpers";
import type { CarapaceConfig } from "carapace/plugin-sdk/config-contracts";
export { createDeferred } from "carapace/plugin-sdk/extension-shared";
...
import { resolveChunkMode } from "carapace/plugin-sdk/reply-dispatch-runtime";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("carapace/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("carapace/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
type ResolveCommandArgMenuFn =
  typeof import("carapace/plugin-sdk/command-auth-native").resolveCommandArgMenu;
type DeliverRepliesFn = typeof import("./bot/delivery.js").deliverReplies;
type LoadModelCatalogFn = typeof import("carapace/plugin-sdk/agent-runtime").loadModelCatalog;
type ResolveDefaultModelForAgentFn =
  typeof import("carapace/plugin-sdk/agent-runtime").resolveDefaultModelForAgent;
...
vi.mock("carapace/plugin-sdk/command-auth-native", async () => {
  const actual = await vi.importActual<typeof import("carapace/plugin-sdk/command-auth-native")>(
    "carapace/plugin-sdk/command-auth-native",
  );
...
export function resetSessionMetaMocks() {
  ...
  sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/carapace-sessions.json");
