...
import { isDiagnosticsEnabled } from "carapace/plugin-sdk/diagnostic-runtime";
import {
  logWebhookError,
  logWebhookProcessed,
  logWebhookReceived,
...
import type { BackoffPolicy, RuntimeEnv } from "carapace/plugin-sdk/runtime-env";
import {
  computeBackoff,
  defaultRuntime,
...
const TELEGRAM_WEBHOOK_ACCEPTED_HEADER = "x-carapace-delivery-accepted";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: CarapaceConfig): string {
