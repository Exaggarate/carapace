...
export type TelegramOutboundPromptContextMessage = {
  ...
  carapace_prompt_context_timestamp_ms?: number;
  text?: string;
  caption?: string;
...
function resolveOutboundCacheMessageTimestamp(
  ...
  if (
    typeof msg.carapace_prompt_context_timestamp_ms === "number" &&
    Number.isFinite(msg.carapace_prompt_context_timestamp_ms)
  ) {
    return msg.carapace_prompt_context_timestamp_ms;
  }
...
function buildOutboundCacheMessage(params: {
  ...
  return {
    ...
    ...(params.promptContextTimestampMs !== undefined
      ? { carapace_prompt_context_timestamp_ms: params.promptContextTimestampMs }
      : {}),
    date:
