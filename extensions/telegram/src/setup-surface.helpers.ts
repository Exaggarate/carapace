...
export function shouldShowTelegramDmAccessWarning(cfg: CarapaceConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`carapace config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`carapace config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
