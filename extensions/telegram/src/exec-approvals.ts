...
import { doesApprovalRequestSelectChannelAccount } from "carapace/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
...
function resolveTelegramOwnerApprovers(cfg: CarapaceConfig): Array<string | number> {
