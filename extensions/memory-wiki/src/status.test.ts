...
import type { MemoryPluginPublicArtifact } from "carapace/plugin-sdk/memory-host-core";
...
describe("memory wiki doctor", () => {
  it("builds actionable fixes from status warnings", async () => {
    ...
    expect(rendered).toContain("carapace wiki init");
  });
