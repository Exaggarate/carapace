...
} from "carapace/plugin-sdk/channel-route";
import type { CarapaceConfig } from "carapace/plugin-sdk/config-contracts";
import { normalizeMessageChannel } from "carapace/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<CarapaceConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: CarapaceConfig) {
