...
import { createPersistentDedupeCache } from "carapace/plugin-sdk/dedupe-runtime";
 ...
 */
const SLACK_THREAD_PARTICIPATION_KEY = Symbol.for("carapace.slackThreadParticipation");
const SLACK_THREAD_FAILURE_NOTICES_KEY = Symbol.for("carapace.slackThreadFailureNotices");
