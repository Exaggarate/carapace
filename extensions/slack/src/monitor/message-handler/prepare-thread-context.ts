...
import type { ContextVisibilityMode, CarapaceConfig } from "carapace/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("carapace/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
