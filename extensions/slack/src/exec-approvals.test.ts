...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CarapaceConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CarapaceConfig["channels"]>["slack"]>>,
): CarapaceConfig {
  return {
    channels: {
      slack: {
