...
describe("Slack approval actions", () => {
  ...
  it.each([
    "callback",
    "carapace:approval:v1:not-json",
    'carapace:approval:v1:{"approvalId":"req-1","decision":"allow-once"}',
    'carapace:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"accept"}',
    'carapace:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"deny","extra":true}',
