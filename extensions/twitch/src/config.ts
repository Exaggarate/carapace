...
export function getAccountConfig(
  ...
  const cfg = coreConfig as CarapaceConfig;
...
export const twitchConfigAdapter = {
  ...
  resolveDefaultTo: ({ cfg, accountId }: { cfg: CarapaceConfig; accountId?: string | null }) =>
    resolveTwitchAccountContext(cfg, accountId).account?.channel,
  isConfigured: (account: ResolvedTwitchAccount, cfg: CarapaceConfig) =>
