...
import { parseDateStringTimestampMs as resolveGoogleChatTimestampMs } from "carapace/plugin-sdk/number-runtime";
 ...
 * 3. Agent identity name, then "Carapace"
 */
function resolveBotDisplayName(params: {
  ...
  return agent?.identity?.name?.trim() || "Carapace";
}
