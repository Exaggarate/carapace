...
function resolveGoogleChatAccountImpl(params: { cfg: CarapaceConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: CarapaceConfig) => {
...
function createGoogleChatCfg(): CarapaceConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
