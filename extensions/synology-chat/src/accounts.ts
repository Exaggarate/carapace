...
import { resolveDangerousNameMatchingEnabled } from "carapace/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full Carapace config object. */
function getChannelConfig(cfg: CarapaceConfig): SynologyChatChannelConfig | undefined {
...
export function resolveAccount(
  ...
  const envBotName = normalizeOptionalString(process.env.CARAPACE_BOT_NAME) ?? "Carapace";
