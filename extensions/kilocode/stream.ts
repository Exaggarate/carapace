...
import { resolveProviderRequestHeaders } from "carapace/plugin-sdk/provider-http";
import { normalizeOpenAICompatibleReasoningPayload } from "carapace/plugin-sdk/provider-stream-shared";
import {
  asOptionalRecord,
