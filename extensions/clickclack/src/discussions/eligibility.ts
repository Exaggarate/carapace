import type { SessionDiscussionInfo } from "carapace/plugin-sdk/session-discussion";
...
export function discussionInfoForBinding(
  ...
  return {
    ...
    embedUrl: `${baseUrl}/embed/channel/${encodeURIComponent(binding.workspaceRouteId)}/${encodeURIComponent(binding.channelRouteId)}?carapaceHostTheme=1`,
