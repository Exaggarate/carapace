...
import type { CarapacePluginGatewayEvents, PluginRuntime } from "carapace/plugin-sdk/core";
import type {
  SessionDiscussionInfo,
  SessionDiscussionProvider,
} from "carapace/plugin-sdk/session-discussion";
...
type DiscussionServiceOptions = {
  ...
  gatewayEvents?: Pick<CarapacePluginGatewayEvents, "onSessionsChanged">;
  startTimer?: boolean;
...
export class ClickClackDiscussionService {
  ...
  bindGatewayEvents(
    gatewayEvents: Pick<CarapacePluginGatewayEvents, "onSessionsChanged"> | undefined,
  ): void {
