...
import type { AckReactionHandle } from "carapace/plugin-sdk/channel-feedback";
...
import type { getReplyFromConfig, MsgContext } from "carapace/plugin-sdk/reply-runtime";
import { resolveAgentRoute, buildGroupHistoryKey } from "carapace/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("carapace/plugin-sdk/runtime-env"))["getChildLogger"]>;
