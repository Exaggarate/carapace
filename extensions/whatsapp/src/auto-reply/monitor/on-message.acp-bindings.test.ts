...
import type { ConfiguredBindingRouteResult } from "carapace/plugin-sdk/conversation-binding-runtime";
...
vi.mock("carapace/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("carapace/plugin-sdk/routing")>();
  return {
    ...actual,
