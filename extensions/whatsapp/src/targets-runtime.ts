...
import { chunkMarkdownTextWithMode, type ChunkMode } from "carapace/plugin-sdk/reply-chunking";
...
import { CONFIG_DIR, resolveUserPath } from "carapace/plugin-sdk/text-utility-runtime";
