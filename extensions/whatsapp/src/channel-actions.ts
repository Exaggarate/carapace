...
function areWhatsAppAgentReactionsEnabled(params: { cfg: CarapaceConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: CarapaceConfig) {
