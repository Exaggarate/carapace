...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "carapace/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: CarapaceConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CarapaceConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CarapaceConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CarapaceConfig): ResolvedWhatsAppAccount[] {
