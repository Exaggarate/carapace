...
import { normalizeOptionalAccountId } from "carapace/plugin-sdk/account-core";
...
import { sendTextMediaPayload } from "carapace/plugin-sdk/reply-payload";
...
function resolveQuoteLookupAccountId(cfg?: CarapaceConfig, accountId?: string | null): string {
