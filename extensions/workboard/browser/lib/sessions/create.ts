import type { SessionsCreateParams, SessionsCreateResult } from "@carapace/gateway-protocol";
import { normalizeOptionalString as stringValue } from "carapace/plugin-sdk/string-coerce-runtime";
