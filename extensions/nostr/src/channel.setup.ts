...
import { createDelegatedSetupWizardProxy } from "carapace/plugin-sdk/setup-runtime";
...
function getNostrConfig(cfg: CarapaceConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function resolveDefaultSetupNostrAccountId(cfg: CarapaceConfig): string {
