...
Nostr DM channel plugin for Carapace using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Carapace. It enables your bot to:
...
# Configure carapace to use local relay
