...
const providerFilter = parseCsvFilter(process.env.CARAPACE_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.CARAPACE_LIVE_MUSIC_GENERATION_MODELS);
