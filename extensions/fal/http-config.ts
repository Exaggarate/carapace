...
import type { AuthProfileStore, CarapaceConfig } from "carapace/plugin-sdk/provider-auth";
...
function resolveFalConfiguredBaseUrl(cfg?: CarapaceConfig): string | undefined {
