...
import { isRecord as isMatrixQaPlainRecord } from "carapace/plugin-sdk/string-coerce-runtime";
import {
  buildMatrixQaToken,
  buildMentionPrompt,
...
export async function runMatrixQaAllowlistHotReloadScenario(
  ...
  const configPath = context.gatewayRuntimeEnv?.CARAPACE_CONFIG_PATH;
