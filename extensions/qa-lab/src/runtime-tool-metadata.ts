...
export type QaRuntimeCapabilityLayer =
  | "codex-native-workspace"
  | "carapace-dynamic-direct"
  | "carapace-dynamic-searchable"
  | "optional-profile-or-plugin"
  | "structural-text";
...
const DEFAULT_LAYER_BY_BUCKET: Record<QaRuntimeToolBucket, QaRuntimeToolExpectedLayer> = {
  ...
  "carapace-dynamic-integration": "carapace-dynamic",
...
const DEFAULT_CAPABILITY_LAYER_BY_BUCKET: Record<QaRuntimeToolBucket, QaRuntimeCapabilityLayer> = {
  "codex-native-workspace": "codex-native-workspace",
  "carapace-dynamic-integration": "carapace-dynamic-searchable",
...
function inferRuntimeToolBucket(params: { config?: Record<string, unknown> }): QaRuntimeToolBucket {
  ...
  return "carapace-dynamic-integration";
}
...
export function readRuntimeToolCoverageMetadata(params: {
  ...
  const explicitSearchableDynamic = capabilityLayerInput === "carapace-dynamic-searchable";
  const required =
