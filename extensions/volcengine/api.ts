...
import { applyModelCompatPatch } from "carapace/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "carapace/plugin-sdk/provider-model-shared";
