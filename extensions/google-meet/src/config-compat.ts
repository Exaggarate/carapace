...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.google-meet.config.realtime.provider="google" is legacy for Gemini Live bidi mode; use realtime.voiceProvider="google" and realtime.transcriptionProvider="openai". Run "carapace doctor --fix".',
    match: hasLegacyGoogleRealtimeProvider,
  },
];

function migrateGoogleMeetLegacyRealtimeProvider(config: CarapaceConfig): {
