...
Official Buzz channel plugin for Carapace. It connects an Carapace agent to approved Buzz rooms for text conversations and threaded replies.
...
Carapace installs the plugin if needed, asks for the relay URL, and generates a dedicated bot identity.
...
carapace directory peers list --channel buzz
carapace directory groups list --channel buzz
carapace directory groups members --channel buzz --group-id buzz:<ROOM_UUID>
```
...
- Never give Carapace a human owner's private key.
- The generated bot private key is stored in Carapace configuration; only its public key is displayed.
...
- Not yet supported: DMs, media, reactions, or creating rooms from Carapace.

Full documentation: ../../docs/channels/buzz.md

Package: `@carapace/buzz` · Plugin ID: `buzz`
