...
>({
  ...
  session: {
    ...
    participantIdentity: (transport) =>
      transport === "chrome-node"
        ...
        : "Microsoft Teams guest in the Carapace Chrome profile",
  },
  ...
  browser: {
    ...
    browserControlUnavailable: () => ({
      ...
      message:
        "Open the Carapace browser profile, finish the Teams sign-in, admission, or permission prompt, then retry.",
    }),
