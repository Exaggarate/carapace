...
export const MEETING_STATE_KEY = "__carapaceTeamsMeeting";
...
export async function runStatusScript(params: StatusScriptParams) {
  ...
  if (params.priorAudioOutputs) {
    window["__carapaceTeamsAudioOutputs"] = params.priorAudioOutputs;
  }
  if (params.priorCaptions) {
    window["__carapaceTeamsCaptions"] = params.priorCaptions;
  }
...
export function continueStatusScript(previous: StatusScriptPage, params: StatusScriptParams = {}) {
  return runStatusScript({
    ...params,
    priorAudioOutputs: previous.window["__carapaceTeamsAudioOutputs"] as unknown[],
...
export function runCaptionRows(
  ...
  return runCaptionStatusScript({
    captionRows,
    priorCaptions: previous?.window["__carapaceTeamsCaptions"],
    ...params,
  });
}
