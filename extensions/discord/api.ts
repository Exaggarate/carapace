...
// Deprecated compatibility surface for existing @carapace/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "carapace/plugin-sdk/runtime-group-policy";
...
/**
 * @deprecated Shipped `@carapace/discord/api` compatibility only. Use native
