...
import type { ContextVisibilityMode } from "carapace/plugin-sdk/config-contracts";
import type { HistoryEntry } from "carapace/plugin-sdk/reply-history";
import { filterSupplementalContextItems } from "carapace/plugin-sdk/security-runtime";
