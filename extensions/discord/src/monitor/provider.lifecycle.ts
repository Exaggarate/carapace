...
import { createTransportActivityStatusPatch } from "carapace/plugin-sdk/gateway-runtime";
import { asDateTimestampMs, parseStrictPositiveInteger } from "carapace/plugin-sdk/number-runtime";
import { danger, sleepWithAbort } from "carapace/plugin-sdk/runtime-env";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "CARAPACE_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "CARAPACE_DISCORD_RUNTIME_READY_TIMEOUT_MS";
