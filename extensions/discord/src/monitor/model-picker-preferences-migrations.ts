...
import type { BundledChannelLegacyStateMigrationDetector } from "carapace/plugin-sdk/channel-entry-contract";
import { MAX_DATE_TIMESTAMP_MS, timestampMsToIsoString } from "carapace/plugin-sdk/number-runtime";
import {
