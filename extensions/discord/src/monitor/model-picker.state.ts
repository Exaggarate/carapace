...
import type { ModelsProviderData } from "carapace/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "carapace/plugin-sdk/number-runtime";
...
const loadModelsProviderRuntime = createLazyRuntimeModule(
  () => import("carapace/plugin-sdk/models-provider-runtime"),
);
