...
import { createSubsystemLogger, formatDurationSeconds } from "carapace/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("carapace/plugin-sdk/runtime-env").createSubsystemLogger
>;
