...
import { resolveChunkMode } from "carapace/plugin-sdk/reply-chunking";
...
import { readLatestAssistantTextByIdentity } from "carapace/plugin-sdk/session-transcript-runtime";
