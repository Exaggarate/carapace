...
import { buildMessagingTarget, type MessagingTarget } from "carapace/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "carapace/plugin-sdk/directory-runtime";
