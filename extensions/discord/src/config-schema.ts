import { normalizeLegacyDmAliases } from "carapace/plugin-sdk/channel-config-helpers";
...
import * as channelConfigSchema from "carapace/plugin-sdk/channel-config-schema";
