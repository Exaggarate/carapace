...
const VERTEX_ADC_TEST_API_KEY = Symbol.for("carapace.google.vertexAdcTestApi");
 ...
 *      Carapace, included for completeness).
 ...
 * existing fetchImpl test seam and the Carapace upstream behaviour); when the
