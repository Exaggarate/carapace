# GitHub Copilot agent runtime (Carapace plugin)

External Carapace plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. Carapace remains the default embedded runtime.
