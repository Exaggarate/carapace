...
describe("buildCopilotPromptGuidance", () => {
  it("composes ordered Carapace policy from the final callable capabilities", () => {
  ...
  it("uses the message tool only when it remains callable", () => {
    ...
    expect(unavailable).not.toContain("Carapace delivers your final response automatically");
  });
