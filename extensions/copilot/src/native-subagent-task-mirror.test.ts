...
vi.mock("carapace/plugin-sdk/agent-harness-task-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("carapace/plugin-sdk/agent-harness-task-runtime")>();
  return {
    ...actual,
