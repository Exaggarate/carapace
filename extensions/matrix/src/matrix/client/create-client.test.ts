...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/carapace-matrix-create-client-test",
    storagePath: "/tmp/carapace-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/carapace-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/carapace-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "carapace-matrix-default-token-hash",
