 ...
 */
import { resolveAwsSdkEnvVarName } from "carapace/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "carapace/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells Carapace to use AWS SDK credentials. */
