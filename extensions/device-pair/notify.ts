...
import { listDevicePairing } from "carapace/plugin-sdk/device-bootstrap";
...
function openNotifySubscriberStore(api: CarapacePluginApi): NotifySubscriberStore {
...
async function notifyPendingPairingRequests(params: { api: CarapacePluginApi }): Promise<void> {
...
async function runNotifyPoll(api: CarapacePluginApi): Promise<void> {
...
export function createPairingNotifierService(api: CarapacePluginApi): CarapacePluginService {
