...
import { parseModelRef } from "carapace/plugin-sdk/model-ref-parse";
...
export const legacyConfigRules = [
  {
    ...
    message: `${ENTRY_PATH}.config.allowedModels moved to ${ENTRY_PATH}.llm.allowedCompletionModels. Run "carapace doctor --fix".`,
  },
  {
    path: ["plugins", "entries", "llm-task"],
    message: `${ENTRY_PATH} needs host-owned LLM model/profile permissions to preserve shipped tool parameters. Run "carapace doctor --fix".`,
    match: (value: unknown) => {
