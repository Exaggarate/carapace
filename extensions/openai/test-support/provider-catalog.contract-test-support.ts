...
import type { ProviderPlugin } from "carapace/plugin-sdk/provider-test-contracts";
...
vi.mock("carapace/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("carapace/plugin-sdk/provider-catalog-runtime")
  >("carapace/plugin-sdk/provider-catalog-runtime");
