/**
 * Routes Codex app-server plugin approval prompts through Carapace's gateway
...
import { isApprovalNotFoundError, toErrorObject } from "carapace/plugin-sdk/error-runtime";
...
/** Starts a two-phase plugin approval request through the Carapace gateway. */
