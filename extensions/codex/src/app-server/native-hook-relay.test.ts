...
import type { NativeHookRelayRegistrationHandle } from "carapace/plugin-sdk/agent-harness-runtime";
import {
...
describe("Codex native hook relay config", () => {
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event post_tool_use --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event before_agent_finalize --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 9000",
              timeout: 10,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 9000",
              timeout: 10,
              async: false,
              statusMessage: "Carapace native hook relay",
            },
  ...
  it("projects canonical Carapace ids to Codex canonical and alias matcher names", () => {
    const config = buildCodexNativeHookRelayConfig({
      relay: createRelay({
        matchers: {
          pre_tool_use: ["exec"],
...
function createRelay(options?: {
  ...
  return {
    ...
    commandForEvent: (event, commandOptions) =>
      `carapace hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event ${event}${
