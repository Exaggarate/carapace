...
import { wrapToolWithBeforeToolCallHook } from "carapace/plugin-sdk/agent-harness-runtime";
import {
...
// Codex tests cover carapace owned tool runtime contract plugin behavior.
...
describe("Carapace-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetCarapaceOwnedToolHooks();
  });
