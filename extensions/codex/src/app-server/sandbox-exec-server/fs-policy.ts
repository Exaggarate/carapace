/**
 * Resolves Codex filesystem sandbox policy payloads into Carapace path/glob
...
function readFsSandboxCwd(execServer: CarapaceExecServer, sandbox: JsonObject): string {
