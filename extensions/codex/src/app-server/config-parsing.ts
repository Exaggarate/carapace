...
import { detectWindowsSpawnCommandInlineArgs } from "carapace/plugin-sdk/windows-spawn";
import { z } from "zod";
import {
...
export const DEFAULT_CODEX_APP_SERVER_NETWORK_PROXY_PROFILE_PREFIX = "carapace-network";
