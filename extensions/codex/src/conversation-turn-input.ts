...
import { normalizeSingleOrTrimmedStringList } from "carapace/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Carapace channels expose either local staged files or remote URLs. Keep
