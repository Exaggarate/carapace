...
describe("iMessage monitor attachment policy", () => {
  ...
  it("does not stage local attachments for messages dropped by inbound policy", async () => {
    ...
    const attachmentPath = "/Users/carapace/Library/Messages/Attachments/AA/BB/photo.heic";
    let onNotification:
  ...
  it.each([
    {
      ...
      attachments: [
        {
          original_path: "/Users/carapace/Library/Messages/Attachments/missing.heic",
          mime_type: "image/heic",
          missing: true,
        },
      ],
    ...
    },
    {
      ...
      attachments: [
        ...
        {
          original_path: "/Users/carapace/Library/Messages/Attachments/report.pdf",
      ...
      staged: {
        attachments: [
          ...
          {
            path: "/Users/carapace/Library/Messages/Attachments/report.pdf",
      ...
      expectedMediaUrls: ["", "/Users/carapace/Library/Messages/Attachments/report.pdf"],
    },
  ])(
    "$name",
      ...
      await monitorIMessageProvider({
        ...
        config: {
          channels: {
            imessage: {
              includeAttachments: true,
              attachmentRoots: ["/Users/carapace/Library/Messages/Attachments"],
              dmPolicy: "allowlist",
