...
function mergeZalouserAccountConfig(cfg: CarapaceConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: CarapaceConfig; accountId?: string | null }) {
