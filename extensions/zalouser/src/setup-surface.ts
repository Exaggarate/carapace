...
function ensureZalouserPluginEnabled(cfg: CarapaceConfig): CarapaceConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("carapace directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("carapace directory groups list --channel zalouser"),
            }),
