...
import { updateAuthProfileStoreWithLock } from "carapace/plugin-sdk/provider-auth";
...
async function buildOpenCodeSecretCandidates(
  ...
  // Carapace's Copilot token profile cannot preserve OpenCode enterprise routing yet.
