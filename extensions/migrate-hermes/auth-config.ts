...
import { resolveMigrationConfigRuntime } from "carapace/plugin-sdk/migration";
import type { MigrationProviderContext } from "carapace/plugin-sdk/plugin-entry";
import { applyAuthProfileConfig, type CarapaceConfig } from "carapace/plugin-sdk/provider-auth";
...
export async function applyAuthProfileConfigWithConflictCheck(params: {
  ctx: MigrationProviderContext;
  profile: HermesAuthProfileConfig;
  applyConfigPatch?: (config: CarapaceConfig) => CarapaceConfig;
