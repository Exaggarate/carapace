...
export const legacyConfigRules = [
  {
    ...
    message:
      'plugins.entries.active-memory.config.qmd is retired because the QMD memory backend was removed. Run "carapace doctor --fix".',
  },
];
...
/** State migrations exposed to Carapace doctor for Active Memory. */
