...
import { findCodeRegions, type CodeRegion } from "carapace/plugin-sdk/text-chunking";

const CLAUDE_RAW_TOOL_OUTPUT_ERROR =
  "Claude CLI returned malformed tool output (invalid request format): raw tool protocol appeared as assistant text. Carapace refused to persist or deliver it.";
