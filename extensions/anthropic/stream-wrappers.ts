...
const CARAPACE_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const CARAPACE_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...CARAPACE_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
export { isAnthropicOAuthApiKey } from "carapace/plugin-sdk/provider-stream-shared";
...
/** Wrap a stream function to merge Carapace and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const carapaceBetas = isOauth
      ? (CARAPACE_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (CARAPACE_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...carapaceBetas, ...effectiveBetas])];
