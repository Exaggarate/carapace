// Opencode plugin entrypoint registers its Carapace integration.
...
import { createOpenAICompatibleCompletionsThinkingOffWrapper } from "carapace/plugin-sdk/provider-stream-shared";
