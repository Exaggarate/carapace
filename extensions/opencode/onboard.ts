...
import { withAgentModelAliases, type CarapaceConfig } from "carapace/plugin-sdk/provider-onboard";

export const OPENCODE_ZEN_DEFAULT_MODEL_REF = "opencode/claude-opus-5";

export function applyOpencodeZenProviderConfig(cfg: CarapaceConfig): CarapaceConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
