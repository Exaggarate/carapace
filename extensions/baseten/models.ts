...
import { asNonArrayRecord, filterStringEntries } from "carapace/plugin-sdk/string-coerce-runtime";
...
/** Projects Baseten's authenticated `/models` response into Carapace model rows. */
