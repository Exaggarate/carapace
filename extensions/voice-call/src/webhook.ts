...
import { resolveConfiguredCapabilityProvider } from "carapace/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "carapace/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private coreConfig: CarapaceConfig | null;
  private fullConfig: CarapaceConfig | null;
  private agentRuntime: CarapacePluginApi["runtime"]["agent"] | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as CarapaceConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as CarapaceConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as CarapaceConfig | null) ?? undefined,
