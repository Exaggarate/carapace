...
Official external Carapace plugin for daily, weekly, and monthly GitHub activity reports
with optional Discord discussion, model-written summaries, and a **Reports**
tab in the Control UI. Installed on demand (`carapace plugins install @carapace/team-reports`);
...
See the [Team Reports guide](../../docs/plugins/team-reports.md)
