...
import { isRecord, readStringValue as readString } from "carapace/plugin-sdk/string-coerce-runtime";
...
export function registerFeishuDriveTools(api: CarapacePluginApi) {
  if (!api.config) {
    return;
  }
