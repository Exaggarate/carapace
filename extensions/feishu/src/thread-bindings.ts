...
import { isPluginOwnedSessionBindingRecord } from "carapace/plugin-sdk/conversation-binding-runtime";
import {
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("carapace.feishuThreadBindingsState");
