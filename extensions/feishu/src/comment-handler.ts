...
import { resolveInboundReplyDispatchCounts } from "carapace/plugin-sdk/channel-inbound";
...
import type { CarapaceConfig as ClawdbotConfig } from "carapace/plugin-sdk/config-contracts";
