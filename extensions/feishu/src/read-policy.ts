...
type FeishuReadContext = FeishuActionReadContext | CarapacePluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: CarapaceConfig, account: ResolvedFeishuAccount) {
