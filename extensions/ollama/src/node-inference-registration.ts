...
function createLazyNodeHostCommand(
  ...
  let runtimeCommandPromise: Promise<CarapacePluginNodeHostCommand> | undefined;
...
export function createLazyOllamaNodeHostCommands(): CarapacePluginNodeHostCommand[] {
  return [
...
export function createOllamaNodeInvokePolicy(): CarapacePluginNodeInvokePolicy {
  return {
...
export function createLazyOllamaNodeInferenceTool(api: CarapacePluginApi): AnyAgentTool {
