/**
 * Wire protocol between the extension relay server and the Carapace Chrome
...
/** Tab snapshot reported by the extension for tabs currently accessible to Carapace. */
