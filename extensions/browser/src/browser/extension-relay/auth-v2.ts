...
export const BROWSER_RELAY_EXTENSION_SUBPROTOCOL = "carapace-extension-relay.v2";
export const BROWSER_RELAY_AUTH_CHALLENGE_PATH = "/_carapace/relay/auth/v2/challenge";
export const BROWSER_RELAY_AUTH_COMPLETE_PATH = "/_carapace/relay/auth/v2/complete";
