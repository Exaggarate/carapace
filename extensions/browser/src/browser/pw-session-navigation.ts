...
// Carapace operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Carapace itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Carapace navigated to a blocked URL. */
