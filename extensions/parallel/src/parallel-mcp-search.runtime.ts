...
import { withTrustedWebSearchEndpoint } from "carapace/plugin-sdk/provider-web-search";
...
// without this, undici sends a generic `node` UA and Carapace usage is only
  ...
  const init = await postMcp({
    ...
    body: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "carapace-parallel", version: PLUGIN_VERSION },
      },
    },
  });
  if (!init.ok) {
