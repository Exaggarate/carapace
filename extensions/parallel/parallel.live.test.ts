  ...
  it(
    ...
    async () => {
      ...
      const result = (await tool.execute({
        objective:
          "Find the Carapace GitHub repository and recent project activity for a quick smoke test.",
        search_queries: ["carapace github repository", "carapace release notes"],
        count: 3,
