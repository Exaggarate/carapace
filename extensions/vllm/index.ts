import { defineSelfHostedOpenAICompatibleProvider } from "carapace/plugin-sdk/provider-model-shared";
import {
...
export default defineSelfHostedOpenAICompatibleProvider({
  ...
  overrides: {
    buildUnknownModelHint: () =>
      ...
      'Set VLLM_API_KEY (any value works) or run "carapace configure". ' +
