...
import type { ChannelDirectoryAdapter } from "carapace/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "carapace/plugin-sdk/directory-runtime";
