...
import { chunkMarkdownTextWithMode, resolveChunkMode } from "carapace/plugin-sdk/reply-chunking";
...
function setupMSTeamsTrace(recorder: WireRecorder, traceCase: MSTeamsTraceCase) {
  ...
  const created = createMSTeamsReplyDispatcher({
    cfg: { channels: { msteams: {} } } as CarapaceConfig,
    agentId: "agent",
    ...
    conversationRef: {
      ...
      agent: { id: "28:trace-bot", name: "Carapace" },
      conversation: {
