...
const ENV_KEYS = ["CARAPACE_OTEL_PRELOADED", "OTEL_PROPAGATORS", "OTEL_SDK_DISABLED"] as const;
...
test("disables every Carapace route while preserving W3C propagation", async () => {
