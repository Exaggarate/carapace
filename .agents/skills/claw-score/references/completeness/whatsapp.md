...
- Channel Setup and Operations: Official @carapace/whatsapp plugin metadata, carapace plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops
