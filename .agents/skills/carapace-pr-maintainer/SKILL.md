---
name: carapace-pr-maintainer
description: "Review, triage, repair, or land Carapace issues and pull requests with current-source evidence and the native maintainer workflow."
---

# Carapace PR Maintainer

Use for the requested Carapace issue/PR operation. Root `AGENTS.md` owns repair,
...
Use `$carapace-testing` to choose proportional proof and its source-trust/host
