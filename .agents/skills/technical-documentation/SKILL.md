...
- Applying repository-specific documentation overlays, including Carapace page-type, docs IA, preservation, and validation rules when present.
...
6. For Carapace docs work, read `references/carapace.md` before the build/review playbook.
