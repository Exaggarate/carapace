...
When the target repo or request is Carapace-specific, layer `references/carapace.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
