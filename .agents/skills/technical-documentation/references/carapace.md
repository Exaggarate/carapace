# Carapace Documentation Overlay

Use this reference only for Carapace docs work. It layers Carapace-specific page
...
- Topic page: explain a major Carapace entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Carapace repo behavior.
