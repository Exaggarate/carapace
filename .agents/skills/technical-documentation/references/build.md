...
- For Carapace docs work, choose a page type from `references/carapace.md` before drafting.
- Keep task-critical Carapace configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Carapace docs work, apply the validation checklist in `references/carapace.md`.
