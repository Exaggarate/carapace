...
- Canonical source: `carapace/agent-skills`, under `skills/autoreview`.
- Before editing any copy, fast-forward a checkout of `carapace/agent-skills` from `origin/main`.
