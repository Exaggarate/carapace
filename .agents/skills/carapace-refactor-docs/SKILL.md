---
name: carapace-refactor-docs
description: Refactor an existing Carapace docs page with source-audited preservation, restructuring, and verification.
---

# Carapace Refactor Docs

## Overview

Use this skill when the user gives a target Carapace docs page and asks to
