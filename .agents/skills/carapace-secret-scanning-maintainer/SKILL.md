---
name: carapace-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Carapace GitHub Secret Scanning alerts in issues or PRs.
---

# Carapace Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/Exaggarate/carapace/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/carapace-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/Exaggarate/carapace/issues/63101#issuecomment-xxx",
