---
name: carapace-update
description: "Route routine updates of an existing local or remote Carapace Gateway to its installation owner, with automatic session recovery. Defer to deployment-specific skills when available."
---
...
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Canonical live main checkout and macOS app | [carapace-live-updater](../carapace-live-updater/SKILL.md).                                                                                                |
