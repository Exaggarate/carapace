---
name: carapace-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm Carapace GHSA security advisories and private-fork state."
---

# Carapace GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-carapace-maintainer`.
...
```bash
fork=$(gh api /repos/carapace/carapace/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/carapace/carapace/security-advisories/<GHSA> \
