...
Set `OPENAI_API_KEY`, or configure it in the active Carapace config file (`$CARAPACE_CONFIG_PATH`, default `~/.carapace/carapace.json`). Optionally set `OPENAI_BASE_URL`:
