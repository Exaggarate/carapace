---
name: healthcheck
description: "Audit/harden Carapace hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Carapace host healthcheck
...
- Never claim Carapace manages OS firewall, SSH, or updates.
...
- Carapace gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `carapace security audit --deep`.
