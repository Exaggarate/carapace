...
metadata: { "carapace": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Carapace CLI path: `node --inspect-brk carapace.mjs ...`
- Carapace test path: `CARAPACE_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
