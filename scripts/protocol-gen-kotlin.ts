// Protocol Gen Kotlin script supports Carapace repository automation.
...
const gatewayOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/carapace/app/gateway/GatewayProtocol.kt",
);
const constantsOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/carapace/app/protocol/CarapaceProtocolConstants.kt",
);
...
const androidEnums: EnumSpec[] = [
  ...
  enumSpec("CarapaceCameraCommand", "camera.", [
    ["List", "list"],
    ["Snap", "snap"],
    ["Clip", "clip"],
  ]),
  enumSpec("CarapaceSmsCommand", "sms.", [
    ["Send", "send"],
    ["Search", "search"],
  ]),
  enumSpec("CarapaceTalkCommand", "talk.", [
    ["PttStart", "ptt.start"],
    ["PttStop", "ptt.stop"],
    ["PttCancel", "ptt.cancel"],
    ["PttOnce", "ptt.once"],
  ]),
  enumSpec("CarapaceLocationCommand", "location.", [["Get", "get"]]),
  enumSpec("CarapaceDeviceCommand", "device.", [
    ["Status", "status"],
    ["Info", "info"],
  ...
  enumSpec("CarapaceNotificationsCommand", "notifications.", [
    ["List", "list"],
    ["Actions", "actions"],
  ]),
  enumSpec("CarapaceSystemCommand", "system.", [["Notify", "notify"]]),
  enumSpec("CarapacePhotosCommand", "photos.", [["Latest", "latest"]]),
  enumSpec("CarapaceContactsCommand", "contacts.", [
    ["Search", "search"],
    ["Add", "add"],
  ]),
  enumSpec("CarapaceCalendarCommand", "calendar.", [
    ["Events", "events"],
    ["Add", "add"],
  ]),
  enumSpec("CarapaceMotionCommand", "motion.", [
    ["Activity", "activity"],
    ["Pedometer", "pedometer"],
  ]),
  enumSpec("CarapaceCallLogCommand", "callLog.", [["Search", "search"]]),
  enumSpec("CarapaceMobileUiCommand", "mobile.ui.", [
    ["Observe", "observe"],
    ["Act", "act"],
  ]),
];
