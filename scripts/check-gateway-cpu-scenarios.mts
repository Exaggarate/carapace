  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          CARAPACE_HOME: qaState.home,
          CARAPACE_STATE_DIR: qaState.stateDir,
          CARAPACE_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    CARAPACE_BUILD_PRIVATE_QA: "1",
    CARAPACE_ENABLE_PRIVATE_QA_CLI: "1",
    CARAPACE_RUN_NODE_SKIP_DTS_BUILD: env.CARAPACE_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    CARAPACE_TEST_DISABLE_UPDATE_CHECK: env.CARAPACE_TEST_DISABLE_UPDATE_CHECK ?? "1",
