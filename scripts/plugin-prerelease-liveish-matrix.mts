...
const LIVEISH_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    env: ["TELEGRAM_BOT_TOKEN", "CARAPACE_TELEGRAM_BOT_TOKEN"],
  },
  {
    probe: "channel-discord",
    env: ["DISCORD_TOKEN", "CARAPACE_DISCORD_TOKEN"],
  },
  {
    probe: "channel-slack",
    env: ["SLACK_BOT_TOKEN", "CARAPACE_SLACK_BOT_TOKEN"],
  },
  {
    probe: "channel-whatsapp",
    env: ["WHATSAPP_ACCESS_TOKEN", "CARAPACE_WHATSAPP_ACCESS_TOKEN"],
  },
]);
