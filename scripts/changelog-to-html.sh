...
if [[ -z "$version_content" ]]; then
  echo "<h2>Carapace $VERSION</h2>"
  echo "<p>Latest Carapace update.</p>"
  echo "<p><a href=\"https://github.com/Exaggarate/carapace/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
