...
profile_path="${1:-$HOME/.carapace-testbox-live.profile}"
helper_path="${2:-$HOME/.local/bin/carapace-testbox-env}"
...
profile_path="\${CARAPACE_TESTBOX_PROFILE_FILE:-\$default_profile_path}"
