...
EXPECTED_COMMIT="$(carapace_trim_build_metadata_value "${EXPECTED_COMMIT}")"
if ! carapace_is_full_git_commit "${EXPECTED_COMMIT}"; then
...
if ! carapace_is_full_git_commit "${CHECKOUT_COMMIT}"; then
