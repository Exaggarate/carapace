...
IMAGE_NAME="$(docker_e2e_resolve_image "carapace-doctor-install-switch-e2e" CARAPACE_DOCTOR_INSTALL_SWITCH_E2E_IMAGE)"
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz doctor-switch "${CARAPACE_CURRENT_PACKAGE_TGZ:-}")"
