...
IMAGE_NAME="$(docker_e2e_resolve_image "carapace-release-plugin-marketplace-e2e" CARAPACE_RELEASE_PLUGIN_MARKETPLACE_E2E_IMAGE)"
SKIP_BUILD="${CARAPACE_RELEASE_PLUGIN_MARKETPLACE_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-plugin-marketplace "${CARAPACE_CURRENT_PACKAGE_TGZ:-}")"
...
CARAPACE_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-plugin-marketplace empty)"
