...
MODEL_REF="${CARAPACE_OPENAI_CHAT_TOOLS_MODEL:?missing CARAPACE_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/carapace-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/carapace-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" CARAPACE_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
