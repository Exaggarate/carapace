...
const JSON_ARTIFACT_MAX_BYTES = readPositiveIntEnv(
  "CARAPACE_PLUGIN_INDEX_JSON_MAX_BYTES",
  1024 * 1024,
);
...
export function writePluginInstallIndexForE2E(index, options = {}) {
  ...
  try {
    ...
    if (storageMode === "current") {
      ...
      const persisted = {
        ...
        index: {
          ...
          warning:
            index.warning ??
            "DO NOT EDIT. This row is generated by Carapace plugin registry commands.",
    ...
    db.prepare(
      ...
      index.warning ?? "DO NOT EDIT. This row is generated by Carapace plugin registry commands.",
      now,
    );
  } finally {
    db.close();
