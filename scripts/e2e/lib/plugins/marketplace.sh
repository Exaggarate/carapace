run_plugins_marketplace_scenario() {
  ...
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/marketplace-list.json" plugins marketplace list claude-fixtures --json
  ...
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/plugins-marketplace.json" plugins list --json
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/plugins-marketplace-shortcut-inspect.json" plugins inspect marketplace-shortcut --runtime --json
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/plugins-marketplace-direct-inspect.json" plugins inspect marketplace-direct --runtime --json
  ...
  write_fixture_plugin \
    ...
    "Marketplace Shortcut"
  run_plugins_carapace_logged update-marketplace-shortcut-dry-run plugins update marketplace-shortcut --dry-run
  run_plugins_fixture_logged update-marketplace-shortcut plugins update marketplace-shortcut
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/plugins-marketplace-updated.json" plugins list --json
  run_plugins_carapace_capture "$CARAPACE_PLUGINS_TMP_DIR/plugins-marketplace-updated-inspect.json" plugins inspect marketplace-shortcut --runtime --json
