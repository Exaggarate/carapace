...
const logPath = process.env.CARAPACE_CONFIG_RELOAD_LOG_PATH ?? "/tmp/config-reload-e2e.log";
const deadlineMs = Date.now() + readPositiveIntEnv("CARAPACE_CONFIG_RELOAD_LOG_TIMEOUT_MS", 30_000);
const maxReadBytes = readPositiveIntEnv("CARAPACE_CONFIG_RELOAD_LOG_MAX_READ_BYTES", 256 * 1024);
