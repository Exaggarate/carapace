...
// Summarizes Carapace performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node --import tsx scripts/carapace-performance-source-summary.mts --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Carapace-native performance probe artifacts for CI reports.`);
}
