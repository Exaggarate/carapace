...
const SCHEMAS = [
  {
    name: "carapace-state",
    schema: "src/state/carapace-state-schema.sql",
    outFile: "src/state/carapace-state-db.generated.d.ts",
  },
  {
    name: "carapace-agent",
    schema: "src/state/carapace-agent-schema.sql",
    outFile: "src/state/carapace-agent-db.generated.d.ts",
  },
];
