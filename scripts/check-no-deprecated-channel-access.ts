// Check No Deprecated Channel Access script supports Carapace repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']carapace\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']carapace\/plugin-sdk\/command-auth["']/u,
  },
];
