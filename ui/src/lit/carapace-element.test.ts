...
import {
  CarapaceLightDomContentsElement,
  CarapaceLightDomElement,
  CarapaceLitElement,
} from "./carapace-element.ts";

const LIGHT_ELEMENT_NAME = "test-carapace-light-dom-element";
const LIGHT_CONTENTS_ELEMENT_NAME = "test-carapace-light-dom-contents-element";
const SHADOW_ELEMENT_NAME = "test-carapace-shadow-dom-element";

class TestLightDomElement extends CarapaceLightDomElement {
  renderCount = 0;
...
class TestShadowDomElement extends CarapaceLitElement {
  override render() {
    return html`<span>shadow content</span>`;
  }
}

class TestLightDomContentsElement extends CarapaceLightDomContentsElement {
  override render() {
...
describe("Carapace Lit elements", () => {
  beforeEach(async () => {
