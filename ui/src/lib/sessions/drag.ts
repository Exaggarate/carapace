...
export const SESSION_DRAG_MIME = "application/x-carapace-session-key";
const SIDEBAR_SECTION_DRAG_MIME = "application/x-carapace-session-group";
const SIDEBAR_ROUTE_DRAG_MIME = "application/x-carapace-sidebar-route";
