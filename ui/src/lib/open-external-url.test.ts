...
describe("resolveSafeExternalUrl", () => {
  const baseHref = "https://github.com/Exaggarate/carapace";
  ...
  it("allows blob URLs", () => {
    expect(resolveSafeExternalUrl("blob:https://github.com/Exaggarate/carapace", baseHref)).toBe(
      "blob:https://github.com/Exaggarate/carapace",
    );
  });
...
describe("openExternalUrlSafe", () => {
  it("nulls opener when window.open returns a proxy-like object", () => {
    ...
    const opened = openExternalUrlSafe("https://example.com/safe.png", {
      baseHref: "https://github.com/Exaggarate/carapace",
    });
