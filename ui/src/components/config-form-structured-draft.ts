...
class ConfigFormStructuredDraft extends CarapaceLightDomElement {
...
if (!customElements.get("carapace-config-form-structured-draft")) {
  customElements.define("carapace-config-form-structured-draft", ConfigFormStructuredDraft);
}
