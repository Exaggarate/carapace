...
class WorkingPhrase extends CarapaceLightDomContentsElement {
...
if (!customElements.get("carapace-working-phrase")) {
  customElements.define("carapace-working-phrase", WorkingPhrase);
}
