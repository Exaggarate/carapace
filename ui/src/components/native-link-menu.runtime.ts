...
export class NativeLinkMenu extends CarapaceLightDomElement {
...
if (!customElements.get("carapace-native-link-menu")) {
  customElements.define("carapace-native-link-menu", NativeLinkMenu);
}
