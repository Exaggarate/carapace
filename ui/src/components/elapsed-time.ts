...
class ElapsedTime extends CarapaceLightDomContentsElement {
...
if (!customElements.get("carapace-elapsed-time")) {
  customElements.define("carapace-elapsed-time", ElapsedTime);
}
