...
describe("renderAbout", () => {
  ...
  it("renders the hero with Clawd, identity, community links, and license", () => {
    ...
    expect(hero?.querySelector(".about-hero__name")?.textContent).toBe("Carapace");
  ...
  it("keeps version, commit, branch, and localized UTC build date in one facts grid", () => {
    ...
    expect(commitAge?.nextElementSibling?.tagName.toLowerCase()).toBe("carapace-tooltip");
