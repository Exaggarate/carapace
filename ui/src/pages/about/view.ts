...
const ABOUT_LINKS: ReadonlyArray<{ href: string; icon: TemplateResult; label: () => string }> = [
  { href: "https://github.com/Exaggarate/carapace", icon: icons.globe, label: () => t("aboutPage.linkWebsite") },
  { href: "https://github.com/Exaggarate/carapace", icon: icons.book, label: () => t("aboutPage.linkDocs") },
  {
