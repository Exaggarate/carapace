...
class AgentMemoryPanel extends CarapaceLightDomElement {
...
if (!customElements.get("carapace-agent-memory-panel")) {
  customElements.define("carapace-agent-memory-panel", AgentMemoryPanel);
}
