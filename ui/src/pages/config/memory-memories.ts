...
class MemoryMemoriesElement extends CarapaceLightDomElement {
...
if (!customElements.get("carapace-memory-memories")) {
  customElements.define("carapace-memory-memories", MemoryMemoriesElement);
}
