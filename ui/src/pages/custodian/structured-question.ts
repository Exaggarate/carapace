...
import { normalizeNullableString as nonEmptyString } from "@carapace/normalization-core/string-coerce";
...
/**
 * Sanitize the typed `question` field from `carapace.chat`. The gateway owns
