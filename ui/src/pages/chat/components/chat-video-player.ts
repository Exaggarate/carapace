...
class ChatVideoPlayer extends CarapaceLightDomContentsElement {
  @property() src = "";
...
if (!customElements.get("carapace-chat-video-player")) {
  customElements.define("carapace-chat-video-player", ChatVideoPlayer);
}

declare global {
  interface HTMLElementTagNameMap {
    "carapace-chat-video-player": ChatVideoPlayer;
  }
}
