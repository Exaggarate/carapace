      ...
      if (installCalls <= 2) {
        throw new GatewayRequestError({
          ...
          details: {
            ...
            targetName: "@carapace/bluebubbles",
            targetType: "plugin",
            requestMode: "install",
      ...
      createPluginsRouteData(
        ...
        createResult(
          createPlugin({
            ...
            enabled: false,
            state: "not-installed",
            install: { source: "official", pluginId: "@carapace/bluebubbles" },
          }),
        ),
      ),
    );
    const installIdentity = "plugin:@carapace/bluebubbles";
    const catalogRequest = {
      source: "official",
      pluginId: "@carapace/bluebubbles",
