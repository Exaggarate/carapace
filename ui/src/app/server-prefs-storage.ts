...
export const LAST_SEEN_KEY = "carapace.control.serverPrefs.v1";
...
export const PENDING_KEY = "carapace.control.serverPrefs.pending.v1";
...
const RETAINED_LOCAL_KEY = "carapace.control.serverPrefs.retained-local.v1";
