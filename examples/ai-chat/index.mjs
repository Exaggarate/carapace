// Minimal @carapace/ai consumer: one isolated runtime, built-in providers,
// one streamed completion. Uses only the public package surface — no Carapace
...
const prompt =
  ...
  "Reply with one short sentence: what is @carapace/ai?";
