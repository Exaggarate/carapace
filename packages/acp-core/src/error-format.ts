...
const STRUCTURED_AUTH_MARKER_PREFIX = ";__carapace_structured_auth_redacted_";

// Minimal fallback for standalone or unwired ACP core. Carapace injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Carapace-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@carapace/normalization-core/error-coercion";
