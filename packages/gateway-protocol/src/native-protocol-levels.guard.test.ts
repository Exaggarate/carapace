...
describe("native Gateway protocol levels", () => {
  it("match the TypeScript source of truth", async () => {
    ...
    const androidPath = "apps/android/app/src/main/java/ai/carapace/app/gateway/GatewayProtocol.kt";
  ...
  it("uses the min constant for native connect compatibility ranges", async () => {
    const swiftChannelPath = "apps/shared/CarapaceKit/Sources/CarapaceKit/GatewayChannel.swift";
    const swiftChannel = await readRepoFile(swiftChannelPath);
    const swiftRangePath =
      "apps/shared/CarapaceKit/Sources/CarapaceKit/GatewayConnectFailureBackoff.swift";
    ...
    const swiftWizardPath = "apps/macos/Sources/CarapaceMacCLI/WizardCommand.swift";
    ...
    const androidPath = "apps/android/app/src/main/java/ai/carapace/app/gateway/GatewaySession.kt";
    const android = await readRepoFile(androidPath);
    assertPattern(
      android,
      androidPath,
