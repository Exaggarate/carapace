// Gateway Protocol schema module defines Carapace chat payloads.
...
/**
 * Carapace chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One Carapace reply; `action` tells clients about conversation handoffs. */
