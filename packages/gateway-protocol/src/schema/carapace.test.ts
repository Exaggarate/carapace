...
describe("Carapace chat params protocol", () => {
...
describe("Carapace chat question protocol", () => {
  const question = {
...
describe("Carapace chat history protocol", () => {
...
describe("Carapace interactive activation protocol", () => {
...
describe("Carapace setup detection protocol", () => {
      ...
      unavailableCandidates: [
        {
          ...
          reason: "Reconnect through Carapace or use a Gemini API key.",
...
describe("Carapace setup verification protocol", () => {
