// Process-default registry/runtime retained for the Carapace compatibility
...
const DEFAULT_RUNTIME_KEY = Symbol.for("github.com/Exaggarate/carapace.defaultRuntime");
