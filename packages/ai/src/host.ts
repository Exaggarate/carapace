...
// the embedding application (Carapace core installs its implementations via
...
import type { Api, Context, Model, StreamFn } from "@carapace/llm-core";
...
/** Transport-safe provider policy input kept independent of Carapace config types. */
