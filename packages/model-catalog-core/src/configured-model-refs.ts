// Collects configured model references from Carapace config-shaped objects.
import { asNonArrayRecord, isRecord } from "@carapace/normalization-core/record-coerce";
