import type { ImageContent, Message, TextContent } from "@carapace/llm-core";
import { parseDateStringTimestampMs as parseSessionTimestampMs } from "@carapace/normalization-core/number-coercion";
