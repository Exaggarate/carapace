...
/** Install Carapace-owned loop control without adding a plugin-facing Agent option. */
...
/** Attach Carapace-owned two-phase execution without changing the public AgentTool shape. */
