...
describe("plugin loader records", () => {
  ...
  it.each([
    ...
    vi.stubEnv("CARAPACE_PLUGIN_LIFECYCLE_TRACE", diagnostics);
  ...
  it.each([
    {
      ...
      expected: "install @carapace/discord (Error: import failed)",
    },
    {
    ...
    recordPluginError({
      ...
      logPrefix: "",
      diagnosticMessagePrefix: "",
      missingDependencyHint: "install @carapace/discord",
    });
