...
} from "@carapace/model-catalog-core/model-catalog-refs";
import {
...
export function collectConfiguredWebSearchProviderIds(config: CarapaceConfig): ReadonlySet<string> {
...
function isMemorySlotExplicitlyDisabled(config: CarapaceConfig): boolean {
