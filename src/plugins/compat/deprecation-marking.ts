...
export const DEPRECATION_MARKING_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "carapace/plugin-sdk/provider-stream GOOGLE_THINKING_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream KILOCODE_THINKING_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream MOONSHOT_THINKING_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream MINIMAX_FAST_MODE_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream OPENAI_RESPONSES_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream OPENROUTER_THINKING_STREAM_HOOKS",
      "carapace/plugin-sdk/provider-stream TOOL_STREAM_DEFAULT_ON_HOOKS",
      "carapace/plugin-sdk/provider-stream-shared defaultToolStreamExtraParams",
      "carapace/plugin-sdk/provider-stream-shared stripTrailingAnthropicAssistantPrefillWhenThinking",
      "carapace/plugin-sdk/provider-stream-shared createAnthropicThinkingPrefillPayloadWrapper",
      "carapace/plugin-sdk/provider-stream-shared OpenAICompatibleThinkingLevel",
      "carapace/plugin-sdk/provider-stream-shared isOpenAICompatibleThinkingEnabled",
      "carapace/plugin-sdk/provider-stream-shared DeepSeekV4ThinkingLevel",
      "carapace/plugin-sdk/provider-stream-shared DeepSeekV4ReasoningEffort",
      "carapace/plugin-sdk/provider-stream-shared createDeepSeekV4OpenAICompatibleThinkingWrapper",
      "carapace/plugin-sdk/provider-stream-shared createThinkingOnlyFinalTextWrapper",
      "carapace/plugin-sdk/provider-stream-shared createGoogleThinkingPayloadWrapper",
      "carapace/plugin-sdk/provider-stream-shared createGoogleThinkingStreamWrapper",
      "carapace/plugin-sdk/provider-model-shared isProxyReasoningUnsupportedModelHint",
      "carapace/plugin-sdk/provider-model-shared OPENAI_COMPATIBLE_REPLAY_HOOKS",
      "carapace/plugin-sdk/provider-model-shared ANTHROPIC_BY_MODEL_REPLAY_HOOKS",
      "carapace/plugin-sdk/provider-model-shared NATIVE_ANTHROPIC_REPLAY_HOOKS",
      "carapace/plugin-sdk/provider-model-shared PASSTHROUGH_GEMINI_REPLAY_HOOKS",
      "carapace/plugin-sdk/provider-auth DEFAULT_COPILOT_API_BASE_URL",
      "carapace/plugin-sdk/provider-auth deriveCopilotApiBaseUrlFromToken",
      "carapace/plugin-sdk/provider-auth resolveCopilotApiToken",
      "carapace/plugin-sdk/provider-auth-copilot-cache CachedCopilotToken",
      "carapace/plugin-sdk/oauth-utils toFormUrlEncoded",
      "carapace/plugin-sdk/oauth-utils generatePkceVerifierChallenge",
      "carapace/plugin-sdk/provider-oauth-runtime OAuthProvider",
      "carapace/plugin-sdk/provider-oauth-runtime OAuthProviderInfo",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "carapace/plugin-sdk/reply-payload ReplyPayload.interactive",
      "reduceInteractiveReply",
      "@carapace/discord buildDiscordInteractiveComponents",
      "@carapace/slack buildSlackInteractiveBlocks",
      "@carapace/telegram buildTelegramInteractiveButtons",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "carapace/plugin-sdk/acp-runtime __testing",
      "carapace/plugin-sdk/approval-reaction-runtime",
      "carapace/plugin-sdk/channel-inbound BuildChannelTurnContextParams",
      "carapace/plugin-sdk/channel-inbound BuiltChannelTurnContext",
      "carapace/plugin-sdk/channel-inbound buildChannelTurnContext",
      "carapace/plugin-sdk/channel-inbound finalizeChannelInboundContext",
      "carapace/plugin-sdk/channel-inbound filterChannelTurnSupplementalContext",
      "carapace/plugin-sdk/channel-send-result ChannelSendRawResult",
      "carapace/plugin-sdk/command-auth",
      "carapace/plugin-sdk/command-auth ResolveSenderCommandAuthorizationParams",
      "carapace/plugin-sdk/command-auth resolveCommandAuthorizedFromAuthorizers",
      "carapace/plugin-sdk/command-auth CommandAuthorizationRuntime",
      "carapace/plugin-sdk/command-auth ResolveSenderCommandAuthorizationWithRuntimeParams",
      "carapace/plugin-sdk/command-auth resolveDirectDmAuthorizationOutcome",
      "carapace/plugin-sdk/command-auth resolveSenderCommandAuthorizationWithRuntime",
      "carapace/plugin-sdk/command-auth resolveSenderCommandAuthorization",
      "carapace/plugin-sdk/keyed-async-queue KeyedAsyncQueue.getTailMapForTesting",
      "carapace/plugin-sdk/persistent-dedupe PersistentDedupeLegacyPathOptions.lockOptions",
      "carapace/plugin-sdk/retry-runtime createTelegramRetryRunner",
      "carapace/plugin-sdk/ssrf-policy SsrfPolicyOptions.allowPrivateNetwork",
      "carapace/plugin-sdk/ssrf-policy ssrfPolicyFromAllowPrivateNetwork",
      "carapace/plugin-sdk/tts-runtime TtsSynthesisStreamResult",
      "carapace/plugin-sdk/tts-runtime TtsRuntimeFacade._test",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    surfaces: [
      "@carapace/google-meet __testing",
      "@carapace/discord buildDiscordInteractiveComponents",
      "@carapace/discord normalizeDiscordListenerTimeoutMs",
      "@carapace/discord normalizeDiscordInboundWorkerTimeoutMs",
      "@carapace/discord isAbortError",
      "@carapace/discord runDiscordTaskWithTimeout",
      "@carapace/slack buildSlackInteractiveBlocks",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "@carapace/memory-host-sdk ensureMemoryIndexSchema.embeddingCacheTable",
      "@carapace/memory-host-sdk ensureMemoryIndexSchema.ftsTable",
      "@carapace/memory-host-sdk/runtime-core loadConfig",
      "@carapace/memory-host-sdk/host/carapace-runtime loadConfig",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "CarapacePluginApi.registerSessionExtension",
      "CarapacePluginApi.enqueueNextTurnInjection",
      "CarapacePluginApi.registerControlUiDescriptor",
      "CarapacePluginApi.registerRuntimeLifecycle",
      "CarapacePluginApi.registerAgentEventSubscription",
      "CarapacePluginApi.emitAgentEvent",
      "CarapacePluginApi.setRunContext",
      "CarapacePluginApi.getRunContext",
      "CarapacePluginApi.clearRunContext",
      "CarapacePluginApi.registerSessionSchedulerJob",
      "CarapacePluginApi.registerSessionAction",
      "CarapacePluginApi.sendSessionAttachment",
      "CarapacePluginApi.scheduleSessionTurn",
      "CarapacePluginApi.unscheduleSessionTurnsByTag",
