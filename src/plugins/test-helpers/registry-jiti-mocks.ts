...
vi.mock("../discovery.js", () => ({
  discoverCarapacePlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverCarapacePlugins>
  ) => registryJitiMocks.discoverCarapacePlugins(...args),
}));
...
export function resetRegistryJitiMocks(): void {
  ...
  registryJitiMocks.discoverCarapacePlugins.mockReset();
  registryJitiMocks.loadPluginManifestRegistry.mockReset();
  registryJitiMocks.loadPluginRegistrySnapshot.mockReset();
  registryJitiMocks.discoverCarapacePlugins.mockReturnValue({
    candidates: [],
    diagnostics: [],
  });
