...
export function normalizePluginsConfigForInstalledIndex(
  config: CarapaceConfig["plugins"] | undefined,
...
function resolveGatewayStartupDreamingEngineId(config: CarapaceConfig): string | undefined {
...
function resolveGatewayStartupDreamingSelectedPluginId(config: CarapaceConfig): string | undefined {
...
export function collectConfiguredProviderIds(config: CarapaceConfig): string[] {
...
export function collectValidationConfiguredProviderIds(config: CarapaceConfig): string[] {
...
export function collectValidationConfiguredShorthandModelIds(config: CarapaceConfig): string[] {
  return sortUniquePluginIds(
