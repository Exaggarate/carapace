...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [contractPluginPath({
    ...
    'export type { CarapacePluginServiceContext } from "./api.js";',
  ],
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "carapace/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "carapace/plugin-sdk/status-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiCarapaceConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [contractPluginPath({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "carapace/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "carapace/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "carapace/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "carapace/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "carapace/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "carapace/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "carapace/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "carapace/plugin-sdk/webhook-request-guards";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "carapace/plugin-sdk/allow-from";',
      'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "carapace/plugin-sdk/channel-contract";',
      ...
      'export { createChannelMessageReplyPipeline } from "carapace/plugin-sdk/channel-outbound";',
      'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "carapace/plugin-sdk/channel-status";',
      'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "carapace/plugin-sdk/channel-targets";',
      'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, CarapaceConfig } from "carapace/plugin-sdk/config-contracts";',
      'export { isDangerousNameMatchingEnabled } from "carapace/plugin-sdk/dangerous-name-runtime";',
      ...
      'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension } from "carapace/plugin-sdk/media-runtime";',
      'export { resolveChannelMediaMaxBytes } from "carapace/plugin-sdk/account-helpers";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "carapace/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "carapace/plugin-sdk/channel-contract";',
    'export type { CarapaceConfig } from "carapace/plugin-sdk/config-contracts";',
  ...
  [contractPluginPath({
    ...
    'export { createChannelPairingController } from "carapace/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, CarapaceConfig } from "carapace/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "carapace/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "carapace/plugin-sdk/channel-outbound";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "signal", relativePath: "runtime-api.ts" })]: [
    ...
    'export { DEFAULT_ACCOUNT_ID, applyAccountNameToChannelSection, deleteAccountFromConfigSection, emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta, migrateBaseNameToDefaultAccount, normalizeAccountId, setAccountEnabledInConfigSection } from "carapace/plugin-sdk/core";',
    'export { resolveChannelMediaMaxBytes } from "carapace/plugin-sdk/account-helpers";',
    ...
    'export { resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy } from "carapace/plugin-sdk/runtime-group-policy";',
    'export { buildBaseAccountStatusSnapshot, buildBaseChannelStatusSummary, collectStatusIssuesFromLastError, createDefaultChannelRuntimeState } from "carapace/plugin-sdk/status-helpers";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { CarapacePluginService, CarapacePluginServiceContext, PluginLogger } from "carapace/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "carapace/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "carapace/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "carapace/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "carapace/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "carapace/plugin-sdk/channel-core";',
      'export { buildChannelConfigSchema, TelegramConfigSchema } from "./config-api.js";',
      'export { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "carapace/plugin-sdk/account-id";',
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "carapace/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "carapace/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "carapace/plugin-sdk/channel-core";',
      'export type { CarapaceConfig } from "carapace/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeCarapaceConfig["channels"]>["telegram"] >;',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "carapace/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "carapace/plugin-sdk/channel-core";',
  ...
  [contractPluginPath({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText, sendHttpRequestRejection } from "carapace/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "carapace/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"carapace/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'carapace/plugin-sdk/${pluginId}'`);
