...
const BUNDLED_EXTENSION_CONFIG_IMPORT_GUARDS = [
  {
    ...
    allowedSpecifier: "carapace/plugin-sdk/channel-config-schema",
    forbiddenSpecifier: "carapace/plugin-sdk/bundled-channel-config-schema",
  },
  {
  ...
  },
  {
    ...
    forbiddenSpecifier: "carapace/plugin-sdk/channel-config-schema",
  },
  {
