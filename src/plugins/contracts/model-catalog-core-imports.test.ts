...
const LEGACY_MODEL_CATALOG_BRIDGES = new Map([
  [path.join(REPO_ROOT, "src/agents/provider-id.ts"), "@carapace/model-catalog-core/provider-id"],
  [
    path.join(REPO_ROOT, "src/model-catalog/refs.ts"),
    "@carapace/model-catalog-core/model-catalog-refs",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/normalize.ts"),
    "@carapace/model-catalog-core/model-catalog-normalize",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/types.ts"),
    "@carapace/model-catalog-core/model-catalog-types",
  ],
  [
    path.join(REPO_ROOT, "src/config/model-refs.ts"),
    "@carapace/model-catalog-core/configured-model-refs",
  ],
  [
    path.join(REPO_ROOT, "src/shared/provider-model-id-normalization.ts"),
    "@carapace/model-catalog-core/provider-model-id-normalization",
  ],
  [
