const PLUGIN_CANDIDATE_INSTALL_OWNER = Symbol.for("carapace.pluginCandidateInstallOwner");
const PLUGIN_INSTALL_OWNER_LOOKUP = Symbol.for("carapace.pluginInstallOwnerLookup");
