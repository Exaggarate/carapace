...
export const PLUGIN_INSTALL_ERROR_CODE = {
  ...
  MISSING_CARAPACE_EXTENSIONS: "missing_carapace_extensions",
  MISSING_PLUGIN_MANIFEST: "missing_plugin_manifest",
  EMPTY_CARAPACE_EXTENSIONS: "empty_carapace_extensions",
  INVALID_CARAPACE_EXTENSIONS: "invalid_carapace_extensions",
