...
const PLUGIN_INSTALL_ROOT_CONTEXT_KEY = Symbol.for("carapace.pluginInstallRootContext");
 ...
 * redirects CARAPACE_STATE_DIR for ephemeral sessions and runtime state.
 */
