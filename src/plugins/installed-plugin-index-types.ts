...
import type { CarapacePackageBuild, PluginPackageChannel } from "./package-manifest.types.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Carapace from plugin manifests, install records, and config policy. Use `carapace plugins registry --refresh`, `carapace plugins install/update/uninstall`, or `carapace plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored carapace.install metadata. This describes catalog/package
