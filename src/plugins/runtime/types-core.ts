...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.carapace.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.carapace.js").CarapaceConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.carapace.js").CarapaceConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.carapace.js").CarapaceConfig>;
    /**
  ...
  media: {
    ...
    detectMime: typeof import("@carapace/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@carapace/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("carapace/plugin-sdk/llm").Model<import("carapace/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.carapace.js").CarapaceConfig;
      workspaceDir?: string;
