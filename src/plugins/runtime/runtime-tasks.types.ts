...
import type { CarapacePluginToolContext } from "../tool-types.js";
...
export type BoundTaskRunsRuntime = {
  ...
  cancel: (params: { taskId: string; cfg: CarapaceConfig }) => Promise<TaskRunCancelResult>;
};
...
export type PluginRuntimeTaskRuns = {
  ...
  fromToolContext: (
    ctx: Pick<CarapacePluginToolContext, "sessionKey" | "agentId" | "deliveryContext">,
  ) => BoundTaskRunsRuntime;
};
...
export type PluginRuntimeTaskFlows = {
  ...
  fromToolContext: (
    ctx: Pick<CarapacePluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowsRuntime;
};
