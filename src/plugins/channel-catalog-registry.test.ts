...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/carapace-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/carapace-weixin@2.3.7",
    installPath:
      "/tmp/carapace-test-home/.carapace/npm/node_modules/@tencent-weixin/carapace-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverCarapacePlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/carapace-test-plugin/index.js",
    rootDir: "/tmp/carapace-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/carapace-test-plugin",
    packageManifest: {
