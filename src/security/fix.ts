...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CarapaceConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CarapaceConfig; env: NodeJS.ProcessEnv }): {
  cfg: CarapaceConfig;
  changes: string[];
} {
