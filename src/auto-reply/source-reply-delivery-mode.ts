...
export function buildHarnessVisibleReplyGuidance(params: {
  ...
  const deliveryGuidance = messageToolOwnsVisibleReply(params)
    ...
    : params.messageToolAvailable
      ? "You can participate in the conversation throughout your work. Use `message` when you have something worth saying; you don’t need to wait until you’re finished, and sending a message doesn’t end your task. Carapace delivers your final response automatically."
      : "For the current source conversation, reply normally in your final assistant message; Carapace will deliver it through the active source conversation.";
