...
const suiteTempDirs = createSuiteTempRootTracker({ prefix: "carapace-abort-" });
...
describe("abort detection", () => {
  ...
  it("isAbortRequestText aligns abort command semantics", () => {
    ...
    expect(isAbortRequestText("stop carapace!!!")).toBe(true);
    ...
    expect(isAbortRequestText("/stop@carapace_bot", { botUsername: "carapace_bot" })).toBe(true);
    expect(isAbortRequestText("/Stop@carapace_bot", { botUsername: "carapace_bot" })).toBe(true);
    expect(
