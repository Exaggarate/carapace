...
const acpMocks = vi.hoisted(() => ({
  ...
  readAcpSessionEntry: vi.fn<
    (params: { sessionKey: string; agentId?: string; cfg?: CarapaceConfig }) => unknown
  >(() => null),
...
vi.mock("./dispatch-acp-manager.runtime.js", () => ({
  ...
  readAcpSessionEntry: (params: { sessionKey: string; agentId?: string; cfg?: CarapaceConfig }) =>
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: CarapaceConfig) => ttsMocks.resolveTtsConfig(cfg),
}));
...
vi.mock("../../tts/tts-config.js", () => ({
  normalizeTtsAutoMode: (value: unknown) => ttsMocks.normalizeTtsAutoMode(value),
  resolveConfiguredTtsMode: (cfg: CarapaceConfig) => ttsMocks.resolveTtsConfig(cfg).mode,
  resolveEffectiveTtsConfig: (cfg: CarapaceConfig) => cfg.tts ?? {},
...
export const emptyConfig = {} as CarapaceConfig;
