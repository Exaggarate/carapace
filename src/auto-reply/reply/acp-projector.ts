// Projects ACP runtime events into Carapace-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@carapace/acp-core/runtime/types";
import {
