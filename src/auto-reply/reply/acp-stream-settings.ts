...
import type { AcpSessionUpdateTag } from "@carapace/acp-core/runtime/types";
...
export function resolveAcpProjectionSettings(cfg: CarapaceConfig): AcpProjectionSettings {
