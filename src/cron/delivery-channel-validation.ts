...
function hasExplicitChannelConfigEntry(cfg: CarapaceConfig): boolean {
...
export async function assertValidCronCreateDelivery(cfg: CarapaceConfig, job: CronJobCreate) {
