...
describe("avatar policy", () => {
  it("classifies avatar URI and path helpers directly", () => {
    ...
    expect(isWindowsAbsolutePath("C:\\\\avatars\\\\carapace.png")).toBe(true);
  });
  ...
  it("detects avatar-like path strings", () => {
    expect(looksLikeAvatarPath("avatars/carapace.svg")).toBe(true);
    expect(looksLikeAvatarPath("carapace.webp")).toBe(true);
