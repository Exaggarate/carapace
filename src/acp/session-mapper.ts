/** Resolves ACP request metadata into Carapace Gateway session keys and reset behavior. */
import { readBool, readMetadataString } from "@carapace/acp-core/meta";
...
/** Parses ACP request metadata into Carapace session routing hints. */
