...
import { createInMemorySessionStore, type AcpSessionStore } from "@carapace/acp-core/session";
...
/** ACP Agent implementation backed by the Carapace Gateway and replay ledger. */
