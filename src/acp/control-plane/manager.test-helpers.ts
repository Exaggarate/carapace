...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@carapace/acp-core/runtime/types";
...
export type { AcpRuntime, CarapaceConfig, SessionAcpMeta };
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("CARAPACE_STATE_DIR", ORIGINAL_STATE_DIR);
    }
