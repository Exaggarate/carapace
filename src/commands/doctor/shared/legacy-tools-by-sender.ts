...
export function scanLegacyToolsBySenderKeys(cfg: CarapaceConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: CarapaceConfig): {
