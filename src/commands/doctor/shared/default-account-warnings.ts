...
export function collectMissingDefaultAccountBindingWarnings(cfg: CarapaceConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: CarapaceConfig): string[] {
  const warnings: string[] = [];
