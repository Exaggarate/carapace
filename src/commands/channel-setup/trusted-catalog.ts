...
function resolveEffectiveTrustConfig(cfg: CarapaceConfig, env?: NodeJS.ProcessEnv): CarapaceConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: CarapaceConfig): string[] | undefined {
