  ...
  it("returns a low-space warning finding", () => {
    ...
    expect(findings).toEqual([
      expect.objectContaining({
        ...
        severity: "warning",
        message: "Low disk space: 300 MB free on the partition containing /home/test/.carapace.",
  ...
  it("returns a critical-space error finding", () => {
    ...
    expect(findings).toEqual([
      expect.objectContaining({
        checkId: "core/doctor/disk-space",
        severity: "error",
        message: "CRITICAL: only 50 MB free on the partition containing /home/test/.carapace.",
        path: "/home/test/.carapace",
        target: "50 MB",
        requirement: "critical-free-space",
