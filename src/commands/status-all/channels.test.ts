      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run carapace plugins install @carapace/feishu or carapace doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run carapace doctor --fix",
        },
      ],
      details: [],
    });
