...
/** Detects only marker-backed catalogs produced by tagged Carapace releases. */
...
export async function maybeMigrateLegacyPluginModelCatalogs(params: {
  ...
  emitNote(
    [
      ...
      "Run carapace doctor --fix to verify and migrate these catalogs into agent SQLite.",
    ].join("\n"),
