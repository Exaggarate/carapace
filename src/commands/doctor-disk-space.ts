// Doctor contribution for low disk space around the Carapace state directory.
import os from "node:os";
import { expectDefined, formatByteSize } from "@carapace/normalization-core";
 ...
 *
 * This catches a common operational failure mode where Carapace silently
