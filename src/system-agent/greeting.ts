...
export const SYSTEM_AGENT_EXTERNAL_EDIT_ALERT =
  "Heads up: the config was edited outside Carapace while I was away — open History to review it.";
...
export function buildSystemAgentGreetingQuestion(
  ...
  if (!overview.config.exists) {
    addQuickAction(exceptional, { label: "Set up Carapace", reply: "setup" });
