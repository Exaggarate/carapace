...
const INFERENCE_UNAVAILABLE_MESSAGE =
  "Carapace could not reach working inference. Run `carapace onboard` on the machine running Carapace to reconnect — it live-tests the route before saving it. Then try again.";
...
/** Safe public error for an Carapace turn that could not complete with intelligence. */
