// Carapace audit helpers persist approved local-state changes.
import { randomUUID } from "node:crypto";
import { createSqliteAuditRecordStore } from "../infra/sqlite-audit-record-store.js";
import { redactSecrets } from "../logging/redact.js";

/**
 * Append-only audit log helpers for Carapace writes.
 *
...
/** Append one Carapace audit entry and return its SQLite owner label. */
