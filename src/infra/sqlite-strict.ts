// Migrates Carapace-owned SQLite tables to canonical STRICT schemas.
...
const STRICT_MIGRATION_TABLE_PREFIX = "__carapace_strict_migration_";
...
/** Atomically upgrade Carapace-owned tables described by a canonical STRICT schema. */
