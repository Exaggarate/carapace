...
const LAUNCHER_ENCODING_MARKER_PREFIX = "@rem carapace-launcher-encoding=";
const LAUNCHER_ENCODING_MARKER_RE = /^@rem carapace-launcher-encoding=(\S+)\s*$/;
...
/** Decodes launcher scripts written by any Carapace version (UTF-16 LE BOM, marked code page, or UTF-8). */
