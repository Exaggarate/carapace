...
import { normalizeUniqueStringEntriesLower } from "@carapace/normalization-core/string-normalization";
import type { CarapaceConfig } from "../config/types.carapace.js";

const DIAGNOSTICS_ENV = "CARAPACE_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `CARAPACE_DIAGNOSTICS` overrides. */
