...
describe("normalizePackageTagInput", () => {
  const packageNames = ["carapace", "@carapace/plugin"] as const;

  it.each([
    { input: undefined, expected: null },
    { input: "   ", expected: null },
    { input: "carapace@beta", expected: "beta" },
    { input: "@carapace/plugin@2026.2.24", expected: "2026.2.24" },
    { input: "carapace@   ", expected: null },
    { input: "carapace", expected: null },
    { input: " @carapace/plugin ", expected: null },
    { input: " latest ", expected: "latest" },
    { input: "@other/plugin@beta", expected: "@other/plugin@beta" },
    { input: "carapaceer@beta", expected: "carapaceer@beta" },
