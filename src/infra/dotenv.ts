...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "CARAPACE_OAUTH_DIR",
  "CARAPACE_PINNED_PYTHON",
  "CARAPACE_PINNED_WRITE_PYTHON",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "AWS_ENDPOINT_URL_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Carapace runtime namespace
  // for shell/global config so new CARAPACE_* controls are fail-closed by default.
  "CARAPACE_",
  "CARAPACE_DISABLE_",
  "CARAPACE_SKIP_",
  "CARAPACE_UPDATE_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.carapace/.env (or CARAPACE_STATE_DIR/.env),
