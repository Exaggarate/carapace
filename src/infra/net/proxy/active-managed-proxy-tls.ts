// Resolves Carapace-managed proxy TLS trust for non-Undici transports.
...
const MANAGED_PROXY_ENV_PREFIX = ["CARAPACE", "PROXY"].join("_");
...
/** Resolves managed proxy TLS trust only when the target proxy is Carapace's active proxy. */
