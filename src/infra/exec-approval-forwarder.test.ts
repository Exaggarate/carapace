...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): CarapaceConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): CarapaceConfig {
  return {
