...
export function buildRealtimeVoiceSpeakExactMessage(params: {
  ...
  return [
    ...
    `Speak this exact Carapace answer to ${params.surfaceLabel}, without adding, removing, or rephrasing words.`,
...
export function classifyRealtimeVoiceConsultToolCall(
  ...
  if (message.includes("Speak this exact Carapace answer")) {
