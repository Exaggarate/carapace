...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["carapace.chat", "system-agent", "operator.admin", "<=2026.7"],
  ["carapace.chat.history", "system-agent", "operator.admin", "2026.7"],
  ["carapace.changes.list", "system-changes", "operator.admin", "<=2026.7"],
  ["carapace.approval.list", "system-agent", "operator.approvals", "<=2026.7"],
  ["carapace.setup.detect", "system-agent", "operator.admin", "<=2026.7"],
  ...
  ["carapace.setup.activate", "system-agent", "operator.admin", "<=2026.7"],
  ["carapace.setup.activate.start", "system-agent", "operator.admin", "2026.8"],
  ["carapace.setup.auth.start", "system-agent", "operator.admin", "<=2026.7"],
  ["carapace.setup.prepare.start", "system-agent", "operator.admin", "<=2026.7"],
  ...
  ["carapace.setup.verify", "system-agent", "operator.admin", "<=2026.7"],
