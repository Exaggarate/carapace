...
export function restoreCanonicalSecretRefs(
  ...
  return projectCanonicalSecretRefsOntoRuntime(sourceConfig, runtimeConfig) as CarapaceConfig;
}
...
export function revokeActiveSkillReviewsBeforeConfigPublication(config: CarapaceConfig): void {
