...
import { asNonNegativeFiniteNumber as normalizeAttachmentNumber } from "@carapace/normalization-core/number-coercion";
...
export function normalizeRpcAttachmentsToChatAttachments(
  ...
  // Accept both the Carapace attachment fields and Anthropic-style
