...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CarapaceConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CarapaceConfig): void {
