...
export function operatorSessionCap(client: GatewayClient | null, cfg: CarapaceConfig) {
  return resolveOperatorRolePolicy(client, cfg)?.sessions.others;
}

export function hasOperatorBoundary(client: GatewayClient | null, cfg: CarapaceConfig): boolean {
