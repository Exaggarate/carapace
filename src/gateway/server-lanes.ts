...
export function resolveGatewayLaneConcurrency(cfg: CarapaceConfig): GatewayLaneConcurrency {
...
export function applyGatewayLaneConcurrency(
  ...
  // is precisely the additive-capacity behaviour carapace#98813 was held for.
