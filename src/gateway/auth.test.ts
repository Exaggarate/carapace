...
describe("gateway auth", () => {
  ...
  it("resolves token/password from CARAPACE gateway env vars", () => {
  ...
  it("accepts password mode when env provides CARAPACE_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        CARAPACE_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
