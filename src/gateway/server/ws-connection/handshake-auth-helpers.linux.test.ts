// Linux native-app admission tests: carapace-linux joins the native UI client class,
...
describe("linux native-app handshake admission", () => {
  it("auto-approves local carapace-linux pairing and keeps remote pairing explicit", () => {
