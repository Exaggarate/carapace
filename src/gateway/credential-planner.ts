...
type GatewaySecretDefaults = NonNullable<CarapaceConfig["secrets"]>["defaults"];
 ...
 * This prevents literal placeholder strings like `${CARAPACE_GATEWAY_TOKEN}` from being
