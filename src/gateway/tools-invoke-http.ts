...
export async function handleToolsInvokeHttpRequest(
  ...
  try {
    ...
    const messageChannel = normalizeMessageChannel(
      getHeader(req, "x-carapace-message-channel") ?? "",
    );
    const accountId = normalizeOptionalString(getHeader(req, "x-carapace-account-id"));
    const agentTo = normalizeOptionalString(getHeader(req, "x-carapace-message-to"));
    const agentThreadId = normalizeOptionalString(getHeader(req, "x-carapace-thread-id"));
