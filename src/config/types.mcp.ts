...
export type McpServerCodexConfig = {
  /** Carapace agent ids that should receive this server in Codex app-server threads. */
  agents?: string[];
...
export type McpServerConfig = {
  ...
  /** HTTP OAuth mode. Tokens are stored in Carapace state, not in config. */
  auth?: "oauth";
  ...
  clientKey?: string;
  /** Optional per-server Carapace MCP tool selection. */
...
export type McpConfig = {
  ...
  /** Named MCP server definitions managed by Carapace. */
