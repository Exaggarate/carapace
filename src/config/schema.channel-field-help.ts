...
const SHARED_CHANNEL_FIELD_HELP: Record<string, string> = {
  ...
  capabilities: "Override the channel capabilities Carapace assumes this account supports.",
  ...
  textChunkLimit: "Maximum characters per outbound message before Carapace splits it.",
