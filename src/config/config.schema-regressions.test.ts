...
describe("config schema regressions", () => {
  ...
  it("rejects bindings referencing an agentId missing from agents.entries (carapace#84692)", () => {
    const res = validateConfigObject({
      agents: {
  ...
  it("accepts a microsoft-foundry model entry carrying thinkingLevelMap (carapace#91011)", () => {
