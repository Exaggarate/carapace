...
function codexPluginEntryEnabled(cfg: CarapaceConfig): boolean | undefined {
...
function resolveEffectiveSelectedModelRefs(params: { cfg: CarapaceConfig; agentId: string }): {
  complete: boolean;
