...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.CARAPACE_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.CARAPACE_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.CARAPACE_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `carapace doctor --fix` once the
