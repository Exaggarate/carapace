...
export type BrowserProfileConfig = {
  ...
  mcpArgs?: string[];
  /**
   * Profile driver (default: carapace). "extension" attaches to the user's
   * signed-in browser through the Carapace Chrome extension relay.
   */
  driver?: "carapace" | "clawd" | "existing-session" | "extension";
...
export type BrowserConfig = {
  ...
  attachOnly?: boolean;
  /** Default profile to use when profile param is omitted. Default: "carapace" */
