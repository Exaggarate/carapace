...
/** Carapace-facing image backend availability error, preserving the failed operation and causes. */
...
/** Creates a Rastermill processor with Carapace temp-dir, pixel-limit, and command trust policy. */
...
/** Detects either Carapace's wrapper error or Rastermill's native unavailable error. */
