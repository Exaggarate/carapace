...
let webFetchProviderCache = new WeakMap<CarapaceConfig, WebFetchProviderCacheEntry>();

function resolveFetchConfig(config: CarapaceConfig | undefined): WebFetchConfig | undefined {
