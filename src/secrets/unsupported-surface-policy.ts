...
// Candidate scanning only sees carapace.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an carapace.json-like object.
 */
...
/**
 * Finds configured carapace.json values whose surfaces currently reject SecretRef objects.
 */
