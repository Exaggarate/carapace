  ...
  it("uses agents.defaults.voiceModel as the default speech provider and model", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/carapace-speech-core-voice-model-default-test.json",
        },
      } as CarapaceConfig,
      disableFallback: true,
    });
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          provider: "openrouter",
          prefsPath: "/tmp/carapace-speech-core-explicit-model-alias-test.json",
          providers: {
            openrouter: {
  ...
  it("tries voiceModel fallbacks before auto-selected speech providers", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/carapace-speech-core-voice-model-fallback-test.json",
        },
      } as CarapaceConfig,
    });
  ...
  it("tries same-provider voiceModel fallbacks as separate model attempts", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/carapace-speech-core-same-provider-voice-model-fallback-test.json",
        },
      } as CarapaceConfig,
    });
    ...
    const result = await textToSpeechStream({
      ...
      cfg: {
        tts: {
          enabled: true,
          provider: "buffered",
          prefsPath: "/tmp/carapace-speech-core-streaming-fallback-test.json",
        },
      } as CarapaceConfig,
    });
    ...
    const result = await textToSpeechStream({
      ...
      cfg: {
        tts: {
          enabled: true,
          provider: "primary",
          prefsPath: "/tmp/carapace-speech-core-streaming-timeout-test.json",
        },
      } as CarapaceConfig,
    });
