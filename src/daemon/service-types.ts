...
const SERVICE_DEFINITION_REASONS = {
  ...
  symlink:
    "is a symbolic link. Ask the deployment owner to replace the managed file through the deployment process; Carapace will not rewrite the link or its target.",
  "foreign-owner":
