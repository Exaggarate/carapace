...
export function isCurrentProcessLaunchdServiceLabel(
  ...
  // Detached update/restart handoffs keep CARAPACE_LAUNCHD_LABEL as the service
  ...
  return (
    normalizeOptionalString(env.CARAPACE_LAUNCHD_LABEL) === label &&
    normalizeOptionalString(env.CARAPACE_SERVICE_MARKER) === "carapace" &&
    Boolean(normalizeOptionalString(env.CARAPACE_SERVICE_KIND))
  );
}
 ...
 * The detached update helper's recovery CLI inherits CARAPACE_LAUNCHD_LABEL but
