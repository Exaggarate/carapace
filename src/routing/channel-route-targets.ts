...
function listConfiguredChannelIds(cfg: CarapaceConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: CarapaceConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: CarapaceConfig): ChannelRouteTarget[] {
