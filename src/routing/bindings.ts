...
export function listBindings(cfg: CarapaceConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: CarapaceConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CarapaceConfig) {
