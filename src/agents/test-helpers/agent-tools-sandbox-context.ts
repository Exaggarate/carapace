...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "carapace-sbx-test",
    runtimeLabel: params.containerName ?? "carapace-sbx-test",
    containerName: params.containerName ?? "carapace-sbx-test",
