...
function readToolSearchConfig(config?: CarapaceConfig): Record<string, unknown> {
...
export function resolveToolSearchConfig(config?: CarapaceConfig): ToolSearchConfig {
