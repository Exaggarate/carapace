...
function resolveSubagentWaitTimeoutMs(cfg: CarapaceConfig, runTimeoutSeconds?: number) {
...
const SUBAGENT_REGISTRY_TEST_HANDLE = Symbol.for("carapace.subagentRegistryTestApi");
