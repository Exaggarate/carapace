...
describe("buildEmbeddedCompactionRuntimeContext", () => {
  it("preserves sender and current message routing for compaction", () => {
    const result = buildEmbeddedCompactionRuntimeContext({
      ...
      agentDir: "/tmp/agent",
      config: {} as unknown as CarapaceConfig,
      senderIsOwner: true,
      senderId: "user-123",
      provider: "openai",
      modelId: "gpt-5.4",
  ...
  it("preserves direct OpenAI compaction for the Carapace runtime", () => {
    const result = resolveEmbeddedCompactionTarget({
      config: {
        models: {
          providers: {
  ...
  it.each([
    { selection: "implicit Carapace", harnessRuntime: undefined, nativeCompaction: undefined },
    { selection: "bound Carapace", harnessRuntime: "carapace", nativeCompaction: undefined },
  ...
  it.each([
    ...
    const result = resolveEmbeddedCompactionTarget({
      config: fixture.config as unknown as CarapaceConfig,
