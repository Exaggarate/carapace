...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded Carapace harness provider when the model provider is known", () => {
    // The Carapace harness id is a transport wrapper, not the provider users
