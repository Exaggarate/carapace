...
export function prepareCliProviderClassifier(cfg?: CarapaceConfig): CliProviderClassifier {
...
export function isCliProvider(provider: string, cfg?: CarapaceConfig): boolean {
