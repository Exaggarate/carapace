...
function createTools(
  config: CarapaceToolsOptions["config"],
...
function requireTool(tools: ReturnType<typeof createCarapaceTools>, name: string) {
...
describe("carapace session lookup context", () => {
  it.each([
