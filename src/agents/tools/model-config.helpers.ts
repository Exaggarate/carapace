...
/** Resolves the configured default model ref, falling back to Carapace defaults. */
export function resolveDefaultModelRef(cfg?: CarapaceConfig): { provider: string; model: string } {
  if (cfg) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("carapace.modelConfigHelpersTestApi")] = {
