...
export function coerceImageModelConfig(cfg?: CarapaceConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: CarapaceConfig; ref: string }): string[] {
