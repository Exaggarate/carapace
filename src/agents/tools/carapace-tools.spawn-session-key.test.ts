// Verifies createCarapaceTools passes the durable runSessionKey (not the
...
vi.mock("../carapace-tools.media-factory-plan.js", async (importOriginal) => {
...
describe("createCarapaceTools sessions_spawn session-key selection", () => {
  beforeEach(() => {
