...
async function resolveContext(config: CarapaceConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CarapaceConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
