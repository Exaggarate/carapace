...
export function resolveImageFallbackDefaultProvider(cfg: CarapaceConfig | undefined): string {
...
function resolveFallbackCandidateModelProviderCacheParts(cfg: CarapaceConfig | undefined): unknown {
