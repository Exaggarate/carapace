 ...
 *
 * Wraps pi-tui keybindings with Carapace-specific actions and per-agent overrides.
 */
...
/** Carapace-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads Carapace defaults plus optional user overrides. */
