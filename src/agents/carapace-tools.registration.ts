/**
 * Carapace-owned tool registration filters.
 *
...
export function collectPresentCarapaceTools(
  candidates: readonly (AnyAgentTool | null | undefined)[],
): AnyAgentTool[] {
  return candidates.filter((tool): tool is AnyAgentTool => tool !== null && tool !== undefined);
}

/** Decides whether progress_card should be included in the assembled Carapace tool set. */
export function shouldIncludeProgressCardToolForCarapaceTools(params: {
  agentId?: string;
...
function shouldIncludePrimarySessionToolForCarapaceTools(
...
export function shouldIncludeAskUserToolForCarapaceTools(
  params: PrimarySessionToolRegistrationParams,
): boolean {
  return shouldIncludePrimarySessionToolForCarapaceTools("ask_user", params);
}

/** Keeps credential management on primary sessions allowed by the normal tool policy. */
export function shouldIncludeSecretsToolForCarapaceTools(
  params: PrimarySessionToolRegistrationParams,
): boolean {
  return shouldIncludePrimarySessionToolForCarapaceTools("secrets", params);
}
