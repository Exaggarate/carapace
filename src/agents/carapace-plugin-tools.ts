...
import type { CarapacePluginToolDelivery } from "../plugins/tool-types.js";
import { resolvePluginTools } from "../plugins/tools.js";
import type { CarapacePluginToolContext } from "../plugins/types.js";
...
import {
  resolveCarapacePluginToolInputs,
  type CarapacePluginToolOptions,
} from "./carapace-tools.plugin-context.js";
...
type ResolveCarapacePluginToolsOptions = CarapacePluginToolOptions & {
...
function createPluginToolDelivery(params: {
  options: ResolveCarapacePluginToolsOptions | undefined;
  context: CarapacePluginToolContext;
  bindingConfig: CarapaceConfig | undefined;
  resolveConfig: () => CarapaceConfig | undefined;
}): CarapacePluginToolDelivery | undefined {
...
export function resolveCarapacePluginToolsForOptions(params: {
  options?: ResolveCarapacePluginToolsOptions;
  ...
  const pluginToolInputs = resolveCarapacePluginToolInputs({
