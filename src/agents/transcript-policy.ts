 ...
 */
import { bindsClaudeThinkingPrefix } from "@carapace/llm-core";
...
const transcriptPolicyCache = new WeakMap<CarapaceConfig, Map<string, TranscriptPolicy>>();

function canCacheTranscriptPolicy(params: {
  config?: CarapaceConfig;
  env?: NodeJS.ProcessEnv;
}): params is { config: CarapaceConfig; env?: NodeJS.ProcessEnv } {
  if (!params.config) {
    return false;
  }
