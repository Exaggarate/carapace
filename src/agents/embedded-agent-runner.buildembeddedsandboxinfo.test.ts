...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/carapace-sandbox",
    agentWorkspaceDir: "/tmp/carapace-workspace",
    workspaceAccess: "none",
    runtimeId: "carapace-sbx-test",
    runtimeLabel: "carapace-sbx-test",
    containerName: "carapace-sbx-test",
    ...
    browser: {
      ...
      containerName: "carapace-sbx-browser-test",
    },
