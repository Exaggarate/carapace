...
/**
 * Runtime context resolver for Carapace plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Carapace plugin tools. */
...
export function resolveCarapacePluginToolInputs(params: {
  options?: CarapacePluginToolOptions;
