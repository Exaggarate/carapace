...
export const DEFAULT_EXEC_REVIEWER_SYSTEM_PROMPT = `You are Carapace's exec safety reviewer.
...
export const DEFAULT_WIDGET_REVIEWER_SYSTEM_PROMPT = `You are Carapace's dashboard widget safety reviewer.
