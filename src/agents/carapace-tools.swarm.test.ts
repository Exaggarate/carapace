...
function createSwarmTools(options: NonNullable<Parameters<typeof createCarapaceTools>[0]>) {
...
function createSwarmToolNames(options: NonNullable<Parameters<typeof createCarapaceTools>[0]>) {
...
describe("Swarm registration", () => {
  ...
  it("keeps structured_output through restrictive child tool policy", () => {
    const names = createCarapaceCodingTools({
