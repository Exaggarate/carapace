/**
 * Built-in Carapace harness registration.
 *
 * Harness selection uses this factory to expose the embedded Carapace runtime
...
/** Creates the built-in harness backed by the embedded Carapace agent runner. */
export function createCarapaceAgentHarness(): AgentHarnessV2 {
...
export function isBuiltInCarapaceAgentHarness(harness: AgentHarness): boolean {
  return builtInCarapaceHarnesses.has(harness);
}
