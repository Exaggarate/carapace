...
function withDefaultRoster(config: CarapaceConfig = {}): CarapaceConfig {
  return {
    ...config,
...
function cfgWithProviderRuntime(id: string): CarapaceConfig {
...
function cfgWithModelRuntime(modelId: string, id: string): CarapaceConfig {
  return withDefaultRoster({
    models: {
      providers: {
        "github-copilot": {
