 ...
 * Converts provider-specific usage shapes into Carapace's normalized input,
...
/** Normalize provider-specific token usage fields into Carapace usage buckets. */
 ...
 * recombine Carapace's separately priced buckets and retain their details.
