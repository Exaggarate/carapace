/** Tests merging bundled MCP defaults with Carapace user MCP configuration. */
...
describe("loadMergedBundleMcpConfig", () => {
  it("lets Carapace mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps Carapace transports to downstream CLI types when requested", () => {
    expect(
  ...
  it("keeps disabled Carapace MCP servers out of embedded runtimes", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {
  ...
  it("lets disabled Carapace MCP servers tombstone bundle defaults with the same name", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {
