...
describe("provider attribution", () => {
  ...
  it("resolves the canonical Carapace product and runtime version", () => {
  ...
  it("returns a documented Google Gemini attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      version: "2026.3.22",
      headers: {
        "x-goog-api-client": "carapace/2026.3.22",
      },
    });
  });
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { CARAPACE_VERSION: "2026.3.22" })).toEqual({
      provider: "openai",
      enabledByDefault: true,
    ...
    expect(
      resolveProviderAttributionPolicy("openai", { CARAPACE_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "carapace",
      version: "2026.3.22",
      "User-Agent": "carapace/2026.3.22",
  ...
  it("returns a hidden-spec xAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("xai", { CARAPACE_VERSION: "2026.3.22" })).toEqual({
      provider: "xai",
      enabledByDefault: true,
      verification: "vendor-hidden-api-spec",
      hook: "request-headers",
    ...
    expect(
      resolveProviderAttributionPolicy("xai", { CARAPACE_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "carapace",
      version: "2026.3.22",
      "User-Agent": "carapace/2026.3.22",
  ...
  it("returns a documented OpenCode Go attribution policy", () => {
    expect(
      resolveProviderAttributionPolicy("opencode-go", { CARAPACE_VERSION: "2026.3.22" }),
    ).toEqual({
  ...
  it("lists the current attribution support matrix", () => {
    ...
    expect(
      listProviderAttributionPolicies({ CARAPACE_VERSION: "2026.3.22" }).map((policy) => [
        policy.provider,
  ...
  it("identifies Carapace only on native OpenCode Go routes", () => {
