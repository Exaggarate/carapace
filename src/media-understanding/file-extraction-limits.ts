...
import { asPositiveFiniteNumber as positiveExtractionLimit } from "@carapace/normalization-core/number-coercion";
...
export function resolveFileExtractionLimits(cfg: CarapaceConfig): FileExtractionLimits {
