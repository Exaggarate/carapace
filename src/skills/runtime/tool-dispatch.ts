...
import type { createCarapaceTools } from "../../agents/carapace-tools.js";
...
export type SkillToolDispatchDependencies = {
  createCarapaceTools: typeof createCarapaceTools;
};
...
export function resolveSkillDispatchTools(
  ...
  const beforeToolCallHookContext = params.skillCommand
    ...
    : undefined;
  const tools = dependencies.createCarapaceTools({
