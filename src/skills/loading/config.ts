...
export function resolveSkillsInstallPreferences(config?: CarapaceConfig): SkillsInstallPreferences {
...
const BUNDLED_SOURCES = new Set(["carapace-bundled", "carapace-custodian"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: CarapaceConfig): ReadonlySet<string> | undefined {
