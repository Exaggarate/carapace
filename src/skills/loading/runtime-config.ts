...
function hasConfiguredSkillApiKeyRef(config?: CarapaceConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: CarapaceConfig): CarapaceConfig | undefined {
