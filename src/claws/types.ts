// Shared types for grouped Carapace Claw manifests and read-only add plans.
import type { ToolProfileId } from "../agents/tool-policy-shared.js";
import type { AgentConfig } from "../config/types.agents.js";

export const CLAW_SCHEMA_VERSION = 1 as const;
export const CLAW_ADD_PLAN_SCHEMA_VERSION = "carapace.clawAddPlan.v1" as const;
export const CLAW_INSPECT_RESULT_SCHEMA_VERSION = "carapace.clawInspect.v1" as const;
...
type ClawExtensionFormat = "carapace" | "claude" | "codex" | "cursor";

export type ClawCarapaceExtension = {
  id: string;
  kind: "plugin";
...
export type ClawCarapaceProfile = {
  schemaVersion: 1;
  agent: {
    groupChat?: {
...
type ClawSourceSnapshot = {
  ...
  carapaceProfile?: ClawProfileSourceSnapshot;
...
export type ClawReadResult =
  | {
      ...
      legacyCarapaceProfile?: ClawCarapaceProfile;
...
export type ClawExtensionPlan = ClawCarapaceExtension & {
  detectedFormat?: ClawExtensionFormat;
  integrity?: string;
  installId?: string;
