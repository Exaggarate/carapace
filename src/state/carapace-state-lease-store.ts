...
export type CarapaceStateLeaseIdentity = { scope: string; key: string; owner: string };
...
export function acquireCarapaceStateLeaseInTransaction(
  db: DatabaseSync,
  identity: CarapaceStateLeaseIdentity,
  leaseMs: number,
): number | undefined {
...
export function readCarapaceStateLeaseExpiry(
  db: DatabaseSync,
  identity: CarapaceStateLeaseIdentity,
): number | undefined {
...
export function renewCarapaceStateLeaseInTransaction(
  db: DatabaseSync,
  identity: CarapaceStateLeaseIdentity,
  leaseMs: number,
): number | undefined {
...
export function releaseCarapaceStateLeaseInTransaction(
  db: DatabaseSync,
  identity: CarapaceStateLeaseIdentity,
): void {
  executeSqliteQuerySync(
