...
vi.mock("./carapace-state-schema.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./carapace-state-schema.js")>();
  return {
    ...actual,
    CARAPACE_STATE_SCHEMA_SQL: `${actual.CARAPACE_STATE_SCHEMA_SQL}\n${trailingSchema.sql}\n`,
  };
});
