...
} from "./carapace-state-lease-heartbeat-shared.js";
import {
...
const renew = () => {
  ...
  try {
      ...
      () =>
        runSqliteImmediateTransactionSync(
          ...
          () => {
            ...
            return renewCarapaceStateLeaseInTransaction(db, params.identity, params.leaseMs);
          },
          { logger: { warn() {} } },
        ),
    ...
    expiresAt = readCarapaceStateLeaseExpiry(db, params.identity);
  }
