// Removes transient runtime state from restorable Carapace database snapshots.
...
type SnapshotSanitizerDatabase = Pick<CarapaceStateKyselyDatabase, "exec_approvals_config">;
...
export function sanitizeCarapaceStateLeaseRows(database: DatabaseSync): void {
...
export function sanitizeCarapaceGlobalStateSnapshot(database: DatabaseSync): void {
