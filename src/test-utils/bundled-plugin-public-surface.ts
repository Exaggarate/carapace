...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(CARAPACE_PACKAGE_ROOT, "extensions"),
    path.resolve(CARAPACE_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(CARAPACE_PACKAGE_ROOT, "dist", "extensions"),
