...
These internal hooks ship with Carapace. They subscribe to colon-separated events
...
The default state directory is `~/.carapace`. Agent workspaces can differ; see
...
`metadata.carapace.events` declares subscriptions. Custom hooks can also use
