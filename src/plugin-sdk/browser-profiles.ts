...
export const DEFAULT_CARAPACE_BROWSER_ENABLED = true;
...
export const DEFAULT_CARAPACE_BROWSER_COLOR = "#FF4500";
/** Default Carapace-managed browser profile name. */
export const DEFAULT_CARAPACE_BROWSER_PROFILE_NAME = "carapace";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "carapace";
 ...
 */
export const DEFAULT_UPLOAD_DIR = "/tmp/carapace/uploads";
