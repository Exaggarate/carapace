...
import {
  ...
  type CarapacePluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { CarapacePluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<CarapacePluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): CarapacePluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } satisfies CarapacePluginApiWithoutFacades;
