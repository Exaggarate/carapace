...
/**
 * @deprecated Compatibility facade for the `carapace/plugin-sdk/discord` subpath.
...
export type { CarapaceConfig } from "./config-contracts.js";
export type { CarapacePluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in Carapace config. */
export type DiscordAccountConfig = NonNullable<NonNullable<CarapaceConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: CarapaceConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: CarapaceConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: CarapaceConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: CarapaceConfig }): CarapaceConfig {
...
/** List configured Discord account ids from Carapace config. */
export function listDiscordAccountIds(cfg: CarapaceConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: CarapaceConfig): string {
