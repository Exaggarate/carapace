...
// Registry readers (2026-07-22): @nodeskai/feishu, carapace-channel-whatsapp-official,
// carapace-vk, carapace-ndr, moltbot-channel-feishu, @kagura-agent/carapace-zulip,
// @jeik/dingtalk-connector, @xzq-xu/feishu, @dingtalk-real-ai/dingtalk-connector,
// @carapace-vk/vk, yzw-dingtalk-connector, and carapace-channel-zulip.
...
export type {
  ...
  WizardProgress,
  WizardPrompter,
  // Registry reader (2026-07-22): @ama2/carapace-channel.
  WizardSelectParams,
...
// Registry readers (2026-07-22): @cyzlmh/carapace-sms, @spicerhome/claw-messenger,
// @chatu-ai/webhub, @rowger_go/chatu, and @emotion-machine/claw-messenger.
export { normalizeE164 } from "../utils.js";
// Registry readers (2026-07-22): carapace-rcs, @woowonjae/rol-websocket-channel,
// carapace-swarm-layer, rol-websocket-channel, @clawling/clawchat-plugin-carapace,
// @workclaw/carapace-workclaw, clawspec, and @privateclaw/privateclaw.
...
export {
  ...
  // Registry reader (2026-07-22): @lansenger-pm/carapace-lansenger-channel.
  ...
  // Registry reader (2026-07-22): carapace-channel-xiaozhu.
  resolveSetupAccountId,
  runSingleChannelSecretStep,
  setSetupChannelEnabled,
  // Registry readers (2026-07-22): carapace-vk and @carapace-vk/vk.
