...
export function resolveSessionToolsVisibility(cfg: CarapaceConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: CarapaceConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: CarapaceConfig): AgentToAgentPolicy {
