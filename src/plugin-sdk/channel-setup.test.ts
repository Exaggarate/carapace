...
import { runSetupWizardFinalize } from "carapace/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @carapace/example to be installed. Docs: https://github.com/Exaggarate/carapace",
    );
    ...
    ).rejects.toThrow("@carapace/example");
  });
});
