// Carapace-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installCarapaceOwnedToolHooks(params?: {
 ...
 * Pair with `installCarapaceOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetCarapaceOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
