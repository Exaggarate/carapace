...
export { redactSensitiveUrlLikeString } from "@carapace/net-policy/redact-sensitive-url";
...
// Compatibility for @tencent-connect/carapace-qqbot@2.0.3. Remove after the pinned
