...
import type { CarapacePluginApi } from "../plugins/types.js";
...
export type {
  ...
  CarapacePluginSessionsChangedEvent,
...
export { parseStrictPositiveInteger } from "@carapace/normalization-core/number-coercion";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: CarapaceConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
