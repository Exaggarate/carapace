...
export type {
  CarapacePluginGatewayEventScope,
  CarapacePluginGatewayEvents,
...
type DefinePluginEntryOptions = {
  ...
  reload?: CarapacePluginDefinition["reload"];
  nodeHostCommands?: CarapacePluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: CarapacePluginDefinition["securityAuditCollectors"];
  register: NonNullable<CarapacePluginDefinition["register"]>;
};

/** Normalized object shape that Carapace loads from a plugin entry module. */
 ...
 * `carapace/plugin-sdk/core` so they inherit the channel capability wiring.
 *
 * @experimental Pin and test Carapace host versions; existing compatibility windows still apply.
 */
