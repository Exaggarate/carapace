// Browser control auth helpers resolve plugin browser credentials from Carapace config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: CarapaceConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
