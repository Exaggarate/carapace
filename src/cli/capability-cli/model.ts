...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside Carapace.";
...
async function loadModelCatalogForInspection(cfg: CarapaceConfig, agentId?: string) {
