...
export function registerAgentsCommands(program: Command): void {
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "github.com/Exaggarate/carapace")}\n`,
    );
...
${formatHelpExamples([
  ['carapace agents set-identity --agent main --name "Carapace" --emoji "🦞"', "Set name + emoji."],
  ["carapace agents set-identity --agent main --avatar avatars/carapace.png", "Set avatar path."],
  [
    "carapace agents set-identity --workspace ~/.carapace/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "carapace agents set-identity --identity-file ~/.carapace/workspace/IDENTITY.md --agent main",
