...
describe("gateway suspend CLI", () => {
  ...
  it.each([undefined, 0, "0", " 0 ", "0.25", "1e1"])(
    ...
    async (waitSeconds) => {
      ...
      expect(runtime.log).toHaveBeenCalledWith("Resume with: carapace gateway resume suspension-1");
    },
  );
  ...
  it.each([
    {
      ...
      profile: "",
      container: "",
      command: "carapace gateway resume suspension-1",
    },
    {
      ...
      profile: "",
      container: "",
      command: "carapace gateway resume suspension-1 --port 18999",
    },
    {
      ...
      profile: "work",
      container: "",
      command: "carapace --profile work gateway resume suspension-1 --port 18999",
    },
    {
      ...
      profile: "work",
      container: "demo",
      command: "carapace --container demo gateway resume suspension-1 --port 18999",
    },
    {
