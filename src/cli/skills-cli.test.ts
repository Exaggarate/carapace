...
describe("skills-cli", () => {
  ...
  describe("ClawHub command hints", () => {
    it.each([
      {
        ...
        profile: "work",
        container: "",
        prefix: "carapace --profile work",
      },
      {
        name: "managed container",
        profile: "",
        container: "demo",
        prefix: "carapace --container demo",
      },
      {
    ...
    it("keeps profile and container guidance out of machine-readable skill output", () => {
      ...
      vi.stubEnv("CARAPACE_CONTAINER_HINT", "demo");
      const report = createMockReport([]);
      const outputs = [
      ...
      for (const output of outputs) {
        ...
        expect(output).not.toContain("carapace --profile");
        expect(output).not.toContain("carapace --container");
      }
    });
  });
  ...
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("carapace skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("carapace skills install");
    });
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("carapace skills update");
    });
