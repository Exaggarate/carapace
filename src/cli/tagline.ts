...
const DEFAULT_TAGLINE = "All your chats, one Carapace.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'carapace gateway start.'",
  ...
  "If found wandering, please return to ~/.carapace.",
  ...
  "Carapace Support will never DM you first. I, on the other hand, absolutely will.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.CARAPACE_TAGLINE_INDEX;
