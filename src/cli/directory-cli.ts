    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["carapace directory self --channel slack", "Show the connected account identity."],
          [
            'carapace directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["carapace directory groups list --channel discord", "List available groups/channels."],
          [
            "carapace directory groups members --channel discord --group-id <id>",
