 ...
 *
 * Maps channel-specific direct/group/channel labels into Carapace chat types.
 */
...
/**
 * Normalizes channel-specific chat type labels into Carapace conversation kinds.
 */
