...
type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: CarapaceConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: CarapaceConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: CarapaceConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: CarapaceConfig;
    accountId: string;
...
type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: CarapaceConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: CarapaceConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: CarapaceConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: CarapaceConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: CarapaceConfig) => CarapaceConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: CarapaceConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: CarapaceConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: CarapaceConfig, policy: DmPolicy, accountId?: string) => CarapaceConfig;
