...
- Keep extension-facing channel surfaces flowing through `carapace/plugin-sdk/*`
...
- For bundled plugin channel changes that can affect startup/import cost, run:
  `CARAPACE_LOCAL_CHECK=0 node --import tsx scripts/profile-extension-memory.mts --extension <id> --skip-combined --concurrency 1`
