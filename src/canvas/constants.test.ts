...
describe("core canvas contracts", () => {
  it("keeps document auth scoped to the stable Canvas path", () => {
    expect(isCanvasDocumentHttpPath("/__carapace__/canvas/documents/cv_1/index.html")).toBe(true);
    expect(isCanvasDocumentHttpPath("/__carapace__/canvas/index.html")).toBe(false);
    expect(
      resolveCanvasNodeCapability([
        "/encoded-path",
        "/__carapace__/canvas/documents/cv_1/index.html",
      ]),
