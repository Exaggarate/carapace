...
pub struct CarapaceRTCAddress {
    address: [u8; 16],
    port: u16,
    family: u16,
}

impl CarapaceRTCAddress {
...
impl From<SocketAddr> for CarapaceRTCAddress {
...
#[repr(C)]
#[derive(Default)]
pub struct CarapaceRTCOutput {
    kind: u32,
    bytes: *const u8,
    length: usize,
    source: CarapaceRTCAddress,
    destination: CarapaceRTCAddress,
    time: u64,
}
...
#[unsafe(no_mangle)]
pub extern "C" fn carapace_rtc_create() -> *mut CarapaceRTC {
    catch_unwind(|| {
        ...
        let rtc = Rtc::builder()
            ...
            .build(Instant::now());
        Box::into_raw(Box::new(CarapaceRTC {
            rtc: Some(rtc),
            ..CarapaceRTC::default()
        }))
    })
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_free(pointer: *mut CarapaceRTC) {
    if !pointer.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_add_candidate(
    pointer: *mut CarapaceRTC,
    address: CarapaceRTCAddress,
) -> i32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_offer(pointer: *mut CarapaceRTC) -> i32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_remove_candidate(
    pointer: *mut CarapaceRTC,
    address: CarapaceRTCAddress,
) -> i32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_remote_address(
    pointer: *const CarapaceRTC,
    index: usize,
    address: *mut CarapaceRTCAddress,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_resolve_remote_address(
    pointer: *mut CarapaceRTC,
    index: usize,
    address: CarapaceRTCAddress,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_description(
    pointer: *const CarapaceRTC,
    length: *mut usize,
) -> *const u8 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_answer(
    pointer: *mut CarapaceRTC,
    bytes: *const u8,
    length: usize,
) -> i32 {
    unsafe {
        operate(pointer, |rtc, state| {
            ...
            for candidate in answer.session.ice_candidates().chain(
                ...
                CarapaceRTCAddress::from(address).socket()?;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_receive(
    pointer: *mut CarapaceRTC,
    source: CarapaceRTCAddress,
    destination: CarapaceRTCAddress,
    bytes: *const u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_send_opus(
    pointer: *mut CarapaceRTC,
    bytes: *const u8,
    length: usize,
    timestamp: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_timeout(pointer: *mut CarapaceRTC) -> i32 {
    unsafe {
        operate(pointer, |rtc, _| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn carapace_rtc_poll(
    pointer: *mut CarapaceRTC,
    output: *mut CarapaceRTCOutput,
) -> i32 {
    ...
    unsafe {
        operate(pointer, |rtc, state| {
            *output = CarapaceRTCOutput::default();
            loop {
