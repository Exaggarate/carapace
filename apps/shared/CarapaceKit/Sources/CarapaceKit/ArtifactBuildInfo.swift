...
public struct ArtifactBuildInfo: Equatable, Sendable {
        ...
        versionKeys: [String] = ["CFBundleShortVersionString"])
    {
        ...
        self.gitCommit = Self.validGitCommit(Self.nonEmptyString(infoDictionary["CarapaceGitCommit"]))
        let buildTimestamp = Self.nonEmptyString(infoDictionary["CarapaceBuildTimestamp"])
