...
public enum CarapaceTalkCommand: String, Codable, Sendable {
...
public struct CarapaceTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct CarapaceTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
