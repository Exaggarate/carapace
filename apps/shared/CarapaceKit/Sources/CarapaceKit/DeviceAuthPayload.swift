...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int64,
        nonce: String) -> [String: CarapaceProtocol.AnyCodable]?
    {
        ...
        return [
            "id": CarapaceProtocol.AnyCodable(identity.deviceId),
            "publicKey": CarapaceProtocol.AnyCodable(publicKey),
            "signature": CarapaceProtocol.AnyCodable(signature),
            "signedAt": CarapaceProtocol.AnyCodable(signedAtMs),
            "nonce": CarapaceProtocol.AnyCodable(nonce),
        ]
    }
}
