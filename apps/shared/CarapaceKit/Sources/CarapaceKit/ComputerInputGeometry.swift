...
public struct CarapaceComputerDisplayGeometry: Sendable, Equatable {
...
public enum CarapaceComputerInputGeometry {
    ...
    public static func displayFrameId(
        ...
        sourceHeight: Double,
        referenceWidth: Int,
        display: CarapaceComputerDisplayGeometry) -> String
    {
        let descriptor = [
            String(displayID),
    ...
    public static func isValidMappingGeometry(
        sourceWidth: Double,
        sourceHeight: Double,
        display: CarapaceComputerDisplayGeometry) -> Bool
    {
    ...
    public static func mapReferencePointToGlobal(
        ...
        display: CarapaceComputerDisplayGeometry) -> (x: Double, y: Double)
    {
