...
public enum CarapaceWatchCommand: String, Codable, Sendable {
    case status = "watch.status"
    case notify = "watch.notify"
}

public enum CarapaceWatchPayloadType: String, Codable, Sendable, Equatable {
    case notify = "watch.notify"
...
public enum CarapaceWatchRisk: String, Codable, Sendable, Equatable {
    case low
    case medium
    case high
}

public enum CarapaceWatchExecApprovalDecision: String, Codable, Sendable, Equatable {
    case allowOnce = "allow-once"
    case deny
}

public enum CarapaceWatchExecApprovalCloseReason: String, Codable, Sendable, Equatable {
    case expired
...
public struct CarapaceWatchAction: Codable, Sendable, Equatable, Identifiable {
...
public struct CarapaceWatchExecApprovalItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
    ...
    public var allowedDecisions: [CarapaceWatchExecApprovalDecision]
    public var risk: CarapaceWatchRisk?
    ...
    public init(
        ...
        allowedDecisions: [CarapaceWatchExecApprovalDecision] = [],
        risk: CarapaceWatchRisk? = nil)
    {
        self.id = id
...
public struct CarapaceWatchExecApprovalPromptMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var approval: CarapaceWatchExecApprovalItem
    public var sentAtMs: Int64?
    public var resetResolutionAttemptId: String?

    public init(
        approval: CarapaceWatchExecApprovalItem,
        sentAtMs: Int64? = nil,
...
public struct CarapaceWatchExecApprovalResolveMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: CarapaceWatchExecApprovalDecision
...
public enum CarapaceWatchExecApprovalOutcome: String, Codable, Sendable, Equatable {
    case allowedOnce
    case allowedAlways
    case denied
}

public struct CarapaceWatchExecApprovalResolvedMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: CarapaceWatchExecApprovalDecision?
    public var outcome: CarapaceWatchExecApprovalOutcome?
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: CarapaceWatchExecApprovalDecision? = nil,
        outcome: CarapaceWatchExecApprovalOutcome? = nil,
...
public struct CarapaceWatchExecApprovalExpiredMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var reason: CarapaceWatchExecApprovalCloseReason
...
public struct CarapaceWatchExecApprovalSnapshotMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var approvals: [CarapaceWatchExecApprovalItem]
    public var gatewayStableID: String?
    public var sentAtMs: Int64?
    ...
    public init(
        approvals: [CarapaceWatchExecApprovalItem],
        gatewayStableID: String? = nil,
        sentAtMs: Int64? = nil,
...
public struct CarapaceWatchExecApprovalSnapshotRequestItem: Codable, Sendable, Equatable {
    public var approvalId: String
...
public struct CarapaceWatchExecApprovalSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
    public var gatewayStableID: String?
    public var heldApprovals: [CarapaceWatchExecApprovalSnapshotRequestItem]

    public init(
        requestId: String,
        sentAtMs: Int64? = nil,
        gatewayStableID: String? = nil,
        heldApprovals: [CarapaceWatchExecApprovalSnapshotRequestItem] = [])
    {
...
public struct CarapaceWatchChatItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
...
public struct CarapaceWatchChatCompletionMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
...
public enum CarapaceWatchAppStatusCode: String, Codable, Sendable, Equatable {
...
public struct CarapaceWatchAppStatus: Codable, Sendable, Equatable {
    public var code: CarapaceWatchAppStatusCode
    public var localizationKey: String?
    public var arguments: [String]
    public var verbatim: String?

    public init(
        code: CarapaceWatchAppStatusCode,
    ...
    public static func decodeLegacyGateway(
        text: String?,
        connected: Bool) -> CarapaceWatchAppStatus
    {
        if connected {
        ...
        return CarapaceWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    public static func decodeLegacyTalk(
        ...
        enabled: Bool,
        listening: Bool,
        speaking: Bool) -> CarapaceWatchAppStatus
    {
        if speaking {
        ...
        guard let text, !text.isEmpty else {
            return CarapaceWatchAppStatus(code: .talkReady)
        }
        return CarapaceWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    public static func decodeLegacyChat(
        code: String?,
        text: String?) -> CarapaceWatchAppStatus?
    {
        let statusCode: CarapaceWatchAppStatusCode? = switch code {
        case "connectIPhone":
            CarapaceWatchAppStatusCode.chatConnectIPhone
        case "noMessages":
            CarapaceWatchAppStatusCode.chatNoMessages
        case "unavailable":
            CarapaceWatchAppStatusCode.chatUnavailable
        default:
            nil
        }
        if let statusCode {
            return CarapaceWatchAppStatus(code: statusCode)
        }
...
public struct CarapaceWatchAppSnapshotMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var gatewayStatus: CarapaceWatchAppStatus
    ...
    public var gatewayStableID: String?
    public var talkStatus: CarapaceWatchAppStatus
    ...
    public var chatItems: [CarapaceWatchChatItem]?
    public var chatStatus: CarapaceWatchAppStatus?
    public var chatStatusText: String?
    public var sentAtMs: Int64?
    public var snapshotId: String?
    public var chatDeliveryContext: CarapaceWatchChatDeliveryContext?

    public init(
        gatewayStatus: CarapaceWatchAppStatus,
        ...
        sessionKey: String,
        gatewayStableID: String? = nil,
        talkStatus: CarapaceWatchAppStatus,
        talkStatusText: String,
        talkEnabled: Bool,
        talkListening: Bool,
        talkSpeaking: Bool,
        pendingApprovalCount: Int,
        chatItems: [CarapaceWatchChatItem]? = nil,
        chatStatus: CarapaceWatchAppStatus? = nil,
        chatStatusText: String? = nil,
        sentAtMs: Int64? = nil,
        snapshotId: String? = nil,
        chatDeliveryContext: CarapaceWatchChatDeliveryContext? = nil)
    {
        ...
        chatDeliveryContext: CarapaceWatchChatDeliveryContext? = nil)
    {
        ...
        self.init(
            gatewayStatus: CarapaceWatchAppStatus.decodeLegacyGateway(
            ...
            talkStatus: CarapaceWatchAppStatus.decodeLegacyTalk(
                text: talkStatusText,
                enabled: talkEnabled,
            ...
            chatItems: chatItems,
            chatStatus: CarapaceWatchAppStatus.decodeLegacyChat(code: nil, text: chatStatusText),
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(CarapaceWatchPayloadType.self, forKey: .type)
        ...
        self.chatItems = try container.decodeIfPresent([CarapaceWatchChatItem].self, forKey: .chatItems)
        ...
        self.chatDeliveryContext = try container.decodeIfPresent(
            CarapaceWatchChatDeliveryContext.self, forKey: .chatDeliveryContext)
        ...
        {
            self.gatewayStatus = CarapaceWatchAppStatus(
                code: .legacy,
                verbatim: gatewayStatusText)
        } else {
            self.gatewayStatus = CarapaceWatchAppStatus.decodeLegacyGateway(
                text: gatewayStatusText,
        ...
        {
            self.talkStatus = CarapaceWatchAppStatus(
                code: .legacy,
                verbatim: talkStatusText)
        } else {
            self.talkStatus = CarapaceWatchAppStatus.decodeLegacyTalk(
                text: talkStatusText,
        ...
        self.chatStatus = (try? container.decode(
            CarapaceWatchAppStatus.self,
            forKey: .chatStatus)) ?? CarapaceWatchAppStatus.decodeLegacyChat(
            code: chatStatusCode,
            text: chatStatusText)
    ...
    private static func legacyText(for status: CarapaceWatchAppStatus) -> String {
    ...
    private static func legacyGatewayText(for code: CarapaceWatchAppStatusCode) -> String {
        switch code {
    ...
    private static func legacyTalkText(for code: CarapaceWatchAppStatusCode) -> String {
        switch code {
        case .talkOff: "Off"
    ...
    private static func legacyChatText(for code: CarapaceWatchAppStatusCode) -> String {
        switch code {
...
public struct CarapaceWatchAppSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
...
public enum CarapaceWatchAppCommand: String, Codable, Sendable, Equatable {
    case refresh
...
public struct CarapaceWatchAppCommandMessage: Codable, Sendable, Equatable {
    public var type: CarapaceWatchPayloadType
    public var command: CarapaceWatchAppCommand
    public var commandId: String
    public var sessionKey: String?
    public var gatewayStableID: String?
    public var text: String?
    ...
    public init(
        command: CarapaceWatchAppCommand,
        commandId: String,
...
public struct CarapaceWatchStatusPayload: Codable, Sendable, Equatable {
...
public struct CarapaceWatchNotifyParams: Codable, Sendable, Equatable {
    ...
    public var expiresAtMs: Int64?
    public var risk: CarapaceWatchRisk?
    public var actions: [CarapaceWatchAction]?
    ...
    public init(
        ...
        expiresAtMs: Int64? = nil,
        risk: CarapaceWatchRisk? = nil,
        actions: [CarapaceWatchAction]? = nil)
    {
        self.title = title
        self.body = body
...
public struct CarapaceWatchNotifyPayload: Codable, Sendable, Equatable {
