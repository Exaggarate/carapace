...
extension CarapaceChatSQLiteTranscriptCache {
    ...
    static func cacheableMessages(_ messages: [CarapaceChatMessage]) -> [CarapaceChatMessage] {
    ...
    private static func cacheablePatchArguments(_ item: CarapaceChatMessageContent) -> AnyCodable? {
