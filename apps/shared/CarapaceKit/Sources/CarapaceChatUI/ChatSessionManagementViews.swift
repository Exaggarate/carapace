...
struct ChatSessionInspectorDetails: Equatable {
    ...
    private static func runState(for session: CarapaceChatSessionEntry) -> String? {
...
struct ChatSessionInspectorSheet: View {
    ...
    @State private var displayedSession: CarapaceChatSessionEntry
    @State private var groups: [CarapaceChatSessionGroup] = []
    @State private var isMutatingGroup = false
    @State private var errorText: String?

    init(viewModel: CarapaceChatViewModel, session: CarapaceChatSessionEntry) {
...
struct ChatSessionGroupsSheet: View {
    ...
    @State private var renameTarget: CarapaceChatSessionGroup?
    @State private var renameText = ""
    @State private var deleteTarget: CarapaceChatSessionGroup?
    @State private var routeLease: CarapaceChatSessionGroupsRouteLease?
    ...
    private func renameGroup(_ target: CarapaceChatSessionGroup, to name: String) async {
        defer { self.isMutating = false }
    ...
    private func deleteGroup(_ target: CarapaceChatSessionGroup) async {
        defer { self.isMutating = false }
...
public struct ChatNewSessionOptionsPopover: View {
    ...
    @State private var agents: [CarapaceChatAgentChoice] = []
    @State private var selectedAgentID = ""
    @State private var usesWorktree = false
    @State private var baseRef = ""
    @State private var isLoading = true
    @State private var isCreating = false
    @State private var routeLease: CarapaceChatNewSessionRouteLease?
    @State private var errorText: String?

    public init(viewModel: CarapaceChatViewModel, onComplete: @escaping () -> Void) {
        self.viewModel = viewModel
        self.onComplete = onComplete
    }

    private var selectedAgent: CarapaceChatAgentChoice? {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("New Thread Options")
                .font(CarapaceChatTypography.body(size: 15, weight: .semibold, relativeTo: .headline))
