...
public struct ChatModelProviderSection: Identifiable, Sendable, Equatable {
    ...
    public let models: [CarapaceChatModelChoice]
    public let isDefaultProvider: Bool
}

public struct ChatModelPickerSections: Sendable, Equatable {
    public let pinned: [CarapaceChatModelChoice]
    public let recent: [CarapaceChatModelChoice]
    public let providers: [ChatModelProviderSection]
}

@MainActor
public final class ChatModelPickerStore {
    private static let favoritesKey = "carapace.chat.modelFavorites"
    private static let recentsKey = "carapace.chat.modelRecents"
    ...
    public func recordRecent(_ selectionID: String) {
        guard !selectionID.isEmpty, selectionID != CarapaceChatViewModel.defaultModelSelectionID else { return }
    ...
    static func isDefaultModel(
        _ choice: CarapaceChatModelChoice,
    ...
    private static func effectiveProvider(_ choice: CarapaceChatModelChoice) -> String {
