...
public struct CarapaceChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: CarapaceChatSessionEntry?,
        defaults: CarapaceChatSessionsDefaults?,
        modelContextWindow: Int?) -> CarapaceChatContextUsage?
    {
        ...
        return CarapaceChatContextUsage(
    ...
    private static func latestRunTokens(in messages: [CarapaceChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [CarapaceChatMessage]) -> Double? {
...
extension CarapaceChatViewModel {
    public var contextUsage: CarapaceChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: CarapaceChatSessionEntry?) -> Int? {
