...
public enum CarapaceChatPermissionMode: String, Codable, CaseIterable, Hashable, Sendable {
...
public struct CarapaceChatSessionToolOverrides: Codable, Hashable, Sendable {
...
public struct CarapaceChatComposerSkill: Identifiable, Equatable, Sendable {
...
public struct CarapaceChatComposerTool: Identifiable, Equatable, Sendable {
    public let name: String
...
public struct CarapaceChatComposerConnector: Identifiable, Equatable, Sendable {
    public let name: String
    public let baseEnabled: Bool
    public let tools: [CarapaceChatComposerTool]
    ...
    public init(
        name: String,
        baseEnabled: Bool,
        tools: [CarapaceChatComposerTool],
        notice: String? = nil)
    {
        self.name = name
        self.baseEnabled = baseEnabled
...
public struct CarapaceChatComposerCapabilityCatalog: Equatable, Sendable {
    ...
    public let skills: [CarapaceChatComposerSkill]
    public let connectors: [CarapaceChatComposerConnector]
...
@MainActor
@Observable
final class CarapaceChatComposerCapabilityState {
    ...
    var catalog = CarapaceChatComposerCapabilityCatalog()
