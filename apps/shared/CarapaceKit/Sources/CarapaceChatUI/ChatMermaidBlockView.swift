...
struct ChatMermaidBlockView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 0) {
                ...
                Menu {
                    ...
                    Button {
                        ...
                        Text("Copy diagram source").font(CarapaceChatTypography.body)
                    }
                    #endif
                    Button {
                        ...
                        if self.showSource {
                            Text("View diagram").font(CarapaceChatTypography.body)
                        } else {
                            Text("View source").font(CarapaceChatTypography.body)
                        }
                    }
                    Button {
                        self.expand()
                    } label: {
                        Text("Expand diagram").font(CarapaceChatTypography.body)
                    }
                    ...
                    if self.canRetry {
                        Button {
                            ...
                            Text("Retry diagram").font(CarapaceChatTypography.body)
                        }
                    }
                } label: {
            ...
            if self.showSource {
                ...
                Button {
                    ...
                    CarapacePlatformImageFactory.image(rendered.image)
                        .resizable()
        ...
        .background(CarapaceChatTheme.assistantBubble)
    ...
    private func expand() {
        ...
        self.expanded = PreviewSelection(
            svg: rendered.svg,
            background: self.cssColor(CarapaceChatTheme.assistantBubble))
    }
    ...
    private var request: ChatMermaidRequest? {
        ...
        return ChatMermaidRequest(
            ...
            theme: ChatMermaidTheme(
                background: self.cssColor(CarapaceChatTheme.assistantBubble),
                foreground: self.cssColor(CarapaceChatTheme.assistantText),
                muted: self.cssColor(.secondary),
                border: self.cssColor(CarapaceChatTheme.divider),
                accent: self.cssColor(CarapaceChatTheme.accent),
