...
public struct CarapaceChatGatewayRequest: Sendable, Equatable {
...
public enum CarapaceChatSessionUnreadPatch: Sendable, Equatable {
    case markUnread
    case read
...
public enum CarapaceChatSessionTargetPolicy: Sendable {
    case preserveBareKeys
    case scopeBareKeysToSelectedAgent
}

public struct CarapaceChatSessionTarget: Sendable, Equatable {
    ...
    public static func resolve(
        ...
        policy: CarapaceChatSessionTargetPolicy) -> Self
    {
...
public enum CarapaceChatGatewayRequests {
    ...
    public static func agentsList(timeoutMs: Double = 15000) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(method: "agents.list", timeoutMs: timeoutMs)
    }

    public static func modelsList(agentID: String?) -> CarapaceChatGatewayRequest {
        var params: [String: AnyCodable] = [:]
        self.add(agentID, to: &params, key: "agentId")
        return CarapaceChatGatewayRequest(
            method: "models.list",
            params: params,
            timeoutMs: self.defaultTimeoutMs)
    }

    public static func composerSkillsStatus(agentID: String?) -> CarapaceChatGatewayRequest {
        var params: [String: AnyCodable] = [:]
        self.add(agentID, to: &params, key: "agentId")
        return CarapaceChatGatewayRequest(
    ...
    public static func composerConfigGet() -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(method: "config.get", timeoutMs: self.defaultTimeoutMs)
    }

    public static func composerToolsEffective(
        sessionKey: String,
        agentID: String?) -> CarapaceChatGatewayRequest
    {
    ...
    public static func artifactDownload(
        sessionKey: String,
        agentID: String?,
        artifactId: String) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func chatMetadata(
        ...
        includeSessionKey: Bool = false) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [:]
        self.add(
            CarapaceChatSessionKey.agentID(from: sessionKey) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
    ...
    public static func questionList() -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(method: "question.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func tasksList(
        sessionKey: String,
        agentID: String?,
        limit: Int = 200) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func questionGet(id: String) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
            method: "question.get",
    ...
    public static func resolveQuestion(
        ...
        secretStoreAllowedHosts: [String]? = nil) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "id": AnyCodable(id),
    ...
    public static func cancelQuestion(id: String) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
            method: "question.resolve",
            params: [
                "id": AnyCodable(id),
    ...
    public static func sessionsList(
        ...
        timeoutMs: Double = 15000) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func sessionGroupsList() -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
            method: "sessions.groups.list",
            timeoutMs: self.defaultTimeoutMs)
    }

    public static func sessionGroupsPut(names: [String]) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
    ...
    public static func sessionGroupsRename(
        name: String,
        to: String) -> CarapaceChatGatewayRequest
    {
        CarapaceChatGatewayRequest(
    ...
    public static func sessionGroupsDelete(name: String) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
    ...
    public static func createSession(
        ...
        worktree: Bool?,
        worktreeBaseRef: String? = nil) -> CarapaceChatGatewayRequest
    {
    ...
    public static func abortRun(
        ...
        agentID: String?,
        runID: String,
        requestTimeoutMs: Int = 10000) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func patchSessionPreferences(
        ...
        verboseLevel: String?? = nil) -> CarapaceChatGatewayRequest
    {
    ...
    public static func patchSessionSettings(
        ...
        supportsSessionSettingsCAS: Bool = false) -> CarapaceChatGatewayRequest
    {
    ...
    private static func fastModeValue(_ mode: CarapaceChatFastMode) -> AnyCodable {
        switch mode {
    ...
    private static func toolOverridesValue(_ overrides: CarapaceChatSessionToolOverrides) -> AnyCodable {
    ...
    public static func patchSession(
        ...
        pinned: Bool?,
        archived: Bool?,
        unreadPatch: CarapaceChatSessionUnreadPatch?) -> CarapaceChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
    ...
    public static func forkSession(
        parentSessionKey: String,
        agentID: String?,
        fromLastCompleted: Bool = false) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func rewindSession(
        sessionKey: String,
        agentID: String?,
        entryId: String) -> CarapaceChatGatewayRequest
    {
    ...
    public static func switchSessionBranch(
        sessionKey: String,
        agentID: String?,
        leafEntryId: String) -> CarapaceChatGatewayRequest
    {
        var params = self.sessionParams(
            sessionKey: sessionKey,
            agentID: agentID,
    ...
    public static func subscribeSessions(timeoutMs: Double = 10000) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
    ...
    public static func setSessionObserverVisibility(
        _ visible: Bool,
        timeoutMs: Double = 10000) -> CarapaceChatGatewayRequest
    {
        CarapaceChatGatewayRequest(
    ...
    public static func compactSession(
        sessionKey: String,
        agentID: String?,
        maxLines: Int? = nil) -> CarapaceChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let maxLines {
    ...
    public static func history(
        ...
        timeoutMs: Int? = nil) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = ["sessionKey": AnyCodable(sessionKey)]
        self.add(agentID, to: &params, key: "agentId")
        if let limit {
    ...
    public static func progressCardGet(sessionKey: String, agentID: String?) -> CarapaceChatGatewayRequest {
        ...
        if target.agentID != CarapaceChatSessionKey.agentID(from: target.sessionKey)?.lowercased() {
    ...
    public static func commandsList(
        sessionKey: String?,
        fallbackAgentID: String?) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
        ...
        self.add(
            sessionKey.flatMap(CarapaceChatSessionKey.agentID) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
        return CarapaceChatGatewayRequest(
    ...
    public static func sendMessage(
        ...
        requestTimeoutMs: Int = 30000) -> CarapaceChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func agentWait(
        runID: String,
        timeoutMs: Int,
        requestGraceMs: Int = 5000) -> CarapaceChatGatewayRequest
    {
        CarapaceChatGatewayRequest(
            method: "agent.wait",
            params: [
    ...
    public static func health(timeoutMs: Int) -> CarapaceChatGatewayRequest {
        CarapaceChatGatewayRequest(
            method: "health",
