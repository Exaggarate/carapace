...
extension CarapaceChatComposer {
    ...
    private func cleanContextUsageTokensLine(_ usage: CarapaceChatContextUsage) -> String {
    ...
    private func cleanInlineModelLabel(compact: Bool) -> some View {
        ...
        if compact {
            Image(systemName: "cpu")
                .font(CarapaceChatTypography.display(size: 16, weight: .semibold, relativeTo: .body))
                .foregroundStyle(.secondary)
                .frame(
    ...
    private func cleanInlineModelOptions(_ models: [CarapaceChatModelChoice]) -> some View {
