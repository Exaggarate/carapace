...
extension CarapaceChatViewModel {
    ...
    public func isModelUnavailable(_ model: CarapaceChatModelChoice) -> Bool {
    ...
    public func modelUnavailableDescription(_ model: CarapaceChatModelChoice) -> String? {
    ...
    public var selectedModelUnavailableReason: CarapaceChatModelUnavailableReason? {
    ...
    public func isDefaultModel(_ model: CarapaceChatModelChoice) -> Bool {
    ...
    static func modelSelectionMatches(
        ...
        choices: [CarapaceChatModelChoice]) -> Bool
    {
        ...
        self.enqueueSessionSettingsPatch(requestID: requestID, target: target) { [weak self] routeLease in
            ...
            do {
                ...
                let result = try await routeLease.patchSessionSettings(
                    ...
                    patch: CarapaceChatSessionSettingsPatch(verboseLevel: .some(next)))
        ...
        self.enqueueSessionSettingsPatch(requestID: requestID, target: target) { [weak self] routeLease in
            ...
            do {
                ...
                let result = try await routeLease.patchSessionSettings(
                    sessionKey: target.canonicalSessionKey,
                    agentID: target.agentID,
                    patch: CarapaceChatSessionSettingsPatch(fastMode: .some(next)))
    ...
    func applyModelControlPatchResult(
        _ result: CarapaceChatModelPatchResult,
        sessionKey: String,
    ...
    private func recordModelControlPatchSuccess(
        ...
        fastModeOverride: CarapaceChatFastMode?? = nil,
        ...
        verboseLevelOverride: String?? = nil)
    {
        ...
        let recordedFastMode: CarapaceChatFastMode? = if let fastModeOverride {
            fastModeOverride
        } else {
        ...
        self.lastSuccessfulSettingsPatchResultsByTarget[target] = CarapaceChatModelPatchResult(
    ...
    private func updateCurrentSessionFastMode(
        _ mode: CarapaceChatFastMode?,
        effective: CarapaceChatFastMode?,
        sessionKey: String,
        exactMatchOnly: Bool = false)
    {
        let index = exactMatchOnly
