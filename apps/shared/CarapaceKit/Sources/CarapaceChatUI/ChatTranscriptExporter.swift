...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [CarapaceChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: CarapaceChatMessage) -> Bool {
    ...
    private static func body(for message: CarapaceChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: CarapaceChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: CarapaceChatMessage) -> [CarapaceChatMessageContent] {
