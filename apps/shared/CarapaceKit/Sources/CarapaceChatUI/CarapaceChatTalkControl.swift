public struct CarapaceChatAudioInputDevice: Equatable, Identifiable, Sendable {
...
public enum CarapaceCameraFacingSelection: String, Equatable, Sendable {
    case back
    case front
}

public struct CarapaceChatTalkControl {
    ...
    public var inputDevices: [CarapaceChatAudioInputDevice]
    public var selectedInputDeviceID: String?
    public var selectInputDevice: (@MainActor (_ deviceID: String?) -> Void)?
    public var cameraFacing: CarapaceCameraFacingSelection?
    ...
    public init(
        ...
        inputDevices: [CarapaceChatAudioInputDevice] = [],
        selectedInputDeviceID: String? = nil,
        selectInputDevice: (@MainActor (_ deviceID: String?) -> Void)? = nil,
        cameraFacing: CarapaceCameraFacingSelection? = nil,
