...
public enum CarapaceChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case chatMetadataChanged
    case sessionsChanged(CarapaceChatSessionsChangedEvent)
    case sessionObserver(SessionObserverDigest)
    case chat(CarapaceChatEventPayload)
    case sessionMessage(CarapaceSessionMessageEventPayload)
    case agent(CarapaceAgentEventPayload)
    case progressCardChanged(ProgressCardChangedEvent)
    case task(CarapaceChatTaskEvent)
    case questionRequested(QuestionRecord)
    case questionResolved(CarapaceQuestionResolvedEvent)
    case routeChanged
    case seqGap
}

public enum CarapaceChatTaskEvent: Sendable, Decodable {
...
public struct CarapaceQuestionResolvedEvent: Codable, Sendable {
...
public struct CarapaceChatSessionsChangedEvent: Codable, Sendable, Equatable {
    ...
    public let session: CarapaceChatSessionEntry?
    public let updatedAt: Double?
    public let lastReadAt: Double?
    public let color: String?
    public let agentStatus: CarapaceChatSessionAgentStatus?
    public let observerDigest: CarapaceChatSessionObserverDigest?
    ...
    public init(
        ...
        phase: String? = nil,
        runId: String? = nil,
        session: CarapaceChatSessionEntry? = nil,
        updatedAt: Double? = nil,
        lastReadAt: Double? = nil,
        color: String? = nil,
        agentStatus: CarapaceChatSessionAgentStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.session = try container.decodeIfPresent(CarapaceChatSessionEntry.self, forKey: .session)
        ...
        self.agentStatus = try decode(CarapaceChatSessionAgentStatus.self, forKey: .agentStatus)
        self.observerDigest = try decode(CarapaceChatSessionObserverDigest.self, forKey: .observerDigest)
...
public struct CarapaceChatTransportRouteLease: Sendable {
    public typealias SendMessage = @Sendable (
        _ sessionKey: String,
        _ message: String,
        _ thinking: String,
        _ idempotencyKey: String,
        _ attachments: [CarapaceChatAttachmentPayload]) async throws -> CarapaceChatSendResponse
    public typealias RequestHistory = @Sendable (String) async throws -> CarapaceChatHistoryPayload
    public typealias SendTargetedMessageWithSettings = @Sendable (
        _ sessionKey: String,
        _ agentID: String?,
        _ expectedSessionSettings: CarapaceChatSessionSettingsExpectation?,
        _ message: String,
        _ thinking: String,
        _ idempotencyKey: String,
        _ attachments: [CarapaceChatAttachmentPayload]) async throws -> CarapaceChatSendResponse
    public typealias RequestTargetedHistory = @Sendable (
        _ sessionKey: String,
        _ agentID: String?) async throws -> CarapaceChatHistoryPayload
    ...
    public func requestHistory(
        sessionKey: String,
        agentID: String? = nil) async throws -> CarapaceChatHistoryPayload
    {
        try await self.requestTargetedHistoryImpl(sessionKey, agentID)
    }
}

public enum CarapaceChatTransportRouteLeaseResult: Sendable {
    case available(CarapaceChatTransportRouteLease)
...
public struct CarapaceChatSessionSettingsRouteLease: Sendable {
    public typealias PatchSessionSettings = @Sendable (
        _ sessionKey: String,
        _ agentID: String?,
        _ patch: CarapaceChatSessionSettingsPatch) async throws -> CarapaceChatModelPatchResult?
...
public struct CarapaceChatSessionMutationRouteLease: Sendable {
    ...
    public init(
        sessionTarget: @escaping @Sendable (String) -> CarapaceChatSessionTarget,
        unreadAckContract: Bool?,
        request: @escaping @Sendable (CarapaceChatGatewayRequest) async throws -> Data)
    {
        self.init(
            patchSession: { key, expectedID, expectedMarkedUnreadAt, label, category, color, pinned, archived, unread in
                ...
                _ = try await request(CarapaceChatGatewayRequests.patchSession(
            ...
            deleteSession: { key in
                let target = sessionTarget(key)
                _ = try await request(CarapaceChatGatewayRequests.deleteSession(
                    sessionKey: target.sessionKey,
                    agentID: target.agentID))
            })
    }
...
public struct CarapaceChatSessionGroupsRouteLease: Sendable {
    public typealias ListGroups = @Sendable () async throws -> CarapaceChatSessionGroupsResponse?
    public typealias PutGroups = @Sendable ([String]) async throws -> CarapaceChatSessionGroupsMutationResponse
    public typealias RenameGroup = @Sendable (String, String) async throws -> CarapaceChatSessionGroupsMutationResponse
    public typealias DeleteGroup = @Sendable (String) async throws -> CarapaceChatSessionGroupsMutationResponse
    ...
    public func listGroups() async throws -> CarapaceChatSessionGroupsResponse? {
        try await self.listGroupsImpl()
    }

    public func putGroups(names: [String]) async throws -> CarapaceChatSessionGroupsMutationResponse {
        try await self.putGroupsImpl(names)
    }

    public func renameGroup(name: String, to: String) async throws -> CarapaceChatSessionGroupsMutationResponse {
        try await self.renameGroupImpl(name, to)
    }

    public func deleteGroup(name: String) async throws -> CarapaceChatSessionGroupsMutationResponse {
...
public struct CarapaceChatNewSessionRouteLease: Sendable {
    public typealias ListAgents = @Sendable () async throws -> CarapaceChatAgentsListResponse?
    public typealias CreateSession = @Sendable (
        ...
        _ worktree: Bool?,
        _ worktreeBaseRef: String?) async throws -> CarapaceChatCreateSessionResponse
    ...
    public func listAgents() async throws -> CarapaceChatAgentsListResponse? {
...
public enum CarapaceChatTransportSendError: Error, Sendable {
    case notDispatched
}

public enum CarapaceChatProgressCardError: LocalizedError, Sendable {
    case ownerScopeUnavailable

    public var errorDescription: String? {
        CarapaceChatTransportUpgradeMessage.progressCardAgentScope
    }
}

public enum CarapaceChatTransportUpgradeMessage {
...
public enum CarapaceChatRunTerminalState: Sendable, Equatable {
    case completed
    case failed(message: String)
}

public enum CarapaceChatRunObservation: Sendable, Equatable {
    case terminal(CarapaceChatRunTerminalState)
    case checkAgain
    case unavailable
...
public struct CarapaceChatMetadataCapabilities: Codable, Sendable, Equatable {
...
public struct CarapaceChatModelCatalogSnapshot: Sendable, Equatable {
    public let choices: [CarapaceChatModelChoice]
    public let availabilityIsSessionScoped: Bool

    public init(
        choices: [CarapaceChatModelChoice],
...
public enum CarapaceChatMediaKind: String, Sendable {
    case image
    case audio
    case video
...
public struct CarapaceChatMediaData: Sendable {
...
public struct CarapaceChatMediaStream: Sendable {
    public let url: URL
    public let mimeType: String?
...
public enum CarapaceChatLoadedMedia: Sendable {
    case data(CarapaceChatMediaData)
    case stream(CarapaceChatMediaStream)
    case preparing
}
...
public struct CarapaceChatSwarmRouteLease: Sendable {
    public typealias IsEnabled = @Sendable (_ sessionKey: String) async throws -> Bool
    public typealias ListChildSessions = @Sendable (_ parentKey: String) async throws -> [CarapaceChatSessionEntry]
    ...
    public func listChildSessions(parentKey: String) async throws -> [CarapaceChatSessionEntry] {
        try await self.listChildSessionsImpl(parentKey)
    }
}

public protocol CarapaceChatTransport: Sendable {
    func createSession(
        key: String,
        label: String?,
        parentSessionKey: String?,
    ...
    func renameSessionGroup(name: String, to: String) async throws -> CarapaceChatSessionGroupsMutationResponse
    ...
    func rewindSession(sessionKey: String, entryId: String) async throws -> CarapaceChatRewindResponse
    ...
    func waitForRunCompletion(runId: String, timeoutMs: Int) async -> CarapaceChatRunObservation
...
extension CarapaceChatTransport {
    ...
    public func loadMediaArtifact(
        sessionKey _: String,
        artifactId _: String,
        kind _: CarapaceChatMediaKind,
        playback _: CarapaceChatPlaybackMode?) async throws -> CarapaceChatLoadedMedia?
    {
        nil
    }
    ...
    public func acquireSwarmRouteLease() async -> CarapaceChatSwarmRouteLease? {
        let transport = self
    ...
    public func requestFullMessage(sessionKey _: String, messageID _: String) async throws -> CarapaceChatMessage? {
        nil
    }
        ...
        replacing failedResource: CarapaceChatWidgetResource?) async -> CarapaceChatWidgetResource?
    {
        ...
        return CarapaceChatWidgetResource(url: url)
    }
    ...
    public func acquireOutboxRouteLease() async -> CarapaceChatTransportRouteLeaseResult {
        let transport = self
    ...
    public func acquireSessionSettingsRouteLease() async -> CarapaceChatSessionSettingsRouteLease? {
        let transport = self
    ...
    public func acquireSessionMutationRouteLease() async -> CarapaceChatSessionMutationRouteLease? {
        let transport = self
    ...
    public func acquireSessionGroupsRouteLease() async -> CarapaceChatSessionGroupsRouteLease? {
        let transport = self
    ...
    public func acquireNewSessionRouteLease() async -> CarapaceChatNewSessionRouteLease? {
        let transport = self
    ...
    public func waitForRunCompletion(runId _: String, timeoutMs _: Int) async -> CarapaceChatRunObservation {
        .unavailable
    }
    ...
    public func listChildSessions(parentKey _: String) async throws -> [CarapaceChatSessionEntry] {
        []
    }
    ...
    public func listSessions(limit: Int?, archived: Bool) async throws -> CarapaceChatSessionsListResponse {
    ...
    public func listSessionGroups() async throws -> CarapaceChatSessionGroupsResponse? {
        nil
    }

    public func putSessionGroups(names _: [String]) async throws -> CarapaceChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func renameSessionGroup(
        name _: String,
        to _: String) async throws -> CarapaceChatSessionGroupsMutationResponse
    {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func deleteSessionGroup(name _: String) async throws -> CarapaceChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func rewindSession(
        sessionKey _: String,
        entryId _: String) async throws -> CarapaceChatRewindResponse
    {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func forkSessionAtMessage(
        sessionKey _: String,
        entryId _: String) async throws -> CarapaceChatForkAtMessageResponse
    {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func listSessionBranches(
        sessionKey _: String,
        agentID _: String?) async throws -> CarapaceChatSessionBranchesResponse
    {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func listModels(agentID _: String?) async throws -> [CarapaceChatModelChoice] {
        throw NSError(
            domain: "CarapaceChatTransport",
            code: 0,
    ...
    public func listCommands(sessionKey _: String) async throws -> [CarapaceChatCommandChoice] {
        []
    }
...
public enum CarapaceChatSessionRoutingContract {
...
enum CarapaceChatSessionSettingsContract {
