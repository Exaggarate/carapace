...
enum ChatMermaidResources {
    static let scheme = "carapace-mermaid"
    static let documentURL = URL(string: "carapace-mermaid://renderer/index.html")!
    ...
    static func directory() -> URL? {
        ...
        if Bundle.main.bundleURL.pathExtension == "app" {
            ...
            guard let url = Bundle.main.url(forResource: "CarapaceKit_CarapaceChatUI", withExtension: "bundle"),
...
final class ChatMermaidSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    init(directory: URL) throws {
        ...
        for filename in ["index.html", "native.js", "frame.js", "mermaid.min.js"] {
            ...
            resources["carapace-mermaid://renderer/\(filename)"] = try Resource(
