...
public struct CarapaceChatReplyTarget: Equatable, Sendable {
...
enum ChatReplyQuote {
    ...
    static func prepend(message: String, replyTarget: CarapaceChatReplyTarget) -> String {
...
extension CarapaceChatViewModel {
    ...
    func setReplyTarget(messageID: UUID, text: String, senderLabel: String) {
        ...
        self.replyTarget = CarapaceChatReplyTarget(
            messageID: messageID,
            text: text,
    ...
    func consumeReplyTarget(_ target: CarapaceChatReplyTarget?) {
