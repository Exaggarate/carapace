...
public struct CarapaceChatSessionAgentStatus: Codable, Sendable, Hashable {
    public let note: String
    public let expiresAt: Double
    public let attention: String?
}

public struct CarapaceChatSessionObserverDigest: Codable, Sendable, Hashable {
...
public struct CarapaceChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public enum CarapaceChatFastMode: Sendable, Equatable, Hashable, Codable {
    case off
    case on
    case automatic
...
public struct CarapaceChatModelChoice: Identifiable, Codable, Sendable, Hashable {
    ...
    public var availabilityReason: CarapaceChatModelUnavailableReason? {
        CarapaceChatModelUnavailableReason(rawValue: self.unavailableReason)
    }
}

public enum CarapaceChatModelUnavailableReason: Sendable, Equatable, Hashable {
    case missingAuth
    case authFailed
    case cooldown
    case unknown(String)
...
public struct CarapaceChatSessionSettingsPatch: Sendable, Equatable {
    /// Outer optional means unchanged; inner optional clears the override.
    public let expectedSessionID: String?
    public let expectedPermissionMode: CarapaceChatPermissionMode??
    public let expectedToolOverrides: CarapaceChatSessionToolOverrides??
    public let model: String??
    public let thinkingLevel: String??
    public let fastMode: CarapaceChatFastMode??
    public let verboseLevel: String??
    public let permissionMode: CarapaceChatPermissionMode??
    public let toolOverrides: CarapaceChatSessionToolOverrides??

    public init(
        expectedSessionID: String? = nil,
        expectedPermissionMode: CarapaceChatPermissionMode?? = nil,
        expectedToolOverrides: CarapaceChatSessionToolOverrides?? = nil,
        model: String?? = nil,
    ...
    func withExpectedSessionID(
        ...
        expectedPermissionMode: CarapaceChatPermissionMode?? = nil,
        expectedToolOverrides: CarapaceChatSessionToolOverrides?? = nil) -> Self
    {
        Self(
...
public struct CarapaceChatSessionSettingsExpectation: Codable, Hashable, Sendable {
    public let permissionMode: CarapaceChatPermissionMode?
    public let toolOverrides: CarapaceChatSessionToolOverrides?

    public init(
        permissionMode: CarapaceChatPermissionMode?,
...
public struct CarapaceChatSendTarget: Hashable, Sendable {
    public let agentID: String?
...
public struct CarapaceChatModelPatchResult: Decodable, Sendable, Equatable {
    public let key: String?
    public let modelProvider: String?
    public let model: String?
    public let thinkingLevel: String?
    public let thinkingLevels: [CarapaceChatThinkingLevelOption]?
    public let fastMode: CarapaceChatFastMode?
    public let effectiveFastMode: CarapaceChatFastMode?
    public let verboseLevel: String?
    public let permissionMode: CarapaceChatPermissionMode?
    public let toolOverrides: CarapaceChatSessionToolOverrides?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let entryFastMode = try entry.decodeIfPresent(CarapaceChatFastMode.self, forKey: .fastMode)
        let entryEffectiveFastMode = try entry.decodeIfPresent(
            CarapaceChatFastMode.self,
        ...
        if container.contains(.resolved) {
            ...
            self.thinkingLevels = try resolved.decodeIfPresent(
                [CarapaceChatThinkingLevelOption].self,
                forKey: .thinkingLevels)
            self.fastMode = try resolved.decodeIfPresent(CarapaceChatFastMode.self, forKey: .fastMode)
                ?? entryFastMode
...
public struct CarapaceChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
...
public struct CarapaceChatSessionWorktree: Codable, Sendable, Hashable {
    public let id: String?
...
public struct CarapaceChatAgentRuntime: Codable, Sendable, Hashable {
    public let id: String
    public let fallback: String?
    public let source: String?
}

public struct CarapaceChatSessionGroup: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.name
    }
...
public struct CarapaceChatSessionGroupsResponse: Codable, Sendable, Equatable {
    public let groups: [CarapaceChatSessionGroup]
}

public struct CarapaceChatSessionGroupsMutationResponse: Codable, Sendable, Equatable {
    public let ok: Bool
    public let groups: [CarapaceChatSessionGroup]
    public let updatedSessions: Int?
}

public struct CarapaceChatAgentChoice: Codable, Identifiable, Sendable, Hashable {
    public let id: String
    public let name: String?
...
public struct CarapaceChatAgentsListResponse: Codable, Sendable, Equatable {
    public let defaultId: String
    public let agents: [CarapaceChatAgentChoice]

    public init(defaultId: String, agents: [CarapaceChatAgentChoice]) {
        self.defaultId = defaultId
        self.agents = agents
    }
}

public struct CarapaceChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
    ...
    public var agentStatus: CarapaceChatSessionAgentStatus?
    public var observerDigest: CarapaceChatSessionObserverDigest?
    ...
    public var worktree: CarapaceChatSessionWorktree?
    public var startedAt: Double?
    public var endedAt: Double?
    public var runtimeMs: Double?
    public var agentRuntime: CarapaceChatAgentRuntime?

    public var systemSent: Bool?
    public var abortedLastRun: Bool?
    public var thinkingLevel: String?
    public var verboseLevel: String?
    public var fastMode: CarapaceChatFastMode?
    public var effectiveFastMode: CarapaceChatFastMode?
    public var permissionMode: CarapaceChatPermissionMode?
    public var toolOverrides: CarapaceChatSessionToolOverrides?
    ...
    public var thinkingLevels: [CarapaceChatThinkingLevelOption]?
    ...
    public init(
        ...
        swarmLog: String? = nil,
        worktree: CarapaceChatSessionWorktree? = nil,
        fastMode: CarapaceChatFastMode? = nil,
        effectiveFastMode: CarapaceChatFastMode? = nil,
        permissionMode: CarapaceChatPermissionMode? = nil,
        toolOverrides: CarapaceChatSessionToolOverrides? = nil,
        ...
        agentRuntime: CarapaceChatAgentRuntime? = nil,
    ...
    static func placeholder(key: String) -> CarapaceChatSessionEntry {
...
public enum CarapaceChatSessionListOrganizer {
    public static func organize(_ sessions: [CarapaceChatSessionEntry]) -> [CarapaceChatSessionEntry] {
    ...
    public static func filter(
        ...
        search: String) -> [CarapaceChatSessionEntry]
    {
...
public enum CarapaceChatChildSessionPager {
    private static let maxCollectedSessions = 100_000
    private static let maxPageRequests = 100

    public static func collect(
        fetchPage: (Int) async throws -> CarapaceChatSessionsListResponse) async throws
        -> [CarapaceChatSessionEntry]
    {
        var rowsByKey: [String: CarapaceChatSessionEntry] = [:]
...
public struct CarapaceChatSessionsListResponse: Codable, Sendable {
    ...
    public let defaults: CarapaceChatSessionsDefaults?
    public let sessions: [CarapaceChatSessionEntry]
