...
struct ChatTranscriptExporterTests {
    @Test func `exports system transcript rows without leaking internal prompts`() throws {
        ...
        [
          ...
          },
          {
            ...
            "content": [],
            "timestamp": 1000,
            "__carapace": {"kind": "compaction", "id": "compact-1", "tokensBefore": 25000, "tokensAfter": 12500}
          },
          {
            "role": "system",
            "content": [],
            "timestamp": 2000,
            "__carapace": {"kind": "reset", "id": "reset-1"}
          },
          {
            "role": "system",
            "content": [{"type": "text", "text": "Unknown marker body"}],
            "timestamp": 3000,
            "__carapace": {"kind": "future-marker", "id": "future-1"}
          }
        ]
        """#.utf8)
        let messages = try JSONDecoder().decode([CarapaceChatMessage].self, from: wire)
    ...
    func `classifies gateway media and historical file attachments consistently`(type: String) {
        let content = CarapaceChatMessageContent(
            type: type,
            text: nil,
            mimeType: nil,
            fileName: nil,
    ...
    private func message(role: String, text: String, timestamp: Double) -> CarapaceChatMessage {
        CarapaceChatMessage(
            role: role,
            content: [
                CarapaceChatMessageContent(
