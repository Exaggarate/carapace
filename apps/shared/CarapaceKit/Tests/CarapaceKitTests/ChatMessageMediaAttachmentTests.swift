...
struct ChatMessageMediaAttachmentTests {
    ...
    @Test(arguments: [
        (CarapaceChatMediaKind.image, "artifact_managed_image_11111111-1111-4111-8111-111111111111", true),
        (CarapaceChatMediaKind.image, "artifact_managed_media_11111111-1111-4111-8111-111111111111", false),
        (CarapaceChatMediaKind.audio, "artifact_managed_media_11111111-1111-4111-8111-111111111111", true),
        (CarapaceChatMediaKind.video, "artifact_managed_media_11111111-1111-4111-8111-111111111111", true),
        (CarapaceChatMediaKind.video, "artifact_managed_image_11111111-1111-4111-8111-111111111111", false),
    ])
    ...
    @Test @MainActor func `distinct images never reconcile as the same final message`() {
        ...
        #expect(
            CarapaceChatViewModel.finalMessageContentFingerprint(for: first) !=
                CarapaceChatViewModel.finalMessageContentFingerprint(for: second))
        #expect(
            CarapaceChatViewModel.messageContentFingerprint(for: first) !=
                CarapaceChatViewModel.messageContentFingerprint(for: second))
    }
    ...
    private static func message(artifactId: String) -> CarapaceChatMessage {
        CarapaceChatMessage(
            role: "assistant",
            content: [
