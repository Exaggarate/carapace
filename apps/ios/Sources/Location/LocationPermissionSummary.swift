...
struct LocationPermissionSummary: Equatable {
    var desiredMode: CarapaceLocationMode
    var locationServicesEnabled: Bool
    var authorizationStatus: CLAuthorizationStatus
    var accuracyAuthorization: CLAccuracyAuthorization

    var effectiveMode: CarapaceLocationMode {
    ...
    var detailText: String {
        ...
        {
        case (.off, false, _, _):
            "Location sharing is disabled in Carapace. Location Services are off in iOS Settings."
        case (.off, true, .authorizedAlways, _):
            "Location sharing is disabled in Carapace. iOS currently allows Always."
        case (.off, true, .authorizedWhenInUse, _):
            "Location sharing is disabled in Carapace. iOS currently allows While Using."
        case (.off, _, _, _):
        ...
        @unknown default:
            "Carapace cannot determine the current iOS location permission."
        }
    }
}
