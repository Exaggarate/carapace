...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CarapacePhotosLatestParams) async throws -> CarapacePhotosLatestPayload {
        ...
        var results: [CarapacePhotoPayload] = []
        ...
        return CarapacePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CarapacePhotoPayload
    {
