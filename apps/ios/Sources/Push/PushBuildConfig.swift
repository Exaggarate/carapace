...
struct PushBuildConfig {
    ...
    static let carapaceHostedRelayHost = "github.com/Exaggarate/carapace"
    static let carapaceSandboxRelayHost = "github.com/Exaggarate/carapace"

    var usesCarapaceHostedRelay: Bool {
        ...
        return components.scheme?.lowercased() == "https"
            && [Self.carapaceHostedRelayHost, Self.carapaceSandboxRelayHost]
    ...
    private init(readValue: (String) -> Any?) {
        ...
        case .appStore:
            ...
            self.relayBaseURL = URL(string: "https://\(Self.carapaceHostedRelayHost)")!
            self.apnsEnvironment = .production
            self.relayProfile = .production
            self.proofPolicy = .appleStrict
        case .deviceSandbox:
            ...
            self.relayBaseURL = relayBaseURLOverride
                ?? URL(string: "https://\(Self.carapaceSandboxRelayHost)")!
            self.apnsEnvironment = .sandbox
            self.relayProfile = .deviceSandbox
            self.proofPolicy = .appleDevelopment
        case .simulatorSandbox:
