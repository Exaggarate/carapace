            ...
            VStack(alignment: .leading, spacing: 0) {
                if let headerSidebarAction {
                    CarapaceAdaptiveHeaderRow(
                        ...
                        subtitleFont: CarapaceType.subheadMedium)
                    {
        ...
        return NavigationLink {
            ...
            HStack(spacing: 12) {
                Image(systemName: isDirectory ? "folder" : "doc.text")
                    ...
                    .foregroundStyle(isDirectory ? CarapaceBrand.accent : Color.secondary)
                    .frame(width: 24)
...
struct AgentWorkspaceFilePreview: View {
    ...
    private var content: some View {
        if let file {
            ...
            .padding(CarapaceProMetric.pagePadding)
        }
    }
    ...
    private func share() {
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("CarapaceWorkspaceFiles", isDirectory: true)
