...
Maintenance update for the current Carapace release.
...
Carapace is now available on iPhone.

Connect to your Carapace Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.
...
Maintenance update for the current Carapace development release.
...
First App Store release of Carapace for iPhone. Pair with your Carapace Gateway to use chat, voice, sharing, and device actions from iOS.
