package ai.carapace.app.benchmark
...
class CronJobNavigationTest {
  ...
  fun setUp() {
    ...
    device.executeShellCommand(
      "am start -W -n $packageName/ai.carapace.app.MainActivity " +
        "--ez carapace.screenshotMode true --es carapace.screenshotScene settings",
    )
