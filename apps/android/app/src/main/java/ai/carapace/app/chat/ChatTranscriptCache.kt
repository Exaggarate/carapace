...
private data class CachedMessagePayload(
  ...
  @SerialName("__carapace") val transcriptMarker: ChatTranscriptMarker? = null,
      ...
      messages
        .mapNotNull { message ->
          ...
          val isRealAssistantBoundary =
            message.role == "assistant" && !message.isSyntheticDisplay && !message.isTranscriptOnlyCarapaceAssistant()
