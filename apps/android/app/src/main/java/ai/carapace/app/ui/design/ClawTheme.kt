...
/**
 * Composition-local access point for Carapace Android design tokens.
 */
...
/**
 * Installs Carapace design tokens and maps them into MaterialTheme for Material3 controls.
 */
@Composable
