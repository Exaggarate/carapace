...
internal const val actionOpenConversationNotification =
  "ai.carapace.app.action.OPEN_CONVERSATION_NOTIFICATION"
internal const val actionConsumeConversationNotification =
  "ai.carapace.app.action.CONSUME_CONVERSATION_NOTIFICATION"
internal const val actionReplyConversationNotification =
  "ai.carapace.app.action.REPLY_CONVERSATION_NOTIFICATION"

private const val extraGatewayStableId = "ai.carapace.app.extra.CONVERSATION_GATEWAY_ID"
private const val extraAgentId = "ai.carapace.app.extra.CONVERSATION_AGENT_ID"
private const val extraSessionKey = "ai.carapace.app.extra.CONVERSATION_SESSION_KEY"
private const val extraRunId = "ai.carapace.app.extra.CONVERSATION_RUN_ID"
private const val extraLaunchToken = "ai.carapace.app.extra.CONVERSATION_LAUNCH_TOKEN"
private const val remoteInputReply = "ai.carapace.app.remote_input.CONVERSATION_REPLY"
private const val notificationIntentScheme = "carapace"
...
private const val conversationChannelId = "carapace.chat.replies"
private const val conversationNotificationId = 1
private const val conversationNotificationTagPrefix = "carapace.chat."
private const val conversationShortcutPrefix = "carapace-chat-"
private const val conversationGroup = "carapace.chat"
  ...
  private fun replyAction(target: ConversationNotificationTarget): NotificationCompat.Action {
    ...
    val remoteInput =
      RemoteInput
        ...
        .setLabel(nativeString("Reply to Carapace…"))
        .build()
  ...
  private fun ensureConversationShortcut(target: ConversationNotificationTarget) {
    val shortcut =
      ShortcutInfoCompat
        ...
        .setShortLabel(nativeString("Carapace"))
        .setLongLived(true)
