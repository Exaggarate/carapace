...
class ConnectionManager internal constructor(
  ...
  fun buildUserAgent(): String {
    ...
    return "CarapaceAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "carapace-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(
    ...
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "carapace-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
