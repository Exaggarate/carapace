...
/**
 * Universal Carapace talk animation: Compose port of the shared Siri-style
 * waveform in `apps/shared/CarapaceKit/Sources/CarapaceChatUI/TalkWaveformView.swift`.
