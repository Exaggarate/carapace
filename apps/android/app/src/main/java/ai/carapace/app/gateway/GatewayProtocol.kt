...
enum class GatewayMethod(
  ...
  CarapaceChat("carapace.chat"),
  CarapaceChatHistory("carapace.chat.history"),
  CarapaceChangesList("carapace.changes.list"),
  CarapaceApprovalList("carapace.approval.list"),
  CarapaceSetupDetect("carapace.setup.detect"),
  CarapaceSetupActivate("carapace.setup.activate"),
  CarapaceSetupActivateStart("carapace.setup.activate.start"),
  CarapaceSetupAuthStart("carapace.setup.auth.start"),
  CarapaceSetupPrepareStart("carapace.setup.prepare.start"),
  ...
  CarapaceSetupVerify("carapace.setup.verify"),
...
enum class GatewayEvent(
  ...
  CarapaceApprovalRequested("carapace.approval.requested"),
  CarapaceApprovalResolved("carapace.approval.resolved"),
