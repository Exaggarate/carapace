...
const val actionAskCarapace = "ai.carapace.app.action.ASK_CARAPACE"
...
private fun sharedAttachments(
  ...
  // prevents an external intent from turning Carapace into a reader for its own private files.
  val validUris =
    (streamUris + clipUris)
