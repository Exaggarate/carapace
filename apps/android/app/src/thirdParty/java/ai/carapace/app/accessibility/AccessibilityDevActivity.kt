...
import ai.carapace.app.ui.CarapaceTheme
...
class AccessibilityDevActivity : AppCompatActivity() {
  ...
  private fun refreshForegroundPackage() {
    foregroundPackageName = CarapaceAccessibilityService.instance?.foregroundPackageName()
  }
...
private fun AccessibilityDevScreen(
  ...
  val serviceConnection by CarapaceAccessibilityService.connection.collectAsState()
