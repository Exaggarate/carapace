...
class ChatMarkdownTest {
  ...
  fun markdownLinksUseLabelTextAndDestinationUrl() {
    val annotated = buildChatInlineMarkdown("Open [docs](https://github.com/Exaggarate/carapace) now")
    ...
    assertEquals("https://github.com/Exaggarate/carapace", (links.single().item as LinkAnnotation.Url).url)
  }

  @Test
  fun markdownLinksDropUnsafeDestinations() {
    listOf(
      "intent://example/#Intent;scheme=carapace;end",
