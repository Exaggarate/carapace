...
import ai.carapace.app.ui.controlUiOriginRule
import ai.carapace.app.ui.desktopUrl
import ai.carapace.app.ui.sessionDashboardUrl
import ai.carapace.app.ui.terminalUrl
...
class GatewayControlPageContextPathTest {
  ...
  fun controlPageBasePreservesNormalizedGatewayContextPaths() {
    val cases =
      listOf(
        GatewayEndpoint.manual("gateway.example", 443, true, "carapace-gw") to
          "https://gateway.example:443/carapace-gw",
        ...
        GatewayEndpoint.manual("gateway.example", 443, true, "//carapace") to
          "https://gateway.example:443//carapace",
