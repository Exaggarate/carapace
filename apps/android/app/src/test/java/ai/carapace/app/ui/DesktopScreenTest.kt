    ...
    val cases =
      listOf(
        ...
        DesktopUrlCase(
          ...
          baseUrl = "https://gateway.example.com:8443/carapace/",
          expected = "https://gateway.example.com:8443/carapace/focus/desktop",
        ),
        DesktopUrlCase(
          name = "encoded source",
          baseUrl = "https://gateway.example.com:8443",
        ...
        DesktopUrlCase(
          ...
          expected =
            "https://gateway.example.com:8443/carapace/focus/desktop/session/agent%3Amain%3Amobile%20session",
        ),
        DesktopUrlCase(
