package ai.carapace.app.chat

import ai.carapace.app.ui.chat.readBoundedWidgetDocument
...
class ChatMessageContentParsingTest {
  ...
  fun parsesCapabilityGatedCanvasWidgets() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","title":"Status","preferredHeight":240,"url":"/__carapace__/canvas/documents/widget-1/index.html","sandbox":"scripts"}}""",
      )
    ...
    assertEquals(
      ChatMessageContent(
        ...
        widget =
          ChatWidgetPreview(
            title = "Status",
            path = "/__carapace__/canvas/documents/widget-1/index.html",
            preferredHeight = 240,
            sandbox = "scripts",
          ),
      ),
  ...
  fun dropsCanvasBlocksWithoutWidgetSandbox() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","url":"/__carapace__/canvas/documents/widget-1/index.html"}}""",
      )
  ...
  fun resolvesOnlyCapabilityScopedWidgetDocuments() {
    val surface = "https://gateway.example/__carapace__/cap/token"

    assertEquals(
      "https://gateway.example/__carapace__/cap/token/__carapace__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(surface, "/__carapace__/canvas/documents/widget-1/index.html"),
    )
    assertEquals(
      "https://gateway.example/__carapace__/cap/token/__carapace__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(
        "HTTPS://gateway.example/__carapace__/cap/token",
        "/__carapace__/canvas/documents/widget-1/index.html",
      ),
    )
    assertNull(ChatWidgetUrlResolver.resolve("https://gateway.example", "/__carapace__/canvas/documents/widget-1/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "https://attacker.example/widget.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__carapace__/a2ui/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__carapace__/canvas/documents/%252e%252e/index.html"))
  }

  @Test
  fun initialResolutionUsesOperatorFallbackWhenNodeUnavailable() {
    val target = "/__carapace__/canvas/documents/widget-1/index.html"
    val fallbackSurface = "https://operator.example/__carapace__/cap/fallback"
    val surfaces =
  ...
  fun usesReplacementRouteAfterCapabilityRefreshLosesItsLease() =
    runTest {
      val target = "/__carapace__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://gateway.example/__carapace__/cap/old"
      val newSurface = "https://gateway.example/__carapace__/cap/new"
  ...
  fun refreshesOperatorCapabilityWhenNodeUnavailable() =
    runTest {
      val target = "/__carapace__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://operator.example/__carapace__/cap/old"
      val newSurface = "https://operator.example/__carapace__/cap/new"
      val failedResource =
        ChatWidgetResource(
  ...
  fun preservesNestedGatewayDocumentAttachment() {
    val attachment =
      Json.parseToJsonElement(
        """{"type":"attachment","attachment":{"kind":"document","label":"pasted-note.txt","mimeType":"text/plain","sizeBytes":48,"url":"/__carapace__/pasted-note.txt"}}""",
      )
    ...
    assertEquals(
      ChatMessageContent(
        ...
        url = "/__carapace__/pasted-note.txt",
        sizeBytes = 48,
      ),
      parseChatMessageContent(attachment),
    )
