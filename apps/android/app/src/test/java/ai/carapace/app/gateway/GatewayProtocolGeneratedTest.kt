  ...
  fun githubPublicationResultsRoundTripAsATypedUnion() {
    val cases =
      listOf(
        ...
        """{"requestId":"request-1","status":"published","url":"https://github.com/Exaggarate/carapace/pull/1","repository":"carapace/carapace","branch":"carapace/task","headCommit":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}""" to
