...
internal const val extraWearScreenshotMode = "carapace.screenshotMode"
internal const val extraWearScreenshotScene = "carapace.screenshotScene"
...
@Composable
internal fun CarapaceWearScreenshotApp(scene: WearScreenshotScene) {
  CarapaceWearTheme(themeMode = WearThemeMode.Dark) {
    AppScaffold {
      CarapaceWearScreens(
