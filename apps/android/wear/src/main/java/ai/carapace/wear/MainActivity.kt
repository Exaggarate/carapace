...
internal const val extraWearLaunchTarget = "carapace.wear.launchTarget"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      if (scene == null) {
        ...
        CarapaceWearScreenshotApp(scene)
      }
    }
  }
...
internal fun CarapaceWearApp(
  ...
  CarapaceWearTheme(themeMode = themeMode) {
    AppScaffold {
      CarapaceWearScreens(
        snapshot = snapshot,
        failure = failure,
        ...
        onTalk = {
          if (!state.connected || snapshot?.activeSessionId == null) return@CarapaceWearScreens
...
internal const val REPLY_RESULT_KEY = "carapace_watch_message"
