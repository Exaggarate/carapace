    ...
    private var connectionStatusSubtitle: String {
        ...
        case .local:
            return self.gatewayManager.installation == .external
                ? "Carapace connects to an independently managed Gateway on this Mac."
                : "Carapace starts and monitors the Gateway on this Mac."
        case .remote:
    ...
    private var sshCommandDetails: some View {
        DisclosureGroup("SSH command details") {
            ...
            TextField(
                ...
                prompt: Text(verbatim: "/home/you/Projects/carapace"))
            TextField(
                "CLI path",
                text: self.$state.remoteCliPath,
                prompt: Text(verbatim: "/Applications/Carapace.app/.../carapace"))
        }
        .multilineTextAlignment(.leading)
        .textFieldStyle(.roundedBorder)
    }
...
extension ConnectionSettingsView {
    ...
    private func revealLogs() {
        ...
        Looked for carapace logs in /tmp/carapace/.
