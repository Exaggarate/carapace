...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.carapace", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> CarapaceSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: CarapaceSessionPreviewEntry,
    ...
    private static func cache(payload: CarapaceSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: CarapaceChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [CarapaceKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [CarapaceKit.AnyCodable]) -> [CarapaceChatMessage] {
    ...
    private static func previewText(for message: CarapaceChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: CarapaceChatMessage) -> Bool {
    ...
    private static func toolNames(for message: CarapaceChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: CarapaceChatMessage) -> String? {
