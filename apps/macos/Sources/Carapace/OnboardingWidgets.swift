...
/// Onboarding hero mascot with the github.com/Exaggarate/carapace hero treatment: the animated
...
struct GlowingCarapaceIcon: View {
    @Environment(\.colorScheme) private var colorScheme

    let size: CGFloat
    let mood: CarapaceMascotMood
    let accessory: CarapaceMascotAccessory
    ...
    var body: some View {
        ...
        CarapaceMascotView(
            ...
            .shadow(
                color: CarapaceMascotView.heroGlowColor(for: self.colorScheme),
...
extension OnboardingView {
    ...
    var mascotMood: CarapaceMascotMood {
    ...
    var mascotAccessory: CarapaceMascotAccessory {
    ...
    static func mascotMood(for snapshot: MascotMoodSnapshot) -> CarapaceMascotMood {
    ...
    static func mascotAccessory(for page: MascotPage) -> CarapaceMascotAccessory {
        switch page {
        case .ready: .gradCap
