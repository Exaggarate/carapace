...
enum CloudflareAccessLogin {
    ...
    enum LoginError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .helperUnavailable:
                "The browser sign-in helper is missing. Install a complete copy of Carapace and try again."
            case .invalidApplication:
    ...
    static func signIn(application: Application) async throws -> GatewayBrowserSession {
        ...
        let temporary = FileManager.default.temporaryDirectory
            .appendingPathComponent("carapace-browser-login-\(UUID().uuidString)", isDirectory: true)
        do {
