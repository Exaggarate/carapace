...
struct ScreenSnapshotResult: Sendable {
    let data: Data
    let format: CarapaceScreenSnapshotFormat
    let width: Int
    let height: Int
...
final class ScreenSnapshotService {
    ...
    func snapshot(
        ...
        maxWidth: Int?,
        quality: Double?,
        format: CarapaceScreenSnapshotFormat?) async throws
        ...
        referenceWidth: Int) throws -> String
    {
        ...
        return CarapaceComputerInputGeometry.displayFrameId(
    ...
    private static func normalize(
        maxWidth: Int?,
        quality: Double?,
        format: CarapaceScreenSnapshotFormat)
