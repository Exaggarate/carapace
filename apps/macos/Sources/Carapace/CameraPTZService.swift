...
struct CameraPTZControlResponse: Encodable, Equatable, Sendable {
    let deviceId: String
    let operation: CarapaceCameraPTZOperation
...
protocol CameraPTZServicing: Sendable {
    ...
    func control(_ params: CarapaceCameraPTZControlParams) async throws -> CameraPTZControlResponse
}
...
actor CameraPTZService: CameraPTZServicing {
    ...
    func control(_ params: CarapaceCameraPTZControlParams) throws -> CameraPTZControlResponse {
    ...
    private static func validateControl(
        _ params: CarapaceCameraPTZControlParams) throws -> CarapaceCameraPTZAxisValues
    {
        ...
        case .home:
            ...
            return CarapaceCameraPTZAxisValues()
        case .set:
    ...
    private static func validateAxes(_ axes: CarapaceCameraPTZAxisValues) throws {
    ...
    private static func planMotion(
        ...
        axes: CarapaceCameraPTZAxisValues) throws -> WritePlan
    {
    ...
    private static func requestedDegrees(
        value: Double,
        current: Double,
        operation: CarapaceCameraPTZOperation) -> Double
    {
    ...
    private func execute(
        ...
        deviceId: String,
        operation: CarapaceCameraPTZOperation) throws -> CameraPTZControlResponse
    {
