...
/// This intentionally ignores CARAPACE_STATE_DIR: prod, dev, and profile-specific
...
final class PortGuardianRecordStore: @unchecked Sendable {
    ...
    private let database: CarapaceNativeStateSQLite
    ...
    static var liveRootURL: URL {
        ...
        return base.appendingPathComponent("Carapace", isDirectory: true)
    }
        ...
        }) throws
    {
        ...
        let database: CarapaceNativeStateSQLite
        do {
            database = try CarapaceNativeStateSQLite(databaseURL: databaseURL)
        } catch {
    ...
    private static func decodeRecord(
        _ statement: CarapaceNativeStateSQLiteStatement) throws -> PortGuardian.Record
    {
    ...
    private static func bind(
        ...
        to statement: CarapaceNativeStateSQLiteStatement) throws
    {
    ...
    private static func storeError(_ error: Error) -> Error {
        ...
        if let error = error as? CarapaceNativeStateError {
