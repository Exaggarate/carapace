...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.carapace", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Carapace windows, but below the system’s pop-up menus.
