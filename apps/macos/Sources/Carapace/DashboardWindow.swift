...
let dashboardWindowLogger = Logger(subsystem: "ai.carapace", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let windowFrameAutosaveName = "CarapaceDashboardWindow"
}
...
enum DashboardNativeCommand: String {
    case newSession = "carapace:native-new-session"
    case commandPalette = "carapace:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "carapace:native-open-search"
        }
    }
