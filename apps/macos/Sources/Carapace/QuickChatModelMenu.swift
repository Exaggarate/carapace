...
enum QuickChatModelMenuPresenter {
    static func present(model: QuickChatModel, panel: NSPanel, contentView: NSView) {
        ...
        defaultItem.representedObject = CarapaceChatViewModel.defaultModelSelectionID
        defaultItem.state = model.selectedModelSelectionID == CarapaceChatViewModel.defaultModelSelectionID
            ? .on
            : .off
