...
final class ComputerScreenActionExecutor {
    ...
    private func peekabooClick(at point: CGPoint, action: CarapaceComputerAction) async throws {
    ...
    private struct ResolvedDisplay {
        var geometry: CarapaceComputerDisplayGeometry
        ...
        display: ResolvedDisplay) throws -> CGPoint?
    {
        ...
        let capturedWidth = CarapaceComputerInputGeometry.capturedWidth(
            refWidth: refWidth,
        ...
        let clamped = CarapaceComputerInputGeometry.clampToDisplay(
            x: mapped.x,
            y: mapped.y,
            display: geometry)
    ...
    static func validatedCurrentCursorPoint(
        _ point: CGPoint?,
        display: CarapaceComputerDisplayGeometry) throws -> CGPoint
    {
        guard let point,
    ...
    private func resolveDisplay(params: CarapaceComputerActParams) async throws -> ResolvedDisplay {
        ...
        let geometry = CarapaceComputerDisplayGeometry(
        ...
        guard CarapaceComputerInputGeometry.isValidMappingGeometry(
        ...
        if Self.usesScreenshotCoordinates(params) {
            let refWidth = try Self.requiredReferenceWidth(params)
            let currentFrameId = CarapaceComputerInputGeometry.displayFrameId(
    ...
    private static func usesScreenshotCoordinates(_ params: CarapaceComputerActParams) -> Bool {
        params.x != nil || params.y != nil || params.fromX != nil || params.fromY != nil
    }

    private static func requiredReferenceWidth(_ params: CarapaceComputerActParams) throws -> Int {
    ...
    private func rawScroll(direction: CarapaceComputerScrollDirection, amount: Int, flags: CGEventFlags) throws {
