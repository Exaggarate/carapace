...
extension OnboardingView {
    ...
    /// Carapace becomes available after that choice completes a live round-trip.
    ...
    private var aiSetupSubtitle: String {
        ...
        if state.connectionMode == .remote {
            return "AI access is configured on the remote Gateway. Carapace will use that existing setup."
        }
        return "Carapace needs an AI account to think. " +
