...
extension GatewayConnection {
    func loadMediaArtifact(
        ...
        playback: CarapaceChatPlaybackMode?,
        ifCurrentServerLease lease: ServerLease) async throws -> CarapaceChatLoadedMedia?
    {
    ...
    private static func maximumManagedMediaBytes(for kind: CarapaceChatMediaKind) -> Int {
        switch kind {
