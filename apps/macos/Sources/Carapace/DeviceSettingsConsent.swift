...
enum DeviceSettingsConsent: Equatable {
    ...
    var message: String {
        ...
        case .locationWhileUsing:
            String(localized: "Allow location access while using Carapace?")
        case .locationAlways:
    ...
    var detail: String {
        ...
        case .peekabooBridge:
            String(
                ...
                on this Mac using Carapace's macOS permissions.
                """)
        case .camera:
            String(
                localized: """
        ...
        case .locationWhileUsing:
            String(localized: "The Gateway can request this Mac's location while Carapace is in use.")
        case .locationAlways:
            String(localized: "The Gateway can request this Mac's location even when Carapace is not in use.")
        case .preciseLocation:
