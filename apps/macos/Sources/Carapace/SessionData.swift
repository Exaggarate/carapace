...
enum SessionKind: String {
    ...
    static func from(_ entry: CarapaceChatSessionEntry) -> SessionKind {
...
enum SessionLoader {
        ...
        includeUnknown: Bool = true) async throws -> SessionStoreSnapshot
    {
        ...
        let decoded: CarapaceChatSessionsListResponse
        do {
            decoded = try JSONDecoder().decode(CarapaceChatSessionsListResponse.self, from: data)
        } catch {
