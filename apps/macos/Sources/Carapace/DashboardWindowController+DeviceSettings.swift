...
extension Notification.Name {
    static let carapaceDeviceSettingsChanged = Notification.Name("carapace.deviceSettings.changed")
}

extension DashboardWindowController {
    static let deviceSettingsMessageHandlerName = "carapaceDeviceSettings"
    ...
    func applyDeviceSettingsRequest(_ request: DeviceSettingsRequest) async {
        ...
        NotificationCenter.default.post(name: .carapaceDeviceSettingsChanged, object: nil)
    }
