...
private struct RetryIdentity {
    ...
    let sessionKey: String
    let agentID: String?
    let attachments: [CarapaceChatAttachmentPayload]
...
final class QuickChatModel {
    ...
    typealias SendProvider = @MainActor (
        ...
        String?,
        String,
        [CarapaceChatAttachmentPayload]) async throws -> String
    ...
    typealias ModelPatchProvider = @MainActor (
        ...
        String?) async throws -> CarapaceChatModelPatchResult?
    ...
    private(set) var modelChoices: [CarapaceChatModelChoice] = []
    ...
    var connectionStatusMessage: String? {
        ...
        case .paused: "Carapace is paused"
    ...
    func selectModel(_ selectionID: String) {
        ...
        guard normalized == CarapaceChatViewModel.defaultModelSelectionID ||
    ...
    private func settleModelPatch(request: ModelPatchRequest, model: String?) async -> Bool {
        ...
        do {
            ...
            if self.isCurrentModelPatchPresentation(request) {
                ...
                } else if request.selectionID != CarapaceChatViewModel.defaultModelSelectionID {
