...
actor TalkModeRuntime {
    ...
    let logger = Logger(subsystem: "ai.carapace", category: "talk.runtime")
    let ttsLogger = Logger(subsystem: "ai.carapace", category: "talk.tts")
...
extension TalkModeRuntime {
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CarapaceChatMessage] = messages.compactMap { item in
