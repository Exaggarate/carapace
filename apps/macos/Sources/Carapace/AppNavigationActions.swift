...
enum AppNavigationActions {
    ...
    static func openAbout() {
        ...
        for (title, address) in [
            (String(localized: "Website"), "https://github.com/Exaggarate/carapace"),
            (String(localized: "Docs"), "https://github.com/Exaggarate/carapace"),
            (String(localized: "GitHub"), "https://github.com/Exaggarate/carapace"),
        ...
        NSApp.orderFrontStandardAboutPanel(options: [
            .applicationName: "Carapace",
            .applicationVersion: build.version,
            .version: build.build,
            .credits: credits,
            NSApplication.AboutPanelOptionKey(rawValue: "Copyright"):
                String(localized: "© 2026 Carapace Foundation — MIT License."),
        ])
    }
}
