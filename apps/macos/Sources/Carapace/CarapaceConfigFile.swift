...
enum CarapaceConfigFile {
    ...
    private static let logger = Logger(subsystem: "ai.carapace", category: "config")
    ...
    static func url() -> URL {
        CarapacePaths.configURL
    }

    static func stateDirURL() -> URL {
        CarapacePaths.stateDirURL
    }
...
extension CarapaceConfigFile {
    ...
    static func gatewayPort(root: [String: Any] = CarapaceConfigFile.loadDict()) -> Int? {
    ...
    private static func initializeNativeSessionCatalogPreferences(_ root: inout [String: Any]) -> Bool {
        let bundle: Bundle? = if Bundle.main.bundleURL.pathExtension == "app" {
            Bundle.main.resourceURL
                .map { $0.appendingPathComponent("Carapace_Carapace.bundle") }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-carapace-config-file",
            "event": "config.write",
