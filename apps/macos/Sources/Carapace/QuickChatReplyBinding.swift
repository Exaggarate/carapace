...
final class QuickChatReplyBinding {
    typealias ViewModelFactory = @MainActor (QuickChatRoutingTarget) -> CarapaceChatViewModel

    private(set) var route: QuickChatRoutingTarget?
    private(set) var viewModel: CarapaceChatViewModel?
    ...
    private static func makeViewModel(route: QuickChatRoutingTarget) -> CarapaceChatViewModel {
