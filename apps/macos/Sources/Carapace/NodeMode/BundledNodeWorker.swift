...
enum BundledNodeWorker {
    ...
    static func launch(bundle: Bundle, profile: AppProfile = .current) throws -> MacNodeHostWorkerLaunch {
        ...
        let packageRoot = root.appendingPathComponent("lib/node_modules/carapace")
        ...
        do {
            ...
            guard build.version == appBuild.version,
                  ...
                  build.buildId == info["CarapaceWorkerBuildID"] as? String,
            ...
            throw MacNodeHostWorker.WorkerError.unavailable(
                reason: "The bundled node worker is missing or incompatible. Rebuild or reinstall Carapace.app.",
