...
final class MacNodeCodexThreadCatalogClient: @unchecked Sendable {
    ...
    init(
        ...
        loadRoot: @escaping () -> [String: Any] = { CarapaceConfigFile.loadDict() })
    {
...
final class CodexAppServerThreadClient: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "ai.carapace.codex-thread-catalog")
