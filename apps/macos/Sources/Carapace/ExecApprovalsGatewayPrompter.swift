...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.carapace", category: "exec-approvals.gateway")
    ...
    private func handle(delivery: GatewayConnection.PushDelivery) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "carapace.approval.requested" else { return }
        ...
        do {
            ...
            let isSystemAgent = evt.event == "carapace.approval.requested"
