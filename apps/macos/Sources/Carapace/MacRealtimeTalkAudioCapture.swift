...
final class MacRealtimeTalkAudioCapture: RealtimeTalkAudioCapturing {
    ...
    private let logger = Logger(subsystem: "ai.carapace", category: "talk.realtime.capture")
...
final class MacRealtimeTalkOutputRouteObserver: @unchecked Sendable {
    private let logger = Logger(subsystem: "ai.carapace", category: "talk.realtime.output-route")
