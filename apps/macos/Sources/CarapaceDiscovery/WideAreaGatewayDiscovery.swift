...
enum WideAreaGatewayDiscovery {
        ...
        context: DiscoveryContext = .live) async -> [WideAreaGatewayBeacon]
    {
        ...
        for raw in ptrLines {
            ...
            let suffix = "._carapace-gw._tcp.\(domainTrimmed)"
    ...
    {
        guard let domain = CarapaceBonjour.wideAreaGatewayServiceDomain else { return nil }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_carapace-gw._tcp.\(domainTrimmed)"
