...
struct ConnectOptions {
    ...
    var clientId: String = "carapace-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: carapace-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Carapace macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Carapace macOS Gateway Connect")
...
func gatewayURLDeviceAuthOwner(_ url: URL, mode: String) -> String {
    ...
    return "carapace-mac-cli:route:\(fingerprint)"
}
