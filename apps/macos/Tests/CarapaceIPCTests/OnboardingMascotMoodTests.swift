...
struct OnboardingMascotMoodTests {
    private func mood(_ snapshot: OnboardingView.MascotMoodSnapshot) -> CarapaceMascotMood {
        OnboardingView.mascotMood(for: snapshot)
    }

    private func accessory(_ page: OnboardingView.MascotPage) -> CarapaceMascotAccessory {
