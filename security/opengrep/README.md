...
`precise.yml` is Carapace's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Carapace paths are excluded by `.gitignore` for build reasons even though
